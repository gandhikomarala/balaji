...
/**
 * Data Transfer Object for TuitionFeeStructureCalculator transactions.
 */
public class TuitionFeeStructureCalculatorRequestDto implements Serializable {
    ...
    public TuitionFeeStructureCalculatorRequestDto() {
        this.academicYear = "2026-2027";
    }

    public TuitionFeeStructureCalculatorRequestDto(String studentId, String teacherId, String academicYear,
