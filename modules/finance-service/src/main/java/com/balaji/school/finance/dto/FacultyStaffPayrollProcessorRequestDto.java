...
/**
 * Data Transfer Object for FacultyStaffPayrollProcessor transactions.
 */
public class FacultyStaffPayrollProcessorRequestDto implements Serializable {
    ...
    public FacultyStaffPayrollProcessorRequestDto() {
        this.academicYear = "2026-2027";
    }

    public FacultyStaffPayrollProcessorRequestDto(String studentId, String teacherId, String academicYear,
