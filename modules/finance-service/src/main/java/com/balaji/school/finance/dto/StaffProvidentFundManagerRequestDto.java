...
/**
 * Data Transfer Object for StaffProvidentFundManager transactions.
 */
public class StaffProvidentFundManagerRequestDto implements Serializable {
    ...
    public StaffProvidentFundManagerRequestDto() {
        this.academicYear = "2026-2027";
    }

    public StaffProvidentFundManagerRequestDto(String studentId, String teacherId, String academicYear,
