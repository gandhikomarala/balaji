...
/**
 * Data Transfer Object for SchoolBusMaintenanceLogManager execution.
 */
public class SchoolBusMaintenanceLogManagerRequestDto implements Serializable {
    ...
    public SchoolBusMaintenanceLogManagerRequestDto() {
        this.academicSession = "2026-2027";
        this.targetExecutionDate = LocalDateTime.now();
    }

    public SchoolBusMaintenanceLogManagerRequestDto(String studentId, String employeeId, String academicSession,
