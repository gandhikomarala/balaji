...
/**
 * Enterprise domain model representing VendorPurchaseOrderDesk.
 * Textbook procurement, laboratory supply POs, sports goods vendor invoices, and trust payment approvals.
 */
public class VendorPurchaseOrderDeskEntity implements Serializable {
    ...
    public VendorPurchaseOrderDeskEntity() {
    ...
    public VendorPurchaseOrderDeskEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        VendorPurchaseOrderDeskEntity that = (VendorPurchaseOrderDeskEntity) o;
    ...
    public String toString() {
        return "VendorPurchaseOrderDeskEntity{" +
                "id='" + id + '\'' +
