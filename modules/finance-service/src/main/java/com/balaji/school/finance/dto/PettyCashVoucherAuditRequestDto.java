...
/**
 * Data Transfer Object for PettyCashVoucherAudit transactions.
 */
public class PettyCashVoucherAuditRequestDto implements Serializable {
    ...
    public PettyCashVoucherAuditRequestDto() {
        this.academicYear = "2026-2027";
    }

    public PettyCashVoucherAuditRequestDto(String studentId, String teacherId, String academicYear,
