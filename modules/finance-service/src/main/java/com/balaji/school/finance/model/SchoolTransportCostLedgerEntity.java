...
/**
 * Enterprise domain model representing SchoolTransportCostLedger.
 * Bus diesel consumption auditing, fleet maintenance invoices, insurance renewals, and driver overtime compensation.
 */
public class SchoolTransportCostLedgerEntity implements Serializable {
    ...
    public SchoolTransportCostLedgerEntity() {
    ...
    public SchoolTransportCostLedgerEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        SchoolTransportCostLedgerEntity that = (SchoolTransportCostLedgerEntity) o;
    ...
    public String toString() {
        return "SchoolTransportCostLedgerEntity{" +
                "id='" + id + '\'' +
