...
/**
 * Data Transfer Object for HostelMessAccountsManager transactions.
 */
public class HostelMessAccountsManagerRequestDto implements Serializable {
    ...
    public HostelMessAccountsManagerRequestDto() {
        this.academicYear = "2026-2027";
    }

    public HostelMessAccountsManagerRequestDto(String studentId, String teacherId, String academicYear,
