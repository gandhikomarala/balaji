...
/**
 * Enterprise domain model representing PettyCashVoucherAudit.
 * Daily office stationery, postal stamp vouchers, event refreshment bills, and internal voucher verification.
 */
public class PettyCashVoucherAuditEntity implements Serializable {
    ...
    public PettyCashVoucherAuditEntity() {
    ...
    public PettyCashVoucherAuditEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        PettyCashVoucherAuditEntity that = (PettyCashVoucherAuditEntity) o;
    ...
    public String toString() {
        return "PettyCashVoucherAuditEntity{" +
                "id='" + id + '\'' +
