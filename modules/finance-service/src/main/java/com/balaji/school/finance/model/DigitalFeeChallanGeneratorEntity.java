...
/**
 * Enterprise domain model representing DigitalFeeChallanGenerator.
 * Instant Bharat QR / UPI payment links, SBI counter deposit challans, and transaction reconciliation.
 */
public class DigitalFeeChallanGeneratorEntity implements Serializable {
    ...
    public DigitalFeeChallanGeneratorEntity() {
    ...
    public DigitalFeeChallanGeneratorEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        DigitalFeeChallanGeneratorEntity that = (DigitalFeeChallanGeneratorEntity) o;
    ...
    public String toString() {
        return "DigitalFeeChallanGeneratorEntity{" +
                "id='" + id + '\'' +
