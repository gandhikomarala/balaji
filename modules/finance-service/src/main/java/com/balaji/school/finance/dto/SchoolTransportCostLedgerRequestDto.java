...
/**
 * Data Transfer Object for SchoolTransportCostLedger transactions.
 */
public class SchoolTransportCostLedgerRequestDto implements Serializable {
    ...
    public SchoolTransportCostLedgerRequestDto() {
        this.academicYear = "2026-2027";
    }

    public SchoolTransportCostLedgerRequestDto(String studentId, String teacherId, String academicYear,
