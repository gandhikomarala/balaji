...
/**
 * Data Transfer Object for VendorPurchaseOrderDesk transactions.
 */
public class VendorPurchaseOrderDeskRequestDto implements Serializable {
    ...
    public VendorPurchaseOrderDeskRequestDto() {
        this.academicYear = "2026-2027";
    }

    public VendorPurchaseOrderDeskRequestDto(String studentId, String teacherId, String academicYear,
