...
/**
 * Data Transfer Object for DailyCashCounterReconciler transactions.
 */
public class DailyCashCounterReconcilerRequestDto implements Serializable {
    ...
    public DailyCashCounterReconcilerRequestDto() {
        this.academicYear = "2026-2027";
    }

    public DailyCashCounterReconcilerRequestDto(String studentId, String teacherId, String academicYear,
