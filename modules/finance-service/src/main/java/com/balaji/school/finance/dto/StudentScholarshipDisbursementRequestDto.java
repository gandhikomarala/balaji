...
/**
 * Data Transfer Object for StudentScholarshipDisbursement transactions.
 */
public class StudentScholarshipDisbursementRequestDto implements Serializable {
    ...
    public StudentScholarshipDisbursementRequestDto() {
        this.academicYear = "2026-2027";
    }

    public StudentScholarshipDisbursementRequestDto(String studentId, String teacherId, String academicYear,
