...
/**
 * Data Transfer Object for BuildingMaintenanceFund transactions.
 */
public class BuildingMaintenanceFundRequestDto implements Serializable {
    ...
    public BuildingMaintenanceFundRequestDto() {
        this.academicYear = "2026-2027";
    }

    public BuildingMaintenanceFundRequestDto(String studentId, String teacherId, String academicYear,
