...
/**
 * Data Transfer Object for ExaminationFeeCollection transactions.
 */
public class ExaminationFeeCollectionRequestDto implements Serializable {
    ...
    public ExaminationFeeCollectionRequestDto() {
        this.academicYear = "2026-2027";
    }

    public ExaminationFeeCollectionRequestDto(String studentId, String teacherId, String academicYear,
