...
/**
 * Enterprise domain model representing TuitionFeeStructureCalculator.
 * Multi-tier tuition fee calculation, concession approvals, installment split plans, and scholarship deductions.
 */
public class TuitionFeeStructureCalculatorEntity implements Serializable {
    ...
    public TuitionFeeStructureCalculatorEntity() {
    ...
    public TuitionFeeStructureCalculatorEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        TuitionFeeStructureCalculatorEntity that = (TuitionFeeStructureCalculatorEntity) o;
    ...
    public String toString() {
        return "TuitionFeeStructureCalculatorEntity{" +
                "id='" + id + '\'' +
