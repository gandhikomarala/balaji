...
/**
 * Data Transfer Object for EducationalTrustAuditor transactions.
 */
public class EducationalTrustAuditorRequestDto implements Serializable {
    ...
    public EducationalTrustAuditorRequestDto() {
        this.academicYear = "2026-2027";
    }

    public EducationalTrustAuditorRequestDto(String studentId, String teacherId, String academicYear,
