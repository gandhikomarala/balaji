package com.balaji.school.finance.dto;

import java.io.Serializable;
import java.time.LocalDateTime;

/**
 * Data Transfer Object for FeeDefaulterInstallmentWorkflow execution.
 */
public class FeeDefaulterInstallmentWorkflowRequestDto implements Serializable {
    ...
    public FeeDefaulterInstallmentWorkflowRequestDto() {
        this.academicSession = "2026-2027";
        this.targetExecutionDate = LocalDateTime.now();
    }

    public FeeDefaulterInstallmentWorkflowRequestDto(String studentId, String employeeId, String academicSession,
