...
/**
 * Enterprise domain model representing FacultyStaffPayrollProcessor.
 * Monthly teacher salary calculation, Basic Pay, DA, HRA, Provident Fund (EPF), ESI, and Professional Tax deductions.
 */
public class FacultyStaffPayrollProcessorEntity implements Serializable {
    ...
    public FacultyStaffPayrollProcessorEntity() {
    ...
    public FacultyStaffPayrollProcessorEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        FacultyStaffPayrollProcessorEntity that = (FacultyStaffPayrollProcessorEntity) o;
    ...
    public String toString() {
        return "FacultyStaffPayrollProcessorEntity{" +
                "id='" + id + '\'' +
