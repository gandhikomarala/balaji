...
/**
 * Data Transfer Object for StaffCasualLeaveWorkflow execution.
 */
public class StaffCasualLeaveWorkflowRequestDto implements Serializable {
    ...
    public StaffCasualLeaveWorkflowRequestDto() {
        this.academicSession = "2026-2027";
        this.targetExecutionDate = LocalDateTime.now();
    }

    public StaffCasualLeaveWorkflowRequestDto(String studentId, String employeeId, String academicSession,
