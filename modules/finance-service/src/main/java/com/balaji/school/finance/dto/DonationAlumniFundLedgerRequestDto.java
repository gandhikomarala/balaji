...
/**
 * Data Transfer Object for DonationAlumniFundLedger transactions.
 */
public class DonationAlumniFundLedgerRequestDto implements Serializable {
    ...
    public DonationAlumniFundLedgerRequestDto() {
        this.academicYear = "2026-2027";
    }

    public DonationAlumniFundLedgerRequestDto(String studentId, String teacherId, String academicYear,
