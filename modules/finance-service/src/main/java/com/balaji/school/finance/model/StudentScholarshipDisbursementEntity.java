...
/**
 * Enterprise domain model representing StudentScholarshipDisbursement.
 * Direct benefit transfer (DBT) reconciler for government social welfare grants and BC/SC/ST student stipends.
 */
public class StudentScholarshipDisbursementEntity implements Serializable {
    ...
    public StudentScholarshipDisbursementEntity() {
    ...
    public StudentScholarshipDisbursementEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        StudentScholarshipDisbursementEntity that = (StudentScholarshipDisbursementEntity) o;
    ...
    public String toString() {
        return "StudentScholarshipDisbursementEntity{" +
                "id='" + id + '\'' +
