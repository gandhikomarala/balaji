...
/**
 * Data Transfer Object for AlumniMentorshipFundLedger execution.
 */
public class AlumniMentorshipFundLedgerRequestDto implements Serializable {
    ...
    public AlumniMentorshipFundLedgerRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public AlumniMentorshipFundLedgerRequestDto(String studentId, String officerId, String academicYear,
