...
/**
 * Data Transfer Object for SchoolBusGpsFleetTelematics transactions.
 */
public class SchoolBusGpsFleetTelematicsRequestDto implements Serializable {
    ...
    public SchoolBusGpsFleetTelematicsRequestDto() {
        this.academicYear = "2026-2027";
    }

    public SchoolBusGpsFleetTelematicsRequestDto(String studentId, String teacherId, String academicYear,
