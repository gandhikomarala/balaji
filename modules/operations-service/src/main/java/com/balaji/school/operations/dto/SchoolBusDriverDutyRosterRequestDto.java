...
/**
 * Data Transfer Object for SchoolBusDriverDutyRoster execution.
 */
public class SchoolBusDriverDutyRosterRequestDto implements Serializable {
    ...
    public SchoolBusDriverDutyRosterRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public SchoolBusDriverDutyRosterRequestDto(String studentId, String officerId, String academicYear,
