...
/**
 * Data Transfer Object for ScienceFairExhibitionPavilion transactions.
 */
public class ScienceFairExhibitionPavilionRequestDto implements Serializable {
    ...
    public ScienceFairExhibitionPavilionRequestDto() {
        this.academicYear = "2026-2027";
    }

    public ScienceFairExhibitionPavilionRequestDto(String studentId, String teacherId, String academicYear,
