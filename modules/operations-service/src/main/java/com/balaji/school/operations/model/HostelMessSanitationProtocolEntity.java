...
/**
 * Enterprise domain model representing HostelMessSanitationProtocol.
 * Kitchen hygiene compliance, pest control certification, drinking water bacteriological analysis, and kitchen audit.
 */
public class HostelMessSanitationProtocolEntity implements Serializable {
    ...
    public HostelMessSanitationProtocolEntity() {
    ...
    public HostelMessSanitationProtocolEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        HostelMessSanitationProtocolEntity that = (HostelMessSanitationProtocolEntity) o;
    ...
    public String toString() {
        return "HostelMessSanitationProtocolEntity{" +
                "id='" + id + '\'' +
