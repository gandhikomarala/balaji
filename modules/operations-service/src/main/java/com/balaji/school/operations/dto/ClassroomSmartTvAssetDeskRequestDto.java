...
/**
 * Data Transfer Object for ClassroomSmartTvAssetDesk transactions.
 */
public class ClassroomSmartTvAssetDeskRequestDto implements Serializable {
    ...
    public ClassroomSmartTvAssetDeskRequestDto() {
        this.academicYear = "2026-2027";
    }

    public ClassroomSmartTvAssetDeskRequestDto(String studentId, String teacherId, String academicYear,
