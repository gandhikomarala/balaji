...
/**
 * Data Transfer Object for StateBoardInspectionComplianceAuditor execution.
 */
public class StateBoardInspectionComplianceAuditorRequestDto implements Serializable {
    ...
    public StateBoardInspectionComplianceAuditorRequestDto() {
        this.academicSession = "2026-2027";
        this.targetExecutionDate = LocalDateTime.now();
    }

    public StateBoardInspectionComplianceAuditorRequestDto(String studentId, String employeeId, String academicSession,
