...
/**
 * Data Transfer Object for HostelMessSanitationProtocol transactions.
 */
public class HostelMessSanitationProtocolRequestDto implements Serializable {
    ...
    public HostelMessSanitationProtocolRequestDto() {
        this.academicYear = "2026-2027";
    }

    public HostelMessSanitationProtocolRequestDto(String studentId, String teacherId, String academicYear,
