...
/**
 * Data Transfer Object for SolarPowerEnergyAuditor transactions.
 */
public class SolarPowerEnergyAuditorRequestDto implements Serializable {
    ...
    public SolarPowerEnergyAuditorRequestDto() {
        this.academicYear = "2026-2027";
    }

    public SolarPowerEnergyAuditorRequestDto(String studentId, String teacherId, String academicYear,
