...
/**
 * Data Transfer Object for ParentTeacherMeetingResolutionTracker execution.
 */
public class ParentTeacherMeetingResolutionTrackerRequestDto implements Serializable {
    ...
    public ParentTeacherMeetingResolutionTrackerRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public ParentTeacherMeetingResolutionTrackerRequestDto(String studentId, String officerId, String academicYear,
