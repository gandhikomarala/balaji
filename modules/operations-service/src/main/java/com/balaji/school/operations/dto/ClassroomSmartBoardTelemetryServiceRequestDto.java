...
/**
 * Data Transfer Object for ClassroomSmartBoardTelemetryService execution.
 */
public class ClassroomSmartBoardTelemetryServiceRequestDto implements Serializable {
    ...
    public ClassroomSmartBoardTelemetryServiceRequestDto() {
        this.academicSession = "2026-2027";
        this.targetExecutionDate = LocalDateTime.now();
    }

    public ClassroomSmartBoardTelemetryServiceRequestDto(String studentId, String employeeId, String academicSession,
