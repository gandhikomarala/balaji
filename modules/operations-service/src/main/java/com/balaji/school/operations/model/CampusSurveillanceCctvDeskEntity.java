...
/**
 * Enterprise domain model representing CampusSurveillanceCctvDesk.
 * Classroom, corridor, and playground CCTV camera health monitoring, storage NVR retention, and safety reviews.
 */
public class CampusSurveillanceCctvDeskEntity implements Serializable {
    ...
    public CampusSurveillanceCctvDeskEntity() {
    ...
    public CampusSurveillanceCctvDeskEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        CampusSurveillanceCctvDeskEntity that = (CampusSurveillanceCctvDeskEntity) o;
    ...
    public String toString() {
        return "CampusSurveillanceCctvDeskEntity{" +
                "id='" + id + '\'' +
