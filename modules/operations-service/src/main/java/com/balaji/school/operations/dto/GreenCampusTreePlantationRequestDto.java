...
/**
 * Data Transfer Object for GreenCampusTreePlantation transactions.
 */
public class GreenCampusTreePlantationRequestDto implements Serializable {
    ...
    public GreenCampusTreePlantationRequestDto() {
        this.academicYear = "2026-2027";
    }

    public GreenCampusTreePlantationRequestDto(String studentId, String teacherId, String academicYear,
