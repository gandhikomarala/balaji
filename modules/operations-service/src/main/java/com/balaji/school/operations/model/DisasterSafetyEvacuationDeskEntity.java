...
/**
 * Enterprise domain model representing DisasterSafetyEvacuationDesk.
 * Fire extinguisher expiry inspection, emergency evacuation drill logs, first aid kit replenishment, and police liaisons.
 */
public class DisasterSafetyEvacuationDeskEntity implements Serializable {
    ...
    public DisasterSafetyEvacuationDeskEntity() {
    ...
    public DisasterSafetyEvacuationDeskEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        DisasterSafetyEvacuationDeskEntity that = (DisasterSafetyEvacuationDeskEntity) o;
    ...
    public String toString() {
        return "DisasterSafetyEvacuationDeskEntity{" +
                "id='" + id + '\'' +
