...
/**
 * Enterprise domain model representing CampusSecurityVisitorGate.
 * Digital visitor badge printing, parent identity verification, student gate departure passes, and security logs.
 */
public class CampusSecurityVisitorGateEntity implements Serializable {
    ...
    public CampusSecurityVisitorGateEntity() {
    ...
    public CampusSecurityVisitorGateEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        CampusSecurityVisitorGateEntity that = (CampusSecurityVisitorGateEntity) o;
    ...
    public String toString() {
        return "CampusSecurityVisitorGateEntity{" +
                "id='" + id + '\'' +
