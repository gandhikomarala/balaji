...
/**
 * Data Transfer Object for MiddayMealNutritionQualityAuditor execution.
 */
public class MiddayMealNutritionQualityAuditorRequestDto implements Serializable {
    ...
    public MiddayMealNutritionQualityAuditorRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public MiddayMealNutritionQualityAuditorRequestDto(String studentId, String officerId, String academicYear,
