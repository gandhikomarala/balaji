...
/**
 * Data Transfer Object for SanitationWaterQualityFilter transactions.
 */
public class SanitationWaterQualityFilterRequestDto implements Serializable {
    ...
    public SanitationWaterQualityFilterRequestDto() {
        this.academicYear = "2026-2027";
    }

    public SanitationWaterQualityFilterRequestDto(String studentId, String teacherId, String academicYear,
