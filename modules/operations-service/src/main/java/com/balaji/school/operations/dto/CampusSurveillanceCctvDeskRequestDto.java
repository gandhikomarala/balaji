...
/**
 * Data Transfer Object for CampusSurveillanceCctvDesk transactions.
 */
public class CampusSurveillanceCctvDeskRequestDto implements Serializable {
    ...
    public CampusSurveillanceCctvDeskRequestDto() {
        this.academicYear = "2026-2027";
    }

    public CampusSurveillanceCctvDeskRequestDto(String studentId, String teacherId, String academicYear,
