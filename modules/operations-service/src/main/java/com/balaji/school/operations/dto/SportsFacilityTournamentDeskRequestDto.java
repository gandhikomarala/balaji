...
/**
 * Data Transfer Object for SportsFacilityTournamentDesk transactions.
 */
public class SportsFacilityTournamentDeskRequestDto implements Serializable {
    ...
    public SportsFacilityTournamentDeskRequestDto() {
        this.academicYear = "2026-2027";
    }

    public SportsFacilityTournamentDeskRequestDto(String studentId, String teacherId, String academicYear,
