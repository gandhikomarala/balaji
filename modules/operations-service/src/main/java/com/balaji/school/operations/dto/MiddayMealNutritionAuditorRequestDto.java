...
/**
 * Data Transfer Object for MiddayMealNutritionAuditor transactions.
 */
public class MiddayMealNutritionAuditorRequestDto implements Serializable {
    ...
    public MiddayMealNutritionAuditorRequestDto() {
        this.academicYear = "2026-2027";
    }

    public MiddayMealNutritionAuditorRequestDto(String studentId, String teacherId, String academicYear,
