...
import com.balaji.school.operations.service.GreenCampusTreePlantationService;
...
/**
 * Enterprise REST API Controller for GreenCampusTreePlantation.
 */
public class GreenCampusTreePlantationController {

    private final GreenCampusTreePlantationService service;

    public GreenCampusTreePlantationController() {
        this.service = new GreenCampusTreePlantationService();
    }

    public GreenCampusTreePlantationController(GreenCampusTreePlantationService service) {
        this.service = service != null ? service : new GreenCampusTreePlantationService();
    }

    public Map<String, Object> fetchAll() {
        List<GreenCampusTreePlantationEntity> records = service.getAll();
    ...
    public Map<String, Object> fetchById(String id) {
        Optional<GreenCampusTreePlantationEntity> entity = service.getById(id);
        Map<String, Object> response = new HashMap<>();
        if (entity.isPresent()) {
            response.put("statusCode", 200);
    ...
    public Map<String, Object> submitRecord(GreenCampusTreePlantationRequestDto request) {
        Map<String, Object> response = new HashMap<>();
        try {
            GreenCampusTreePlantationEntity created = service.registerEntry(request);
