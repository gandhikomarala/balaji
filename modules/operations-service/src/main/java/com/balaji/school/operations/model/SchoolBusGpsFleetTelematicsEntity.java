...
/**
 * Enterprise domain model representing SchoolBusGpsFleetTelematics.
 * Real-time IoT bus GPS tracking, speed governor alerts, route deviation detection, and parent ETA notifications.
 */
public class SchoolBusGpsFleetTelematicsEntity implements Serializable {
    ...
    public SchoolBusGpsFleetTelematicsEntity() {
    ...
    public SchoolBusGpsFleetTelematicsEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        SchoolBusGpsFleetTelematicsEntity that = (SchoolBusGpsFleetTelematicsEntity) o;
    ...
    public String toString() {
        return "SchoolBusGpsFleetTelematicsEntity{" +
                "id='" + id + '\'' +
