...
/**
 * Data Transfer Object for CampusSecurityVisitorGate transactions.
 */
public class CampusSecurityVisitorGateRequestDto implements Serializable {
    ...
    public CampusSecurityVisitorGateRequestDto() {
        this.academicYear = "2026-2027";
    }

    public CampusSecurityVisitorGateRequestDto(String studentId, String teacherId, String academicYear,
