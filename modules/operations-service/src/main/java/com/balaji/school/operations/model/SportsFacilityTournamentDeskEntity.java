...
/**
 * Enterprise domain model representing SportsFacilityTournamentDesk.
 * Annual athletic meet scorekeeping, cricket/volleyball tournament fixtures, equipment allocation, and victory trophies.
 */
public class SportsFacilityTournamentDeskEntity implements Serializable {
    ...
    public SportsFacilityTournamentDeskEntity() {
    ...
    public SportsFacilityTournamentDeskEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        SportsFacilityTournamentDeskEntity that = (SportsFacilityTournamentDeskEntity) o;
    ...
    public String toString() {
        return "SportsFacilityTournamentDeskEntity{" +
                "id='" + id + '\'' +
