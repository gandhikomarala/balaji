...
/**
 * Data Transfer Object for DisasterSafetyEvacuationDesk transactions.
 */
public class DisasterSafetyEvacuationDeskRequestDto implements Serializable {
    ...
    public DisasterSafetyEvacuationDeskRequestDto() {
        this.academicYear = "2026-2027";
    }

    public DisasterSafetyEvacuationDeskRequestDto(String studentId, String teacherId, String academicYear,
