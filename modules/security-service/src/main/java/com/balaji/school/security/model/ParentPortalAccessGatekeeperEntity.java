...
/**
 * Enterprise domain model representing ParentPortalAccessGatekeeper.
 * Enforces two-factor SMS OTP authentication for parent portal login and sensitive fee payment actions.
 */
public class ParentPortalAccessGatekeeperEntity implements Serializable {
    ...
    public ParentPortalAccessGatekeeperEntity() {
    ...
    public ParentPortalAccessGatekeeperEntity(String id, String referenceCode, String studentId, String officerId,
    ...
    public boolean equals(Object o) {
        ...
        ParentPortalAccessGatekeeperEntity that = (ParentPortalAccessGatekeeperEntity) o;
    ...
    public String toString() {
        return "ParentPortalAccessGatekeeperEntity{" +
                "id='" + id + '\'' +
