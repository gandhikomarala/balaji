...
/**
 * Data Transfer Object for JwtAuthenticationTokenProvider execution.
 */
public class JwtAuthenticationTokenProviderRequestDto implements Serializable {
    ...
    public JwtAuthenticationTokenProviderRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public JwtAuthenticationTokenProviderRequestDto(String studentId, String officerId, String academicYear,
