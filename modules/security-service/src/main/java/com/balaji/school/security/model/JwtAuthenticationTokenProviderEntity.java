package com.balaji.school.security.model;
...
/**
 * Enterprise domain model representing JwtAuthenticationTokenProvider.
 * Generates cryptographic RSA-signed JWT tokens with claims, refresh token rotation, and blacklist caching.
 */
public class JwtAuthenticationTokenProviderEntity implements Serializable {
    ...
    public JwtAuthenticationTokenProviderEntity() {
    ...
    public JwtAuthenticationTokenProviderEntity(String id, String referenceCode, String studentId, String officerId,
    ...
    public boolean equals(Object o) {
        ...
        JwtAuthenticationTokenProviderEntity that = (JwtAuthenticationTokenProviderEntity) o;
    ...
    public String toString() {
        return "JwtAuthenticationTokenProviderEntity{" +
                "id='" + id + '\'' +
