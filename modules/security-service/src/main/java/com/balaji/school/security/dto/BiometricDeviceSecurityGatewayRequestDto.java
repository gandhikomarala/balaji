...
/**
 * Data Transfer Object for BiometricDeviceSecurityGateway execution.
 */
public class BiometricDeviceSecurityGatewayRequestDto implements Serializable {
    ...
    public BiometricDeviceSecurityGatewayRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public BiometricDeviceSecurityGatewayRequestDto(String studentId, String officerId, String academicYear,
