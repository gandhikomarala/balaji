...
/**
 * Data Transfer Object for SchoolUserRoleHierarchyManager execution.
 */
public class SchoolUserRoleHierarchyManagerRequestDto implements Serializable {
    ...
    public SchoolUserRoleHierarchyManagerRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public SchoolUserRoleHierarchyManagerRequestDto(String studentId, String officerId, String academicYear,
