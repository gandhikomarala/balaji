...
/**
 * Enterprise domain model representing BiometricDeviceSecurityGateway.
 * Secures IoT biometric devices at classroom doors, validates encrypted payloads, and prevents replay attacks.
 */
public class BiometricDeviceSecurityGatewayEntity implements Serializable {
    ...
    public BiometricDeviceSecurityGatewayEntity() {
    ...
    public BiometricDeviceSecurityGatewayEntity(String id, String referenceCode, String studentId, String officerId,
    ...
    public boolean equals(Object o) {
        ...
        BiometricDeviceSecurityGatewayEntity that = (BiometricDeviceSecurityGatewayEntity) o;
    ...
    public String toString() {
        return "BiometricDeviceSecurityGatewayEntity{" +
                "id='" + id + '\'' +
