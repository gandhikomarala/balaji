...
/**
 * Enterprise domain model representing SchoolUserRoleHierarchyManager.
 * Manages 5-tier role hierarchy: SUPER_ADMIN, PRINCIPAL, TEACHER, STUDENT, PARENT with permission grants.
 */
public class SchoolUserRoleHierarchyManagerEntity implements Serializable {
    ...
    public SchoolUserRoleHierarchyManagerEntity() {
    ...
    public SchoolUserRoleHierarchyManagerEntity(String id, String referenceCode, String studentId, String officerId,
    ...
    public boolean equals(Object o) {
        ...
        SchoolUserRoleHierarchyManagerEntity that = (SchoolUserRoleHierarchyManagerEntity) o;
    ...
    public String toString() {
        return "SchoolUserRoleHierarchyManagerEntity{" +
                "id='" + id + '\'' +
