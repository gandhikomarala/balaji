package com.balaji.school.security.dto;

import java.io.Serializable;
import java.time.LocalDateTime;

/**
 * Data Transfer Object for DataPrivacyStudentRecordAnonymizer execution.
 */
public class DataPrivacyStudentRecordAnonymizerRequestDto implements Serializable {
    ...
    public DataPrivacyStudentRecordAnonymizerRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public DataPrivacyStudentRecordAnonymizerRequestDto(String studentId, String officerId, String academicYear,
