...
/**
 * Data Transfer Object for AuditTrailComplianceLogger execution.
 */
public class AuditTrailComplianceLoggerRequestDto implements Serializable {
    ...
    public AuditTrailComplianceLoggerRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public AuditTrailComplianceLoggerRequestDto(String studentId, String officerId, String academicYear,
