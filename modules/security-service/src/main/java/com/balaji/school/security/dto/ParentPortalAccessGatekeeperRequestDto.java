...
/**
 * Data Transfer Object for ParentPortalAccessGatekeeper execution.
 */
public class ParentPortalAccessGatekeeperRequestDto implements Serializable {
    ...
    public ParentPortalAccessGatekeeperRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public ParentPortalAccessGatekeeperRequestDto(String studentId, String officerId, String academicYear,
