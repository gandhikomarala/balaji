...
/**
 * Data Transfer Object for TeacherPedagogicalEffectivenessAnalyzer execution.
 */
public class TeacherPedagogicalEffectivenessAnalyzerRequestDto implements Serializable {
    ...
    public TeacherPedagogicalEffectivenessAnalyzerRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public TeacherPedagogicalEffectivenessAnalyzerRequestDto(String studentId, String officerId, String academicYear,
