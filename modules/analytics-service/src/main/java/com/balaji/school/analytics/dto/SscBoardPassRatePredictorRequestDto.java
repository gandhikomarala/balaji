...
/**
 * Data Transfer Object for SscBoardPassRatePredictor execution.
 */
public class SscBoardPassRatePredictorRequestDto implements Serializable {
    ...
    public SscBoardPassRatePredictorRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public SscBoardPassRatePredictorRequestDto(String studentId, String officerId, String academicYear,
