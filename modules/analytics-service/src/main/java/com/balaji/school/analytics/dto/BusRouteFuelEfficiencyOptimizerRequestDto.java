...
/**
 * Data Transfer Object for BusRouteFuelEfficiencyOptimizer execution.
 */
public class BusRouteFuelEfficiencyOptimizerRequestDto implements Serializable {
    ...
    public BusRouteFuelEfficiencyOptimizerRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public BusRouteFuelEfficiencyOptimizerRequestDto(String studentId, String officerId, String academicYear,
