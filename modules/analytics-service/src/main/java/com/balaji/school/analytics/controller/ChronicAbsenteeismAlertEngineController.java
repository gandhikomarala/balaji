...
import com.balaji.school.analytics.service.ChronicAbsenteeismAlertEngineService;
...
/**
 * REST API Endpoint Controller for ChronicAbsenteeismAlertEngine.
 */
public class ChronicAbsenteeismAlertEngineController {

    private final ChronicAbsenteeismAlertEngineService service;

    public ChronicAbsenteeismAlertEngineController() {
        this.service = new ChronicAbsenteeismAlertEngineService();
    }

    public ChronicAbsenteeismAlertEngineController(ChronicAbsenteeismAlertEngineService service) {
        this.service = service != null ? service : new ChronicAbsenteeismAlertEngineService();
    }

    public Map<String, Object> listAll() {
        List<ChronicAbsenteeismAlertEngineEntity> records = service.getAll();
    ...
    public Map<String, Object> findById(String id) {
        Optional<ChronicAbsenteeismAlertEngineEntity> entity = service.getById(id);
        Map<String, Object> response = new HashMap<>();
        if (entity.isPresent()) {
            response.put("statusCode", 200);
    ...
    public Map<String, Object> createEntry(ChronicAbsenteeismAlertEngineRequestDto request) {
        Map<String, Object> response = new HashMap<>();
        try {
            ChronicAbsenteeismAlertEngineEntity created = service.executeWorkflow(request);
