...
/**
 * Enterprise domain model representing SscBoardPassRatePredictor.
 * Machine learning regression predicting student AP SSC board exam pass probabilities based on FA/SA marks.
 */
public class SscBoardPassRatePredictorEntity implements Serializable {
    ...
    public SscBoardPassRatePredictorEntity() {
    ...
    public SscBoardPassRatePredictorEntity(String id, String referenceCode, String studentId, String officerId,
    ...
    public boolean equals(Object o) {
        ...
        SscBoardPassRatePredictorEntity that = (SscBoardPassRatePredictorEntity) o;
    ...
    public String toString() {
        return "SscBoardPassRatePredictorEntity{" +
                "id='" + id + '\'' +
