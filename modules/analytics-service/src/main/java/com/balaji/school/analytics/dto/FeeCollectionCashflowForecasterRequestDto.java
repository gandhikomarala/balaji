...
/**
 * Data Transfer Object for FeeCollectionCashflowForecaster execution.
 */
public class FeeCollectionCashflowForecasterRequestDto implements Serializable {
    ...
    public FeeCollectionCashflowForecasterRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public FeeCollectionCashflowForecasterRequestDto(String studentId, String officerId, String academicYear,
