...
/**
 * Data Transfer Object for MiddayMealNutritionalHealthIndex execution.
 */
public class MiddayMealNutritionalHealthIndexRequestDto implements Serializable {
    ...
    public MiddayMealNutritionalHealthIndexRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public MiddayMealNutritionalHealthIndexRequestDto(String studentId, String officerId, String academicYear,
