...
/**
 * Data Transfer Object for NcertDigitalLibraryEcosystem execution.
 */
public class NcertDigitalLibraryEcosystemRequestDto implements Serializable {
    ...
    public NcertDigitalLibraryEcosystemRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public NcertDigitalLibraryEcosystemRequestDto(String studentId, String officerId, String academicYear,
