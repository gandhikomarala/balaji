package com.balaji.school.integration.dto;

import java.io.Serializable;
import java.time.LocalDateTime;

/**
 * Data Transfer Object for DigitalEvaluationSheetArchiver execution.
 */
public class DigitalEvaluationSheetArchiverRequestDto implements Serializable {
    ...
    public DigitalEvaluationSheetArchiverRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public DigitalEvaluationSheetArchiverRequestDto(String studentId, String officerId, String academicYear,
