...
/**
 * Data Transfer Object for WhatsAppParentBroadcastBridge execution.
 */
public class WhatsAppParentBroadcastBridgeRequestDto implements Serializable {
    ...
    public WhatsAppParentBroadcastBridgeRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public WhatsAppParentBroadcastBridgeRequestDto(String studentId, String officerId, String academicYear,
