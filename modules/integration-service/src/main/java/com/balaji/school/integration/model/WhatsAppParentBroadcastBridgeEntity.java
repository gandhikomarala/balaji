...
/**
 * Enterprise domain model representing WhatsAppParentBroadcastBridge.
 * Automated WhatsApp API connector for student marks memos, emergency circulars, and attendance alerts.
 */
public class WhatsAppParentBroadcastBridgeEntity implements Serializable {
    ...
    public WhatsAppParentBroadcastBridgeEntity() {
    ...
    public WhatsAppParentBroadcastBridgeEntity(String id, String referenceCode, String studentId, String officerId,
    ...
    public boolean equals(Object o) {
        ...
        WhatsAppParentBroadcastBridgeEntity that = (WhatsAppParentBroadcastBridgeEntity) o;
    ...
    public String toString() {
        return "WhatsAppParentBroadcastBridgeEntity{" +
                "id='" + id + '\'' +
