...
/**
 * Enterprise domain model representing NcertDigitalLibraryEcosystem.
 * Federated search client for NCERT e-Pathshala, DIKSHA portal, and Telugu Academy digital books.
 */
public class NcertDigitalLibraryEcosystemEntity implements Serializable {
    ...
    public NcertDigitalLibraryEcosystemEntity() {
    ...
    public NcertDigitalLibraryEcosystemEntity(String id, String referenceCode, String studentId, String officerId,
    ...
    public boolean equals(Object o) {
        ...
        NcertDigitalLibraryEcosystemEntity that = (NcertDigitalLibraryEcosystemEntity) o;
    ...
    public String toString() {
        return "NcertDigitalLibraryEcosystemEntity{" +
                "id='" + id + '\'' +
