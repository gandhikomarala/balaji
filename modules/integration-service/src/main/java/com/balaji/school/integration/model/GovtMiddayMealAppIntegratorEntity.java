...
/**
 * Enterprise domain model representing GovtMiddayMealAppIntegrator.
 * Synchronizes daily midday meal beneficiary counts with district education officer mobile applications.
 */
public class GovtMiddayMealAppIntegratorEntity implements Serializable {
    ...
    public GovtMiddayMealAppIntegratorEntity() {
    ...
    public GovtMiddayMealAppIntegratorEntity(String id, String referenceCode, String studentId, String officerId,
    ...
    public boolean equals(Object o) {
        ...
        GovtMiddayMealAppIntegratorEntity that = (GovtMiddayMealAppIntegratorEntity) o;
    ...
    public String toString() {
        return "GovtMiddayMealAppIntegratorEntity{" +
                "id='" + id + '\'' +
