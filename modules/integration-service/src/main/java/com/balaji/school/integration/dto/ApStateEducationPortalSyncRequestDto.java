...
/**
 * Data Transfer Object for ApStateEducationPortalSync execution.
 */
public class ApStateEducationPortalSyncRequestDto implements Serializable {
    ...
    public ApStateEducationPortalSyncRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public ApStateEducationPortalSyncRequestDto(String studentId, String officerId, String academicYear,
