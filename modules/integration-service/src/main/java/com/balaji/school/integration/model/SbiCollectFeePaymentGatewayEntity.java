...
/**
 * Enterprise domain model representing SbiCollectFeePaymentGateway.
 * State Bank of India Collect payment gateway webhook handler with double-entry transaction validation.
 */
public class SbiCollectFeePaymentGatewayEntity implements Serializable {
    ...
    public SbiCollectFeePaymentGatewayEntity() {
    ...
    public SbiCollectFeePaymentGatewayEntity(String id, String referenceCode, String studentId, String officerId,
    ...
    public boolean equals(Object o) {
        ...
        SbiCollectFeePaymentGatewayEntity that = (SbiCollectFeePaymentGatewayEntity) o;
    ...
    public String toString() {
        return "SbiCollectFeePaymentGatewayEntity{" +
                "id='" + id + '\'' +
