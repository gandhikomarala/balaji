...
/**
 * Data Transfer Object for SbiCollectFeePaymentGateway execution.
 */
public class SbiCollectFeePaymentGatewayRequestDto implements Serializable {
    ...
    public SbiCollectFeePaymentGatewayRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public SbiCollectFeePaymentGatewayRequestDto(String studentId, String officerId, String academicYear,
