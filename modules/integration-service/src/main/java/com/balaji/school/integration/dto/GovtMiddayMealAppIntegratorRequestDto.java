...
/**
 * Data Transfer Object for GovtMiddayMealAppIntegrator execution.
 */
public class GovtMiddayMealAppIntegratorRequestDto implements Serializable {
    ...
    public GovtMiddayMealAppIntegratorRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public GovtMiddayMealAppIntegratorRequestDto(String studentId, String officerId, String academicYear,
