...
import com.balaji.school.integration.service.SbiCollectFeePaymentGatewayService;
...
/**
 * REST API Endpoint Controller for SbiCollectFeePaymentGateway.
 */
public class SbiCollectFeePaymentGatewayController {

    private final SbiCollectFeePaymentGatewayService service;

    public SbiCollectFeePaymentGatewayController() {
        this.service = new SbiCollectFeePaymentGatewayService();
    }

    public SbiCollectFeePaymentGatewayController(SbiCollectFeePaymentGatewayService service) {
        this.service = service != null ? service : new SbiCollectFeePaymentGatewayService();
    }

    public Map<String, Object> listAll() {
        List<SbiCollectFeePaymentGatewayEntity> records = service.getAll();
    ...
    public Map<String, Object> findById(String id) {
        Optional<SbiCollectFeePaymentGatewayEntity> entity = service.getById(id);
        Map<String, Object> response = new HashMap<>();
        if (entity.isPresent()) {
            response.put("statusCode", 200);
    ...
    public Map<String, Object> createEntry(SbiCollectFeePaymentGatewayRequestDto request) {
        Map<String, Object> response = new HashMap<>();
        try {
            SbiCollectFeePaymentGatewayEntity created = service.executeWorkflow(request);
