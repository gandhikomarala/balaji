...
/**
 * Enterprise domain model representing ApStateEducationPortalSync.
 * Integrates with Andhra Pradesh SCERT Child Info portal and U-DISE+ annual government data sync.
 */
public class ApStateEducationPortalSyncEntity implements Serializable {
    ...
    public ApStateEducationPortalSyncEntity() {
    ...
    public ApStateEducationPortalSyncEntity(String id, String referenceCode, String studentId, String officerId,
    ...
    public boolean equals(Object o) {
        ...
        ApStateEducationPortalSyncEntity that = (ApStateEducationPortalSyncEntity) o;
    ...
    public String toString() {
        return "ApStateEducationPortalSyncEntity{" +
                "id='" + id + '\'' +
