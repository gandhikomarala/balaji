...
import com.balaji.school.integration.service.ApStateEducationPortalSyncService;
...
/**
 * REST API Endpoint Controller for ApStateEducationPortalSync.
 */
public class ApStateEducationPortalSyncController {

    private final ApStateEducationPortalSyncService service;

    public ApStateEducationPortalSyncController() {
        this.service = new ApStateEducationPortalSyncService();
    }

    public ApStateEducationPortalSyncController(ApStateEducationPortalSyncService service) {
        this.service = service != null ? service : new ApStateEducationPortalSyncService();
    }

    public Map<String, Object> listAll() {
        List<ApStateEducationPortalSyncEntity> records = service.getAll();
    ...
    public Map<String, Object> findById(String id) {
        Optional<ApStateEducationPortalSyncEntity> entity = service.getById(id);
        Map<String, Object> response = new HashMap<>();
        if (entity.isPresent()) {
            response.put("statusCode", 200);
    ...
    public Map<String, Object> createEntry(ApStateEducationPortalSyncRequestDto request) {
        Map<String, Object> response = new HashMap<>();
        try {
            ApStateEducationPortalSyncEntity created = service.executeWorkflow(request);
