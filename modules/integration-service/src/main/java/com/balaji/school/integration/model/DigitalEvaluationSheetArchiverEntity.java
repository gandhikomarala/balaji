package com.balaji.school.integration.model;
...
/**
 * Enterprise domain model representing DigitalEvaluationSheetArchiver.
 * Converts scanned handwritten 10th standard exam answer scripts to encrypted digital PDF archives.
 */
public class DigitalEvaluationSheetArchiverEntity implements Serializable {
    ...
    public DigitalEvaluationSheetArchiverEntity() {
    ...
    public DigitalEvaluationSheetArchiverEntity(String id, String referenceCode, String studentId, String officerId,
    ...
    public boolean equals(Object o) {
        ...
        DigitalEvaluationSheetArchiverEntity that = (DigitalEvaluationSheetArchiverEntity) o;
    ...
    public String toString() {
        return "DigitalEvaluationSheetArchiverEntity{" +
                "id='" + id + '\'' +
