...
/**
 * Data Transfer Object for StudentGrievanceRedressal transactions.
 */
public class StudentGrievanceRedressalRequestDto implements Serializable {
    ...
    public StudentGrievanceRedressalRequestDto() {
        this.academicYear = "2026-2027";
    }

    public StudentGrievanceRedressalRequestDto(String studentId, String teacherId, String academicYear,
