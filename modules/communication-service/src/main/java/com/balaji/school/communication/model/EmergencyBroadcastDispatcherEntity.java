package com.balaji.school.communication.model;
...
/**
 * Enterprise domain model representing EmergencyBroadcastDispatcher.
 * District collector cyclone/heavy rain holiday broadcast dispatcher and instant parent voice/SMS broadcast alerts.
 */
public class EmergencyBroadcastDispatcherEntity implements Serializable {
    ...
    public EmergencyBroadcastDispatcherEntity() {
    ...
    public EmergencyBroadcastDispatcherEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        EmergencyBroadcastDispatcherEntity that = (EmergencyBroadcastDispatcherEntity) o;
    ...
    public String toString() {
        return "EmergencyBroadcastDispatcherEntity{" +
                "id='" + id + '\'' +
