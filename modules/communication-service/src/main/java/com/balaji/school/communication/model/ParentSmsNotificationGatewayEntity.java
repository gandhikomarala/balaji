...
/**
 * Enterprise domain model representing ParentSmsNotificationGateway.
 * Multi-lingual Telugu & English transactional SMS delivery, absent student morning alerts, and fee reminder pings.
 */
public class ParentSmsNotificationGatewayEntity implements Serializable {
    ...
    public ParentSmsNotificationGatewayEntity() {
    ...
    public ParentSmsNotificationGatewayEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        ParentSmsNotificationGatewayEntity that = (ParentSmsNotificationGatewayEntity) o;
    ...
    public String toString() {
        return "ParentSmsNotificationGatewayEntity{" +
                "id='" + id + '\'' +
