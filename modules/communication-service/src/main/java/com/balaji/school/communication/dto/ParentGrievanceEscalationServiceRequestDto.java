package com.balaji.school.communication.dto;

import java.io.Serializable;
import java.time.LocalDateTime;

/**
 * Data Transfer Object for ParentGrievanceEscalationService execution.
 */
public class ParentGrievanceEscalationServiceRequestDto implements Serializable {
    ...
    public ParentGrievanceEscalationServiceRequestDto() {
        this.academicSession = "2026-2027";
        this.targetExecutionDate = LocalDateTime.now();
    }

    public ParentGrievanceEscalationServiceRequestDto(String studentId, String employeeId, String academicSession,
