...
/**
 * Data Transfer Object for AlumniCareerMentorshipRegistry execution.
 */
public class AlumniCareerMentorshipRegistryRequestDto implements Serializable {
    ...
    public AlumniCareerMentorshipRegistryRequestDto() {
        this.academicSession = "2026-2027";
        this.targetExecutionDate = LocalDateTime.now();
    }

    public AlumniCareerMentorshipRegistryRequestDto(String studentId, String employeeId, String academicSession,
