...
/**
 * Data Transfer Object for DigitalNoticeBoardHub transactions.
 */
public class DigitalNoticeBoardHubRequestDto implements Serializable {
    ...
    public DigitalNoticeBoardHubRequestDto() {
        this.academicYear = "2026-2027";
    }

    public DigitalNoticeBoardHubRequestDto(String studentId, String teacherId, String academicYear,
