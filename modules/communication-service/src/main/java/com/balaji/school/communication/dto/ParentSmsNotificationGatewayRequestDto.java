...
/**
 * Data Transfer Object for ParentSmsNotificationGateway transactions.
 */
public class ParentSmsNotificationGatewayRequestDto implements Serializable {
    ...
    public ParentSmsNotificationGatewayRequestDto() {
        this.academicYear = "2026-2027";
    }

    public ParentSmsNotificationGatewayRequestDto(String studentId, String teacherId, String academicYear,
