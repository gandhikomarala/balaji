...
/**
 * Data Transfer Object for TeluguMediumNewsletterService transactions.
 */
public class TeluguMediumNewsletterServiceRequestDto implements Serializable {
    ...
    public TeluguMediumNewsletterServiceRequestDto() {
        this.academicYear = "2026-2027";
    }

    public TeluguMediumNewsletterServiceRequestDto(String studentId, String teacherId, String academicYear,
