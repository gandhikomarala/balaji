...
import com.balaji.school.communication.service.ParentSmsNotificationGatewayService;
...
/**
 * Enterprise REST API Controller for ParentSmsNotificationGateway.
 */
public class ParentSmsNotificationGatewayController {

    private final ParentSmsNotificationGatewayService service;

    public ParentSmsNotificationGatewayController() {
        this.service = new ParentSmsNotificationGatewayService();
    }

    public ParentSmsNotificationGatewayController(ParentSmsNotificationGatewayService service) {
        this.service = service != null ? service : new ParentSmsNotificationGatewayService();
    }

    public Map<String, Object> fetchAll() {
        List<ParentSmsNotificationGatewayEntity> records = service.getAll();
    ...
    public Map<String, Object> fetchById(String id) {
        Optional<ParentSmsNotificationGatewayEntity> entity = service.getById(id);
        Map<String, Object> response = new HashMap<>();
        if (entity.isPresent()) {
            response.put("statusCode", 200);
    ...
    public Map<String, Object> submitRecord(ParentSmsNotificationGatewayRequestDto request) {
        Map<String, Object> response = new HashMap<>();
        try {
            ParentSmsNotificationGatewayEntity created = service.registerEntry(request);
