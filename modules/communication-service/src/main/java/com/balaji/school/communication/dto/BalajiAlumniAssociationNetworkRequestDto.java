...
/**
 * Data Transfer Object for BalajiAlumniAssociationNetwork transactions.
 */
public class BalajiAlumniAssociationNetworkRequestDto implements Serializable {
    ...
    public BalajiAlumniAssociationNetworkRequestDto() {
        this.academicYear = "2026-2027";
    }

    public BalajiAlumniAssociationNetworkRequestDto(String studentId, String teacherId, String academicYear,
