...
/**
 * Data Transfer Object for TeacherAppraisalFeedbackSystem transactions.
 */
public class TeacherAppraisalFeedbackSystemRequestDto implements Serializable {
    ...
    public TeacherAppraisalFeedbackSystemRequestDto() {
        this.academicYear = "2026-2027";
    }

    public TeacherAppraisalFeedbackSystemRequestDto(String studentId, String teacherId, String academicYear,
