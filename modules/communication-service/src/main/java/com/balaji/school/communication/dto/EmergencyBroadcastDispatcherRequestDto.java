...
/**
 * Data Transfer Object for EmergencyBroadcastDispatcher transactions.
 */
public class EmergencyBroadcastDispatcherRequestDto implements Serializable {
    ...
    public EmergencyBroadcastDispatcherRequestDto() {
        this.academicYear = "2026-2027";
    }

    public EmergencyBroadcastDispatcherRequestDto(String studentId, String teacherId, String academicYear,
