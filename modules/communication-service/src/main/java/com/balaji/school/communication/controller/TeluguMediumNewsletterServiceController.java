...
import com.balaji.school.communication.service.TeluguMediumNewsletterServiceService;
...
/**
 * Enterprise REST API Controller for TeluguMediumNewsletterService.
 */
public class TeluguMediumNewsletterServiceController {

    private final TeluguMediumNewsletterServiceService service;

    public TeluguMediumNewsletterServiceController() {
        this.service = new TeluguMediumNewsletterServiceService();
    }

    public TeluguMediumNewsletterServiceController(TeluguMediumNewsletterServiceService service) {
        this.service = service != null ? service : new TeluguMediumNewsletterServiceService();
    }

    public Map<String, Object> fetchAll() {
        List<TeluguMediumNewsletterServiceEntity> records = service.getAll();
    ...
    public Map<String, Object> fetchById(String id) {
        Optional<TeluguMediumNewsletterServiceEntity> entity = service.getById(id);
        Map<String, Object> response = new HashMap<>();
        if (entity.isPresent()) {
            response.put("statusCode", 200);
    ...
    public Map<String, Object> submitRecord(TeluguMediumNewsletterServiceRequestDto request) {
        Map<String, Object> response = new HashMap<>();
        try {
            TeluguMediumNewsletterServiceEntity created = service.registerEntry(request);
