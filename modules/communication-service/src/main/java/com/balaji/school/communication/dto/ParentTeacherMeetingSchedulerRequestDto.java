...
/**
 * Data Transfer Object for ParentTeacherMeetingScheduler transactions.
 */
public class ParentTeacherMeetingSchedulerRequestDto implements Serializable {
    ...
    public ParentTeacherMeetingSchedulerRequestDto() {
        this.academicYear = "2026-2027";
    }

    public ParentTeacherMeetingSchedulerRequestDto(String studentId, String teacherId, String academicYear,
