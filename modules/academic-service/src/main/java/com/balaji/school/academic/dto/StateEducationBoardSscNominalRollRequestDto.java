...
/**
 * Data Transfer Object for StateEducationBoardSscNominalRoll execution.
 */
public class StateEducationBoardSscNominalRollRequestDto implements Serializable {
    ...
    public StateEducationBoardSscNominalRollRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public StateEducationBoardSscNominalRollRequestDto(String studentId, String officerId, String academicYear,
