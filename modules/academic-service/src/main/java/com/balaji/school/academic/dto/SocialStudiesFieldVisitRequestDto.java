...
/**
 * Data Transfer Object for SocialStudiesFieldVisit transactions.
 */
public class SocialStudiesFieldVisitRequestDto implements Serializable {
    ...
    public SocialStudiesFieldVisitRequestDto() {
        this.academicYear = "2026-2027";
    }

    public SocialStudiesFieldVisitRequestDto(String studentId, String teacherId, String academicYear,
