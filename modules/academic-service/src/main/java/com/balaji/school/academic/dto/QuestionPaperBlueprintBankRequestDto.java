...
/**
 * Data Transfer Object for QuestionPaperBlueprintBank transactions.
 */
public class QuestionPaperBlueprintBankRequestDto implements Serializable {
    ...
    public QuestionPaperBlueprintBankRequestDto() {
        this.academicYear = "2026-2027";
    }

    public QuestionPaperBlueprintBankRequestDto(String studentId, String teacherId, String academicYear,
