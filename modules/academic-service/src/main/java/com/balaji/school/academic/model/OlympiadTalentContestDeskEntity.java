...
/**
 * Enterprise domain model representing OlympiadTalentContestDesk.
 * NMMS (National Means-cum-Merit Scholarship), NTSE, and State Science Fair registration and mock test manager.
 */
public class OlympiadTalentContestDeskEntity implements Serializable {
    ...
    public OlympiadTalentContestDeskEntity() {
    ...
    public OlympiadTalentContestDeskEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        OlympiadTalentContestDeskEntity that = (OlympiadTalentContestDeskEntity) o;
    ...
    public String toString() {
        return "OlympiadTalentContestDeskEntity{" +
                "id='" + id + '\'' +
