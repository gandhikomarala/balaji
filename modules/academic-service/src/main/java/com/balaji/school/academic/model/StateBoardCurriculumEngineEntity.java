...
/**
 * Enterprise domain model representing StateBoardCurriculumEngine.
 * SCERT Andhra Pradesh syllabus milestones, weekly unit lesson planning, and digital smart-board content.
 */
public class StateBoardCurriculumEngineEntity implements Serializable {
    ...
    public StateBoardCurriculumEngineEntity() {
    ...
    public StateBoardCurriculumEngineEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        StateBoardCurriculumEngineEntity that = (StateBoardCurriculumEngineEntity) o;
    ...
    public String toString() {
        return "StateBoardCurriculumEngineEntity{" +
                "id='" + id + '\'' +
