...
/**
 * Data Transfer Object for SummativeBoardExamination transactions.
 */
public class SummativeBoardExaminationRequestDto implements Serializable {
    ...
    public SummativeBoardExaminationRequestDto() {
        this.academicYear = "2026-2027";
    }

    public SummativeBoardExaminationRequestDto(String studentId, String teacherId, String academicYear,
