...
/**
 * Data Transfer Object for ScienceLabApparatusSafetyInspection execution.
 */
public class ScienceLabApparatusSafetyInspectionRequestDto implements Serializable {
    ...
    public ScienceLabApparatusSafetyInspectionRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public ScienceLabApparatusSafetyInspectionRequestDto(String studentId, String officerId, String academicYear,
