...
/**
 * Data Transfer Object for ScienceFairExhibitionScorer execution.
 */
public class ScienceFairExhibitionScorerRequestDto implements Serializable {
    ...
    public ScienceFairExhibitionScorerRequestDto() {
        this.academicSession = "2026-2027";
        this.targetExecutionDate = LocalDateTime.now();
    }

    public ScienceFairExhibitionScorerRequestDto(String studentId, String employeeId, String academicSession,
