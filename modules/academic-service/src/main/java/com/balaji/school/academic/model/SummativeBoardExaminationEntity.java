...
/**
 * Enterprise domain model representing SummativeBoardExamination.
 * SA-1 and SA-2 summative examination hall ticket generation, seating arrangement, and external examiner invigilation.
 */
public class SummativeBoardExaminationEntity implements Serializable {
    ...
    public SummativeBoardExaminationEntity() {
    ...
    public SummativeBoardExaminationEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        SummativeBoardExaminationEntity that = (SummativeBoardExaminationEntity) o;
    ...
    public String toString() {
        return "SummativeBoardExaminationEntity{" +
                "id='" + id + '\'' +
