...
/**
 * Data Transfer Object for ScienceLaboratoryInventory transactions.
 */
public class ScienceLaboratoryInventoryRequestDto implements Serializable {
    ...
    public ScienceLaboratoryInventoryRequestDto() {
        this.academicYear = "2026-2027";
    }

    public ScienceLaboratoryInventoryRequestDto(String studentId, String teacherId, String academicYear,
