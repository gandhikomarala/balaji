...
/**
 * Data Transfer Object for MathematicsPracticalKit transactions.
 */
public class MathematicsPracticalKitRequestDto implements Serializable {
    ...
    public MathematicsPracticalKitRequestDto() {
        this.academicYear = "2026-2027";
    }

    public MathematicsPracticalKitRequestDto(String studentId, String teacherId, String academicYear,
