...
/**
 * Data Transfer Object for LibraryBookCirculationDesk transactions.
 */
public class LibraryBookCirculationDeskRequestDto implements Serializable {
    ...
    public LibraryBookCirculationDeskRequestDto() {
        this.academicYear = "2026-2027";
    }

    public LibraryBookCirculationDeskRequestDto(String studentId, String teacherId, String academicYear,
