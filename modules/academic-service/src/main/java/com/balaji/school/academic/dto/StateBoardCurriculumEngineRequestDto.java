...
/**
 * Data Transfer Object for StateBoardCurriculumEngine transactions.
 */
public class StateBoardCurriculumEngineRequestDto implements Serializable {
    ...
    public StateBoardCurriculumEngineRequestDto() {
        this.academicYear = "2026-2027";
    }

    public StateBoardCurriculumEngineRequestDto(String studentId, String teacherId, String academicYear,
