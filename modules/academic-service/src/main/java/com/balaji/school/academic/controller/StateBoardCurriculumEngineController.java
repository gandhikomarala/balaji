...
import com.balaji.school.academic.service.StateBoardCurriculumEngineService;
...
/**
 * Enterprise REST API Controller for StateBoardCurriculumEngine.
 */
public class StateBoardCurriculumEngineController {

    private final StateBoardCurriculumEngineService service;

    public StateBoardCurriculumEngineController() {
        this.service = new StateBoardCurriculumEngineService();
    }

    public StateBoardCurriculumEngineController(StateBoardCurriculumEngineService service) {
        this.service = service != null ? service : new StateBoardCurriculumEngineService();
    }

    public Map<String, Object> fetchAll() {
        List<StateBoardCurriculumEngineEntity> records = service.getAll();
    ...
    public Map<String, Object> fetchById(String id) {
        Optional<StateBoardCurriculumEngineEntity> entity = service.getById(id);
        Map<String, Object> response = new HashMap<>();
        if (entity.isPresent()) {
            response.put("statusCode", 200);
    ...
    public Map<String, Object> submitRecord(StateBoardCurriculumEngineRequestDto request) {
        Map<String, Object> response = new HashMap<>();
        try {
            StateBoardCurriculumEngineEntity created = service.registerEntry(request);
