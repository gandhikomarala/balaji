...
/**
 * Data Transfer Object for DigitalHomeworkAssignment transactions.
 */
public class DigitalHomeworkAssignmentRequestDto implements Serializable {
    ...
    public DigitalHomeworkAssignmentRequestDto() {
        this.academicYear = "2026-2027";
    }

    public DigitalHomeworkAssignmentRequestDto(String studentId, String teacherId, String academicYear,
