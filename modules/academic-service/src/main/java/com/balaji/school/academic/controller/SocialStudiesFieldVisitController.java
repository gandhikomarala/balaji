...
import com.balaji.school.academic.service.SocialStudiesFieldVisitService;
...
/**
 * Enterprise REST API Controller for SocialStudiesFieldVisit.
 */
public class SocialStudiesFieldVisitController {

    private final SocialStudiesFieldVisitService service;

    public SocialStudiesFieldVisitController() {
        this.service = new SocialStudiesFieldVisitService();
    }

    public SocialStudiesFieldVisitController(SocialStudiesFieldVisitService service) {
        this.service = service != null ? service : new SocialStudiesFieldVisitService();
    }

    public Map<String, Object> fetchAll() {
        List<SocialStudiesFieldVisitEntity> records = service.getAll();
    ...
    public Map<String, Object> fetchById(String id) {
        Optional<SocialStudiesFieldVisitEntity> entity = service.getById(id);
        Map<String, Object> response = new HashMap<>();
        if (entity.isPresent()) {
            response.put("statusCode", 200);
    ...
    public Map<String, Object> submitRecord(SocialStudiesFieldVisitRequestDto request) {
        Map<String, Object> response = new HashMap<>();
        try {
            SocialStudiesFieldVisitEntity created = service.registerEntry(request);
