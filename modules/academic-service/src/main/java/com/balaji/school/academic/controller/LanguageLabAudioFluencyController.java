...
import com.balaji.school.academic.service.LanguageLabAudioFluencyService;
...
/**
 * Enterprise REST API Controller for LanguageLabAudioFluency.
 */
public class LanguageLabAudioFluencyController {

    private final LanguageLabAudioFluencyService service;

    public LanguageLabAudioFluencyController() {
        this.service = new LanguageLabAudioFluencyService();
    }

    public LanguageLabAudioFluencyController(LanguageLabAudioFluencyService service) {
        this.service = service != null ? service : new LanguageLabAudioFluencyService();
    }

    public Map<String, Object> fetchAll() {
        List<LanguageLabAudioFluencyEntity> records = service.getAll();
    ...
    public Map<String, Object> fetchById(String id) {
        Optional<LanguageLabAudioFluencyEntity> entity = service.getById(id);
        Map<String, Object> response = new HashMap<>();
        if (entity.isPresent()) {
            response.put("statusCode", 200);
    ...
    public Map<String, Object> submitRecord(LanguageLabAudioFluencyRequestDto request) {
        Map<String, Object> response = new HashMap<>();
        try {
            LanguageLabAudioFluencyEntity created = service.registerEntry(request);
