...
/**
 * Data Transfer Object for SscGradingMarksMemo transactions.
 */
public class SscGradingMarksMemoRequestDto implements Serializable {
    ...
    public SscGradingMarksMemoRequestDto() {
        this.academicYear = "2026-2027";
    }

    public SscGradingMarksMemoRequestDto(String studentId, String teacherId, String academicYear,
