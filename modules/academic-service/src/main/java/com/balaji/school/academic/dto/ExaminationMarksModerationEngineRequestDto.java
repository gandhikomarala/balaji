...
/**
 * Data Transfer Object for ExaminationMarksModerationEngine execution.
 */
public class ExaminationMarksModerationEngineRequestDto implements Serializable {
    ...
    public ExaminationMarksModerationEngineRequestDto() {
        this.academicSession = "2026-2027";
        this.targetExecutionDate = LocalDateTime.now();
    }

    public ExaminationMarksModerationEngineRequestDto(String studentId, String employeeId, String academicSession,
