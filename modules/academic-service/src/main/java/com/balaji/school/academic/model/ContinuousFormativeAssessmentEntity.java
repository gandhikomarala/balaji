...
/**
 * Enterprise domain model representing ContinuousFormativeAssessment.
 * FA-1, FA-2, FA-3, FA-4 formative assessment project work grading, lab activity records, and slip test scores.
 */
public class ContinuousFormativeAssessmentEntity implements Serializable {
    ...
    public ContinuousFormativeAssessmentEntity() {
    ...
    public ContinuousFormativeAssessmentEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        ContinuousFormativeAssessmentEntity that = (ContinuousFormativeAssessmentEntity) o;
    ...
    public String toString() {
        return "ContinuousFormativeAssessmentEntity{" +
                "id='" + id + '\'' +
