...
import com.balaji.school.academic.service.ScienceFairExhibitionScorerService;
...
/**
 * Enterprise REST API Controller for ScienceFairExhibitionScorer.
 */
public class ScienceFairExhibitionScorerController {

    private final ScienceFairExhibitionScorerService service;

    public ScienceFairExhibitionScorerController() {
        this.service = new ScienceFairExhibitionScorerService();
    }

    public ScienceFairExhibitionScorerController(ScienceFairExhibitionScorerService service) {
        this.service = service != null ? service : new ScienceFairExhibitionScorerService();
    }

    public Map<String, Object> listAll() {
        List<ScienceFairExhibitionScorerEntity> records = service.retrieveAllRecords();
    ...
    public Map<String, Object> getById(String id) {
        Optional<ScienceFairExhibitionScorerEntity> entity = service.retrieveById(id);
        Map<String, Object> response = new HashMap<>();
        if (entity.isPresent()) {
            response.put("statusCode", 200);
    ...
    public Map<String, Object> submitRecord(ScienceFairExhibitionScorerRequestDto request) {
        Map<String, Object> response = new HashMap<>();
        try {
            ScienceFairExhibitionScorerEntity created = service.executeWorkflow(request);
