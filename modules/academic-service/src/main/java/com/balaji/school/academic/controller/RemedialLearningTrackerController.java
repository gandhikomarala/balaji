...
import com.balaji.school.academic.service.RemedialLearningTrackerService;
...
/**
 * Enterprise REST API Controller for RemedialLearningTracker.
 */
public class RemedialLearningTrackerController {

    private final RemedialLearningTrackerService service;

    public RemedialLearningTrackerController() {
        this.service = new RemedialLearningTrackerService();
    }

    public RemedialLearningTrackerController(RemedialLearningTrackerService service) {
        this.service = service != null ? service : new RemedialLearningTrackerService();
    }

    public Map<String, Object> fetchAll() {
        List<RemedialLearningTrackerEntity> records = service.getAll();
    ...
    public Map<String, Object> fetchById(String id) {
        Optional<RemedialLearningTrackerEntity> entity = service.getById(id);
        Map<String, Object> response = new HashMap<>();
        if (entity.isPresent()) {
            response.put("statusCode", 200);
    ...
    public Map<String, Object> submitRecord(RemedialLearningTrackerRequestDto request) {
        Map<String, Object> response = new HashMap<>();
        try {
            RemedialLearningTrackerEntity created = service.registerEntry(request);
