...
/**
 * Data Transfer Object for FacultyLessonPlanAudit transactions.
 */
public class FacultyLessonPlanAuditRequestDto implements Serializable {
    ...
    public FacultyLessonPlanAuditRequestDto() {
        this.academicYear = "2026-2027";
    }

    public FacultyLessonPlanAuditRequestDto(String studentId, String teacherId, String academicYear,
