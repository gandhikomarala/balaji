...
/**
 * Data Transfer Object for TeluguMediumElocutionEvaluator execution.
 */
public class TeluguMediumElocutionEvaluatorRequestDto implements Serializable {
    ...
    public TeluguMediumElocutionEvaluatorRequestDto() {
        this.academicSession = "2026-2027";
        this.targetExecutionDate = LocalDateTime.now();
    }

    public TeluguMediumElocutionEvaluatorRequestDto(String studentId, String employeeId, String academicSession,
