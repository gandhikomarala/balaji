...
/**
 * Enterprise domain model representing ComputerScienceLabTerminal.
 * ICT computer laboratory terminal allocation, programming curriculum exercises, and internet firewall filters.
 */
public class ComputerScienceLabTerminalEntity implements Serializable {
    ...
    public ComputerScienceLabTerminalEntity() {
    ...
    public ComputerScienceLabTerminalEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        ComputerScienceLabTerminalEntity that = (ComputerScienceLabTerminalEntity) o;
    ...
    public String toString() {
        return "ComputerScienceLabTerminalEntity{" +
                "id='" + id + '\'' +
