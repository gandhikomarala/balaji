...
/**
 * Data Transfer Object for DigitalLibraryEbookCatalogManager execution.
 */
public class DigitalLibraryEbookCatalogManagerRequestDto implements Serializable {
    ...
    public DigitalLibraryEbookCatalogManagerRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public DigitalLibraryEbookCatalogManagerRequestDto(String studentId, String officerId, String academicYear,
