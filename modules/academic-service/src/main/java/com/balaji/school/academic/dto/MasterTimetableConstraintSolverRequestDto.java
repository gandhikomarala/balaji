...
/**
 * Data Transfer Object for MasterTimetableConstraintSolver transactions.
 */
public class MasterTimetableConstraintSolverRequestDto implements Serializable {
    ...
    public MasterTimetableConstraintSolverRequestDto() {
        this.academicYear = "2026-2027";
    }

    public MasterTimetableConstraintSolverRequestDto(String studentId, String teacherId, String academicYear,
