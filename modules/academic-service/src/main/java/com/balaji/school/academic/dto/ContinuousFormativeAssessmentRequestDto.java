...
/**
 * Data Transfer Object for ContinuousFormativeAssessment transactions.
 */
public class ContinuousFormativeAssessmentRequestDto implements Serializable {
    ...
    public ContinuousFormativeAssessmentRequestDto() {
        this.academicYear = "2026-2027";
    }

    public ContinuousFormativeAssessmentRequestDto(String studentId, String teacherId, String academicYear,
