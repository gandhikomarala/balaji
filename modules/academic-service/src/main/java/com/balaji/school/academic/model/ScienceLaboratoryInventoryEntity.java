...
/**
 * Enterprise domain model representing ScienceLaboratoryInventory.
 * Physics, Chemistry, and Biology apparatus stock ledger, chemical reagent expiry audits, and student experiment logs.
 */
public class ScienceLaboratoryInventoryEntity implements Serializable {
    ...
    public ScienceLaboratoryInventoryEntity() {
    ...
    public ScienceLaboratoryInventoryEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        ScienceLaboratoryInventoryEntity that = (ScienceLaboratoryInventoryEntity) o;
    ...
    public String toString() {
        return "ScienceLaboratoryInventoryEntity{" +
                "id='" + id + '\'' +
