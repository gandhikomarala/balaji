...
/**
 * Enterprise domain model representing SscGradingMarksMemo.
 * AP SSC 10-point GPA calculation engine, subject-wise grade point computation (A1 to E), and cumulative marks sheets.
 */
public class SscGradingMarksMemoEntity implements Serializable {
    ...
    public SscGradingMarksMemoEntity() {
    ...
    public SscGradingMarksMemoEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        SscGradingMarksMemoEntity that = (SscGradingMarksMemoEntity) o;
    ...
    public String toString() {
        return "SscGradingMarksMemoEntity{" +
                "id='" + id + '\'' +
