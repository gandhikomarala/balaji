...
/**
 * Data Transfer Object for ExaminationSeatingArrangementEngine execution.
 */
public class ExaminationSeatingArrangementEngineRequestDto implements Serializable {
    ...
    public ExaminationSeatingArrangementEngineRequestDto() {
        this.academicYear = "2026-2027";
        this.requestedDate = LocalDateTime.now();
    }

    public ExaminationSeatingArrangementEngineRequestDto(String studentId, String officerId, String academicYear,
