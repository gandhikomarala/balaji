...
/**
 * Data Transfer Object for DigitalHallTicketGenerator execution.
 */
public class DigitalHallTicketGeneratorRequestDto implements Serializable {
    ...
    public DigitalHallTicketGeneratorRequestDto() {
        this.academicSession = "2026-2027";
        this.targetExecutionDate = LocalDateTime.now();
    }

    public DigitalHallTicketGeneratorRequestDto(String studentId, String employeeId, String academicSession,
