...
/**
 * Data Transfer Object for LanguageLabAudioFluency transactions.
 */
public class LanguageLabAudioFluencyRequestDto implements Serializable {
    ...
    public LanguageLabAudioFluencyRequestDto() {
        this.academicYear = "2026-2027";
    }

    public LanguageLabAudioFluencyRequestDto(String studentId, String teacherId, String academicYear,
