...
/**
 * Data Transfer Object for SportsTournamentFixtureSolver execution.
 */
public class SportsTournamentFixtureSolverRequestDto implements Serializable {
    ...
    public SportsTournamentFixtureSolverRequestDto() {
        this.academicSession = "2026-2027";
        this.targetExecutionDate = LocalDateTime.now();
    }

    public SportsTournamentFixtureSolverRequestDto(String studentId, String employeeId, String academicSession,
