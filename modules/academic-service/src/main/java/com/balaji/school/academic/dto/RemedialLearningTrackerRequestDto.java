...
/**
 * Data Transfer Object for RemedialLearningTracker transactions.
 */
public class RemedialLearningTrackerRequestDto implements Serializable {
    ...
    public RemedialLearningTrackerRequestDto() {
        this.academicYear = "2026-2027";
    }

    public RemedialLearningTrackerRequestDto(String studentId, String teacherId, String academicYear,
