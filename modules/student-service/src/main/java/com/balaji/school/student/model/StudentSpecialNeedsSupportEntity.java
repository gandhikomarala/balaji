...
/**
 * Enterprise domain model representing StudentSpecialNeedsSupport.
 * Inclusive education support, visual/hearing aid accommodation, scribe allocations, and counselor notes.
 */
public class StudentSpecialNeedsSupportEntity implements Serializable {
    ...
    public StudentSpecialNeedsSupportEntity() {
    ...
    public StudentSpecialNeedsSupportEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        StudentSpecialNeedsSupportEntity that = (StudentSpecialNeedsSupportEntity) o;
    ...
    public String toString() {
        return "StudentSpecialNeedsSupportEntity{" +
                "id='" + id + '\'' +
