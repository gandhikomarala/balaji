...
/**
 * Data Transfer Object for StudentAlumniTransitionRegistry transactions.
 */
public class StudentAlumniTransitionRegistryRequestDto implements Serializable {
    ...
    public StudentAlumniTransitionRegistryRequestDto() {
        this.academicYear = "2026-2027";
    }

    public StudentAlumniTransitionRegistryRequestDto(String studentId, String teacherId, String academicYear,
