...
/**
 * Enterprise domain model representing StudentDisciplineDemerit.
 * Classroom disciplinary logs, positive behavior reward points, counselor guidance records, and parent notices.
 */
public class StudentDisciplineDemeritEntity implements Serializable {
    ...
    public StudentDisciplineDemeritEntity() {
    ...
    public StudentDisciplineDemeritEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        StudentDisciplineDemeritEntity that = (StudentDisciplineDemeritEntity) o;
    ...
    public String toString() {
        return "StudentDisciplineDemeritEntity{" +
                "id='" + id + '\'' +
