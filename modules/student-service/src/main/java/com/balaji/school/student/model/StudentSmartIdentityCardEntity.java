...
/**
 * Enterprise domain model representing StudentSmartIdentityCard.
 * Cryptographic NFC/RFID smart identity card issuance, photo personalization, and digital barcode generation.
 */
public class StudentSmartIdentityCardEntity implements Serializable {
    ...
    public StudentSmartIdentityCardEntity() {
    ...
    public StudentSmartIdentityCardEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        StudentSmartIdentityCardEntity that = (StudentSmartIdentityCardEntity) o;
    ...
    public String toString() {
        return "StudentSmartIdentityCardEntity{" +
                "id='" + id + '\'' +
