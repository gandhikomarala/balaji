...
/**
 * Data Transfer Object for StudentDisciplinaryCouncilService execution.
 */
public class StudentDisciplinaryCouncilServiceRequestDto implements Serializable {
    ...
    public StudentDisciplinaryCouncilServiceRequestDto() {
        this.academicSession = "2026-2027";
        this.targetExecutionDate = LocalDateTime.now();
    }

    public StudentDisciplinaryCouncilServiceRequestDto(String studentId, String employeeId, String academicSession,
