...
/**
 * Data Transfer Object for StudentParentAssociation transactions.
 */
public class StudentParentAssociationRequestDto implements Serializable {
    ...
    public StudentParentAssociationRequestDto() {
        this.academicYear = "2026-2027";
    }

    public StudentParentAssociationRequestDto(String studentId, String teacherId, String academicYear,
