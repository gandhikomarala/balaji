...
import com.balaji.school.student.service.StudentSmartIdentityCardService;
...
/**
 * Enterprise REST API Controller for StudentSmartIdentityCard.
 */
public class StudentSmartIdentityCardController {

    private final StudentSmartIdentityCardService service;

    public StudentSmartIdentityCardController() {
        this.service = new StudentSmartIdentityCardService();
    }

    public StudentSmartIdentityCardController(StudentSmartIdentityCardService service) {
        this.service = service != null ? service : new StudentSmartIdentityCardService();
    }

    public Map<String, Object> fetchAll() {
        List<StudentSmartIdentityCardEntity> records = service.getAll();
    ...
    public Map<String, Object> fetchById(String id) {
        Optional<StudentSmartIdentityCardEntity> entity = service.getById(id);
        Map<String, Object> response = new HashMap<>();
        if (entity.isPresent()) {
            response.put("statusCode", 200);
    ...
    public Map<String, Object> submitRecord(StudentSmartIdentityCardRequestDto request) {
        Map<String, Object> response = new HashMap<>();
        try {
            StudentSmartIdentityCardEntity created = service.registerEntry(request);
