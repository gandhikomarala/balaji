...
/**
 * Data Transfer Object for StudentDisciplineDemerit transactions.
 */
public class StudentDisciplineDemeritRequestDto implements Serializable {
    ...
    public StudentDisciplineDemeritRequestDto() {
        this.academicYear = "2026-2027";
    }

    public StudentDisciplineDemeritRequestDto(String studentId, String teacherId, String academicYear,
