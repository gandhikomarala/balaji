...
/**
 * Data Transfer Object for StudentBiometricAttendance transactions.
 */
public class StudentBiometricAttendanceRequestDto implements Serializable {
    ...
    public StudentBiometricAttendanceRequestDto() {
        this.academicYear = "2026-2027";
    }

    public StudentBiometricAttendanceRequestDto(String studentId, String teacherId, String academicYear,
