...
/**
 * Data Transfer Object for StudentSpecialNeedsSupport transactions.
 */
public class StudentSpecialNeedsSupportRequestDto implements Serializable {
    ...
    public StudentSpecialNeedsSupportRequestDto() {
        this.academicYear = "2026-2027";
    }

    public StudentSpecialNeedsSupportRequestDto(String studentId, String teacherId, String academicYear,
