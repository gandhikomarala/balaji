...
/**
 * Data Transfer Object for StudentSmartIdentityCard transactions.
 */
public class StudentSmartIdentityCardRequestDto implements Serializable {
    ...
    public StudentSmartIdentityCardRequestDto() {
        this.academicYear = "2026-2027";
    }

    public StudentSmartIdentityCardRequestDto(String studentId, String teacherId, String academicYear,
