...
/**
 * Enterprise domain model representing StudentAdmissionWorkflow.
 ...
 */
public class StudentAdmissionWorkflowEntity implements Serializable {
    ...
    public StudentAdmissionWorkflowEntity() {
    ...
    public StudentAdmissionWorkflowEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        StudentAdmissionWorkflowEntity that = (StudentAdmissionWorkflowEntity) o;
    ...
    public String toString() {
        return "StudentAdmissionWorkflowEntity{" +
                "id='" + id + '\'' +
