...
/**
 * Enterprise domain model representing StudentHostelAllocation.
 * Dormitory bed allocation, study-hall attendance, warden night inspection rosters, and mess pass tokens.
 */
public class StudentHostelAllocationEntity implements Serializable {
    ...
    public StudentHostelAllocationEntity() {
    ...
    public StudentHostelAllocationEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        StudentHostelAllocationEntity that = (StudentHostelAllocationEntity) o;
    ...
    public String toString() {
        return "StudentHostelAllocationEntity{" +
                "id='" + id + '\'' +
