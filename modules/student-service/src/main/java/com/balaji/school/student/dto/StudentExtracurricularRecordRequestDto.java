...
/**
 * Data Transfer Object for StudentExtracurricularRecord transactions.
 */
public class StudentExtracurricularRecordRequestDto implements Serializable {
    ...
    public StudentExtracurricularRecordRequestDto() {
        this.academicYear = "2026-2027";
    }

    public StudentExtracurricularRecordRequestDto(String studentId, String teacherId, String academicYear,
