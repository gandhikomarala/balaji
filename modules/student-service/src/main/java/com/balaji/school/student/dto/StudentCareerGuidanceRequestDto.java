...
/**
 * Data Transfer Object for StudentCareerGuidance transactions.
 */
public class StudentCareerGuidanceRequestDto implements Serializable {
    ...
    public StudentCareerGuidanceRequestDto() {
        this.academicYear = "2026-2027";
    }

    public StudentCareerGuidanceRequestDto(String studentId, String teacherId, String academicYear,
