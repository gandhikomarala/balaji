...
/**
 * Data Transfer Object for StudentHealthImmunization transactions.
 */
public class StudentHealthImmunizationRequestDto implements Serializable {
    ...
    public StudentHealthImmunizationRequestDto() {
        this.academicYear = "2026-2027";
    }

    public StudentHealthImmunizationRequestDto(String studentId, String teacherId, String academicYear,
