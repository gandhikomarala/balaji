...
/**
 * Data Transfer Object for StudentTransportBusPass transactions.
 */
public class StudentTransportBusPassRequestDto implements Serializable {
    ...
    public StudentTransportBusPassRequestDto() {
        this.academicYear = "2026-2027";
    }

    public StudentTransportBusPassRequestDto(String studentId, String teacherId, String academicYear,
