...
/**
 * Enterprise domain model representing StudentParentAssociation.
 * Parent KYC verification, guardian contact details, SMS broadcast consent, and PTA election participation.
 */
public class StudentParentAssociationEntity implements Serializable {
    ...
    public StudentParentAssociationEntity() {
    ...
    public StudentParentAssociationEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        StudentParentAssociationEntity that = (StudentParentAssociationEntity) o;
    ...
    public String toString() {
        return "StudentParentAssociationEntity{" +
                "id='" + id + '\'' +
