...
/**
 * Enterprise domain model representing StudentTransferCertificate.
 * Official school leaving certificate generation, no-dues clearance workflow, and SCERT registration.
 */
public class StudentTransferCertificateEntity implements Serializable {
    ...
    public StudentTransferCertificateEntity() {
    ...
    public StudentTransferCertificateEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        StudentTransferCertificateEntity that = (StudentTransferCertificateEntity) o;
    ...
    public String toString() {
        return "StudentTransferCertificateEntity{" +
                "id='" + id + '\'' +
