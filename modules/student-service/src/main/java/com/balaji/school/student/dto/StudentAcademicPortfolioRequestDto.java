...
/**
 * Data Transfer Object for StudentAcademicPortfolio transactions.
 */
public class StudentAcademicPortfolioRequestDto implements Serializable {
    ...
    public StudentAcademicPortfolioRequestDto() {
        this.academicYear = "2026-2027";
    }

    public StudentAcademicPortfolioRequestDto(String studentId, String teacherId, String academicYear,
