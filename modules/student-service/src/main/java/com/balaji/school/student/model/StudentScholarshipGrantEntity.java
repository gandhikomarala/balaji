...
/**
 * Enterprise domain model representing StudentScholarshipGrant.
 * State scholarship disbursement tracker, Jagananna Vidya Deevena integration, and merit fee waiver ledgers.
 */
public class StudentScholarshipGrantEntity implements Serializable {
    ...
    public StudentScholarshipGrantEntity() {
    ...
    public StudentScholarshipGrantEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        StudentScholarshipGrantEntity that = (StudentScholarshipGrantEntity) o;
    ...
    public String toString() {
        return "StudentScholarshipGrantEntity{" +
                "id='" + id + '\'' +
