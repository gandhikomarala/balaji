...
/**
 * Enterprise domain model representing StudentHealthImmunization.
 * School medical room health checkups, blood grouping, height/weight BMI tracking, and vision screening logs.
 */
public class StudentHealthImmunizationEntity implements Serializable {
    ...
    public StudentHealthImmunizationEntity() {
    ...
    public StudentHealthImmunizationEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        StudentHealthImmunizationEntity that = (StudentHealthImmunizationEntity) o;
    ...
    public String toString() {
        return "StudentHealthImmunizationEntity{" +
                "id='" + id + '\'' +
