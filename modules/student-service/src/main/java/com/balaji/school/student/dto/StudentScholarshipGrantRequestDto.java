...
/**
 * Data Transfer Object for StudentScholarshipGrant transactions.
 */
public class StudentScholarshipGrantRequestDto implements Serializable {
    ...
    public StudentScholarshipGrantRequestDto() {
        this.academicYear = "2026-2027";
    }

    public StudentScholarshipGrantRequestDto(String studentId, String teacherId, String academicYear,
