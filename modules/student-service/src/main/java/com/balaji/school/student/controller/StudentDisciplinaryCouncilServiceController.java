...
import com.balaji.school.student.service.StudentDisciplinaryCouncilServiceService;
...
/**
 * Enterprise REST API Controller for StudentDisciplinaryCouncilService.
 */
public class StudentDisciplinaryCouncilServiceController {

    private final StudentDisciplinaryCouncilServiceService service;

    public StudentDisciplinaryCouncilServiceController() {
        this.service = new StudentDisciplinaryCouncilServiceService();
    }

    public StudentDisciplinaryCouncilServiceController(StudentDisciplinaryCouncilServiceService service) {
        this.service = service != null ? service : new StudentDisciplinaryCouncilServiceService();
    }

    public Map<String, Object> listAll() {
        List<StudentDisciplinaryCouncilServiceEntity> records = service.retrieveAllRecords();
    ...
    public Map<String, Object> getById(String id) {
        Optional<StudentDisciplinaryCouncilServiceEntity> entity = service.retrieveById(id);
        Map<String, Object> response = new HashMap<>();
        if (entity.isPresent()) {
            response.put("statusCode", 200);
    ...
    public Map<String, Object> submitRecord(StudentDisciplinaryCouncilServiceRequestDto request) {
        Map<String, Object> response = new HashMap<>();
        try {
            StudentDisciplinaryCouncilServiceEntity created = service.executeWorkflow(request);
