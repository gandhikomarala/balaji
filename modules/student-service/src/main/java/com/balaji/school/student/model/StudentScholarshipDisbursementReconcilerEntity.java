...
/**
 * Enterprise domain model representing StudentScholarshipDisbursementReconciler.
 * Direct Benefit Transfer (DBT) reconciler for government social welfare grants and BC/SC/ST student stipends.
 */
public class StudentScholarshipDisbursementReconcilerEntity implements Serializable {
    ...
    public StudentScholarshipDisbursementReconcilerEntity() {
    ...
    public StudentScholarshipDisbursementReconcilerEntity(String id, String trackingNumber, String studentId, String employeeId,
    ...
    public boolean equals(Object o) {
        ...
        StudentScholarshipDisbursementReconcilerEntity that = (StudentScholarshipDisbursementReconcilerEntity) o;
    ...
    public String toString() {
        return "StudentScholarshipDisbursementReconcilerEntity{" +
                "id='" + id + '\'' +
