package com.balaji.school.student.dto;

import java.io.Serializable;
import java.time.LocalDateTime;

/**
 * Data Transfer Object for StudentScholarshipDisbursementReconciler execution.
 */
public class StudentScholarshipDisbursementReconcilerRequestDto implements Serializable {
    ...
    public StudentScholarshipDisbursementReconcilerRequestDto() {
        this.academicSession = "2026-2027";
        this.targetExecutionDate = LocalDateTime.now();
    }

    public StudentScholarshipDisbursementReconcilerRequestDto(String studentId, String employeeId, String academicSession,
