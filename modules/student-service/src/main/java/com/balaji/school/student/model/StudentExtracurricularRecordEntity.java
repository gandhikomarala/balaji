...
/**
 * Enterprise domain model representing StudentExtracurricularRecord.
 * Sports, NCC, Scouts & Guides, cultural dance, and debate competition participation awards.
 */
public class StudentExtracurricularRecordEntity implements Serializable {
    ...
    public StudentExtracurricularRecordEntity() {
    ...
    public StudentExtracurricularRecordEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        StudentExtracurricularRecordEntity that = (StudentExtracurricularRecordEntity) o;
    ...
    public String toString() {
        return "StudentExtracurricularRecordEntity{" +
                "id='" + id + '\'' +
