...
/**
 * Enterprise domain model representing StudentCareerGuidance.
 * Aptitude assessment, Polytechnic/Intermediate stream recommendation, and 10th standard board counseling.
 */
public class StudentCareerGuidanceEntity implements Serializable {
    ...
    public StudentCareerGuidanceEntity() {
    ...
    public StudentCareerGuidanceEntity(String id, String referenceNumber, String studentId, String teacherId,
    ...
    public boolean equals(Object o) {
        ...
        StudentCareerGuidanceEntity that = (StudentCareerGuidanceEntity) o;
    ...
    public String toString() {
        return "StudentCareerGuidanceEntity{" +
                "id='" + id + '\'' +
