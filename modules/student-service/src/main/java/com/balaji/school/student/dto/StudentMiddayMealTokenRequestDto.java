...
/**
 * Data Transfer Object for StudentMiddayMealToken transactions.
 */
public class StudentMiddayMealTokenRequestDto implements Serializable {
    ...
    public StudentMiddayMealTokenRequestDto() {
        this.academicYear = "2026-2027";
    }

    public StudentMiddayMealTokenRequestDto(String studentId, String teacherId, String academicYear,
