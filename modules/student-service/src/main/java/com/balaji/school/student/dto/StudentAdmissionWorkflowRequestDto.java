...
/**
 * Data Transfer Object for StudentAdmissionWorkflow transactions.
 */
public class StudentAdmissionWorkflowRequestDto implements Serializable {
    ...
    public StudentAdmissionWorkflowRequestDto() {
        this.academicYear = "2026-2027";
    }

    public StudentAdmissionWorkflowRequestDto(String studentId, String teacherId, String academicYear,
