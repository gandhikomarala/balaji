...
/**
 * Data Transfer Object for StudentHostelAllocation transactions.
 */
public class StudentHostelAllocationRequestDto implements Serializable {
    ...
    public StudentHostelAllocationRequestDto() {
        this.academicYear = "2026-2027";
    }

    public StudentHostelAllocationRequestDto(String studentId, String teacherId, String academicYear,
