...
/**
 * Data Transfer Object for StudentTransferCertificate transactions.
 */
public class StudentTransferCertificateRequestDto implements Serializable {
    ...
    public StudentTransferCertificateRequestDto() {
        this.academicYear = "2026-2027";
    }

    public StudentTransferCertificateRequestDto(String studentId, String teacherId, String academicYear,
