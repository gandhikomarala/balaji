...
/**
 * Data Transfer Object for StudentCareerAptitudePredictor execution.
 */
public class StudentCareerAptitudePredictorRequestDto implements Serializable {
    ...
    public StudentCareerAptitudePredictorRequestDto() {
        this.academicSession = "2026-2027";
        this.targetExecutionDate = LocalDateTime.now();
    }

    public StudentCareerAptitudePredictorRequestDto(String studentId, String employeeId, String academicSession,
