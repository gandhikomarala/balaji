...
/**
 * Data Transfer Object for StudentMiddayMealNutritionAuditor execution.
 */
public class StudentMiddayMealNutritionAuditorRequestDto implements Serializable {
    ...
    public StudentMiddayMealNutritionAuditorRequestDto() {
        this.academicSession = "2026-2027";
        this.targetExecutionDate = LocalDateTime.now();
    }

    public StudentMiddayMealNutritionAuditorRequestDto(String studentId, String employeeId, String academicSession,
