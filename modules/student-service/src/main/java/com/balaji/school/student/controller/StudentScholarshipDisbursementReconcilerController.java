...
import com.balaji.school.student.service.StudentScholarshipDisbursementReconcilerService;
...
/**
 * Enterprise REST API Controller for StudentScholarshipDisbursementReconciler.
 */
public class StudentScholarshipDisbursementReconcilerController {

    private final StudentScholarshipDisbursementReconcilerService service;

    public StudentScholarshipDisbursementReconcilerController() {
        this.service = new StudentScholarshipDisbursementReconcilerService();
    }

    public StudentScholarshipDisbursementReconcilerController(StudentScholarshipDisbursementReconcilerService service) {
        this.service = service != null ? service : new StudentScholarshipDisbursementReconcilerService();
    }

    public Map<String, Object> listAll() {
        List<StudentScholarshipDisbursementReconcilerEntity> records = service.retrieveAllRecords();
    ...
    public Map<String, Object> getById(String id) {
        Optional<StudentScholarshipDisbursementReconcilerEntity> entity = service.retrieveById(id);
        Map<String, Object> response = new HashMap<>();
        if (entity.isPresent()) {
            response.put("statusCode", 200);
    ...
    public Map<String, Object> submitRecord(StudentScholarshipDisbursementReconcilerRequestDto request) {
        Map<String, Object> response = new HashMap<>();
        try {
            StudentScholarshipDisbursementReconcilerEntity created = service.executeWorkflow(request);
