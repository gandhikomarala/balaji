...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 038)
 ...
 */
public class CommonService_038 {

    private final String serviceId = "school-common-038";
