...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 056)
 ...
 */
public class GradeConverterCore_056 {

    private final String engineTag = "school-common-unit-056";
