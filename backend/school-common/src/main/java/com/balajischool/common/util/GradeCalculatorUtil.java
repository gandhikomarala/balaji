package com.balajischool.common.util;
...
/**
 * Balaji High School — GradeCalculatorUtil
 * Description: Deterministic SSC Board grading logic computing A1, A2, B1, B2, C1, C2, D, F
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class GradeCalculatorUtil implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "common-util-GradeCalculatorUtil";
    private final Map<String, Object> operationalAttributes = new ConcurrentHashMap<>();
    private Instant createdAt = Instant.now();
    private boolean isActive = true;

    public GradeCalculatorUtil() {
