...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 050)
 ...
 */
public class GradeConverterCore_050 {

    private final String engineTag = "school-common-unit-050";
