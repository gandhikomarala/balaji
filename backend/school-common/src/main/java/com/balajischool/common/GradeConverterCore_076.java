...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 076)
 ...
 */
public class GradeConverterCore_076 {

    private final String engineTag = "school-common-unit-076";
