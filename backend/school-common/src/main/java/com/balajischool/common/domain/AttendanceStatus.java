...
/**
 * Balaji High School — AttendanceStatus
 * Description: Enum representing PRESENT, ABSENT, ON_LEAVE, HALF_DAY, MEDICAL_LEAVE
...
public class AttendanceStatus implements Serializable {
    ...
    private final String componentIdentifier = "common-domain-AttendanceStatus";
