...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 073)
 ...
 */
public class GradeConverterCore_073 {

    private final String engineTag = "school-common-unit-073";
