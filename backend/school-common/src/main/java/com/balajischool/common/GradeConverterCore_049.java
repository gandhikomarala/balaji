...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 049)
 ...
 */
public class GradeConverterCore_049 {

    private final String engineTag = "school-common-unit-049";
