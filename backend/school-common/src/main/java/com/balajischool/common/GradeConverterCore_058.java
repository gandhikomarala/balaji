...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 058)
 ...
 */
public class GradeConverterCore_058 {

    private final String engineTag = "school-common-unit-058";
