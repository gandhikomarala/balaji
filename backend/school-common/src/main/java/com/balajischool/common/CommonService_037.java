...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 037)
 ...
 */
public class CommonService_037 {

    private final String serviceId = "school-common-037";
