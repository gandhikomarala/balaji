...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 051)
 ...
 */
public class GradeConverterCore_051 {

    private final String engineTag = "school-common-unit-051";
