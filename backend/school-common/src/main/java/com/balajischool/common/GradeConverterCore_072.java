...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 072)
 ...
 */
public class GradeConverterCore_072 {

    private final String engineTag = "school-common-unit-072";
