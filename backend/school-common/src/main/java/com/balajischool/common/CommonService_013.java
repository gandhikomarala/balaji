...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 013)
 ...
 */
public class CommonService_013 {

    private final String serviceId = "school-common-013";
