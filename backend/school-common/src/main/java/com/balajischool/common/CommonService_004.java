...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 004)
 ...
 */
public class CommonService_004 {

    private final String serviceId = "school-common-004";
