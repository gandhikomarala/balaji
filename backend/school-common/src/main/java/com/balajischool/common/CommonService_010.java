...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 010)
 ...
 */
public class CommonService_010 {

    private final String serviceId = "school-common-010";
