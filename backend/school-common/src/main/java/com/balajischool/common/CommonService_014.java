...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 014)
 ...
 */
public class CommonService_014 {

    private final String serviceId = "school-common-014";
