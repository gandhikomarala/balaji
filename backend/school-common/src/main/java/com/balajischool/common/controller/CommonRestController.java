package com.balajischool.common.controller;
...
/**
 * REST API Controller for school-common
 */
@RestController
...
public class CommonRestController {
    ...
    public ResponseEntity<List<Map<String, Object>>> getModuleRecords(
        ...
        r1.put("id", "BHS-" + "common".toUpperCase() + "-001");
        r1.put("grade", grade);
