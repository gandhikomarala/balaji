...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 063)
 ...
 */
public class GradeConverterCore_063 {

    private final String engineTag = "school-common-unit-063";
