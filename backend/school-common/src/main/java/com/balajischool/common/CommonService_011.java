...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 011)
 ...
 */
public class CommonService_011 {

    private final String serviceId = "school-common-011";
