...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 022)
 ...
 */
public class CommonService_022 {

    private final String serviceId = "school-common-022";
