...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 028)
 ...
 */
public class CommonService_028 {

    private final String serviceId = "school-common-028";
