...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 017)
 ...
 */
public class CommonService_017 {

    private final String serviceId = "school-common-017";
