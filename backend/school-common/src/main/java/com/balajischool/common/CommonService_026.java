...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 026)
 ...
 */
public class CommonService_026 {

    private final String serviceId = "school-common-026";
