...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 053)
 ...
 */
public class GradeConverterCore_053 {

    private final String engineTag = "school-common-unit-053";
