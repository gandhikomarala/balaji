...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 078)
 ...
 */
public class GradeConverterCore_078 {

    private final String engineTag = "school-common-unit-078";
    ...
    public record AcademicRecord_078(
            String evaluationId,
    ...
    public synchronized AcademicRecord_078 evaluateClassAcademicPerformance(
