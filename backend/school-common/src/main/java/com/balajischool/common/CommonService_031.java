...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 031)
 ...
 */
public class CommonService_031 {

    private final String serviceId = "school-common-031";
