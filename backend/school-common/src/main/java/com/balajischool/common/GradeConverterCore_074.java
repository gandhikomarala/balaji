...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 074)
 ...
 */
public class GradeConverterCore_074 {

    private final String engineTag = "school-common-unit-074";
