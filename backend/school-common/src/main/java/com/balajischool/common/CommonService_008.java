...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 008)
 ...
 */
public class CommonService_008 {

    private final String serviceId = "school-common-008";
