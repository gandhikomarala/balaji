...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 059)
 ...
 */
public class GradeConverterCore_059 {

    private final String engineTag = "school-common-unit-059";
