...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 071)
 ...
 */
public class GradeConverterCore_071 {

    private final String engineTag = "school-common-unit-071";
