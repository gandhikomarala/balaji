...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 044)
 ...
 */
public class CommonService_044 {

    private final String serviceId = "school-common-044";
