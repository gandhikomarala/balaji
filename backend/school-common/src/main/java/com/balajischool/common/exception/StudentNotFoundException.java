...
/**
 * Balaji High School — StudentNotFoundException
 * Description: Domain exception thrown when student admission ID cannot be resolved
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class StudentNotFoundException implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "common-exception-StudentNotFoundException";
