...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 046)
 ...
 */
public class GradeConverterCore_046 {

    private final String engineTag = "school-common-unit-046";
