...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 055)
 ...
 */
public class GradeConverterCore_055 {

    private final String engineTag = "school-common-unit-055";
