...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 034)
 ...
 */
public class CommonService_034 {

    private final String serviceId = "school-common-034";
