...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 081)
 ...
 */
public class GradeConverterCore_081 {

    private final String engineTag = "school-common-unit-081";
