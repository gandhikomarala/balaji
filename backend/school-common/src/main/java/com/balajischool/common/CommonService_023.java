...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 023)
 ...
 */
public class CommonService_023 {

    private final String serviceId = "school-common-023";
