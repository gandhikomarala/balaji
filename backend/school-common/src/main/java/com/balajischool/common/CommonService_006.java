...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 006)
 ...
 */
public class CommonService_006 {

    private final String serviceId = "school-common-006";
