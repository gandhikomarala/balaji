...
/**
 * Balaji High School — AcademicYear
 * Description: Academic session value object with April-March lifecycle validation
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class AcademicYear implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "common-domain-AcademicYear";
