...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 070)
 ...
 */
public class GradeConverterCore_070 {

    private final String engineTag = "school-common-unit-070";
