...
/**
 * Balaji High School — FeeCategory
 * Description: Enum representing TUITION_FEE, ADMISSION_FEE, EXAMINATION_FEE, LAB_LIBRARY_FEE
...
public class FeeCategory implements Serializable {
    ...
    private final String componentIdentifier = "common-domain-FeeCategory";
