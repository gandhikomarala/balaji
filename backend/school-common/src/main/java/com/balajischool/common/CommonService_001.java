...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 001)
 ...
 */
public class CommonService_001 {

    private final String serviceId = "school-common-001";
