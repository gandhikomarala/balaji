...
/**
 * Balaji High School — FeeReceiptNumberGenerator
 * Description: Thread-safe cryptographic receipt number generator with prefix BHS-REC
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class FeeReceiptNumberGenerator implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "common-util-FeeReceiptNumberGenerator";
