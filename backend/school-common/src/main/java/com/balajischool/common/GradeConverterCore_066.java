...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 066)
 ...
 */
public class GradeConverterCore_066 {

    private final String engineTag = "school-common-unit-066";
