...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 067)
 ...
 */
public class GradeConverterCore_067 {

    private final String engineTag = "school-common-unit-067";
