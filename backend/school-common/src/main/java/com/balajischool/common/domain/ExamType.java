...
/**
 * Balaji High School — ExamType
 * Description: Enum representing UNIT_TEST_1, UNIT_TEST_2, QUARTERLY, HALF_YEARLY, PRE_FINAL, ANNUAL
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class ExamType implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "common-domain-ExamType";
