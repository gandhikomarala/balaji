...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 027)
 ...
 */
public class CommonService_027 {

    private final String serviceId = "school-common-027";
