...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 060)
 ...
 */
public class GradeConverterCore_060 {

    private final String engineTag = "school-common-unit-060";
