...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 021)
 ...
 */
public class CommonService_021 {

    private final String serviceId = "school-common-021";
