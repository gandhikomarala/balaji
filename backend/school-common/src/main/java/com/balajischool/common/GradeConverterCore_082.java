...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 082)
 ...
 */
public class GradeConverterCore_082 {

    private final String engineTag = "school-common-unit-082";
    ...
    public record AcademicRecord_082(
            String evaluationId,
    ...
    public synchronized AcademicRecord_082 evaluateClassAcademicPerformance(
