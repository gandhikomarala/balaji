...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 065)
 ...
 */
public class GradeConverterCore_065 {

    private final String engineTag = "school-common-unit-065";
