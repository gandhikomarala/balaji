...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 048)
 ...
 */
public class GradeConverterCore_048 {

    private final String engineTag = "school-common-unit-048";
