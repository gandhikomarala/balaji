...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 016)
 ...
 */
public class CommonService_016 {

    private final String serviceId = "school-common-016";
