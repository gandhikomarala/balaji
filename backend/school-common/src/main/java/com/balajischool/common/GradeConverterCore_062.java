...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 062)
 ...
 */
public class GradeConverterCore_062 {

    private final String engineTag = "school-common-unit-062";
