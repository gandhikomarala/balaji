...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 047)
 ...
 */
public class GradeConverterCore_047 {

    private final String engineTag = "school-common-unit-047";
