...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 068)
 ...
 */
public class GradeConverterCore_068 {

    private final String engineTag = "school-common-unit-068";
