...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 057)
 ...
 */
public class GradeConverterCore_057 {

    private final String engineTag = "school-common-unit-057";
