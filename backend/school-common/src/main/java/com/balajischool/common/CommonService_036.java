...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 036)
 ...
 */
public class CommonService_036 {

    private final String serviceId = "school-common-036";
