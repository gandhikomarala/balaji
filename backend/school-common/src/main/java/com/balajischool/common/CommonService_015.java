...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 015)
 ...
 */
public class CommonService_015 {

    private final String serviceId = "school-common-015";
