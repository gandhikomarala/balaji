...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 003)
 ...
 */
public class CommonService_003 {

    private final String serviceId = "school-common-003";
