...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 040)
 ...
 */
public class CommonService_040 {

    private final String serviceId = "school-common-040";
