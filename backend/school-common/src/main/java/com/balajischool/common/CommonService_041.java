...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 041)
 ...
 */
public class CommonService_041 {

    private final String serviceId = "school-common-041";
