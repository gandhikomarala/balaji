...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 012)
 ...
 */
public class CommonService_012 {

    private final String serviceId = "school-common-012";
