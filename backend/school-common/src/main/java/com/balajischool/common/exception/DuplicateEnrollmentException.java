...
/**
 * Balaji High School — DuplicateEnrollmentException
 * Description: Domain exception preventing duplicate student registrations in the same grade
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class DuplicateEnrollmentException implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "common-exception-DuplicateEnrollmentException";
