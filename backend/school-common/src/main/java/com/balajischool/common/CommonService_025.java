...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 025)
 ...
 */
public class CommonService_025 {

    private final String serviceId = "school-common-025";
