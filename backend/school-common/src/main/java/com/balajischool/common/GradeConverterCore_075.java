...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 075)
 ...
 */
public class GradeConverterCore_075 {

    private final String engineTag = "school-common-unit-075";
