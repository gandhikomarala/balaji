...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 069)
 ...
 */
public class GradeConverterCore_069 {

    private final String engineTag = "school-common-unit-069";
