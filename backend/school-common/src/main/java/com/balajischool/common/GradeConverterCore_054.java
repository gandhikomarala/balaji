...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 054)
 ...
 */
public class GradeConverterCore_054 {

    private final String engineTag = "school-common-unit-054";
