...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 002)
 ...
 */
public class CommonService_002 {

    private final String serviceId = "school-common-002";
