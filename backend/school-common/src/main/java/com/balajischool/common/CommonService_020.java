...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 020)
 ...
 */
public class CommonService_020 {

    private final String serviceId = "school-common-020";
