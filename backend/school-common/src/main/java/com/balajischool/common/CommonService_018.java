...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 018)
 ...
 */
public class CommonService_018 {

    private final String serviceId = "school-common-018";
