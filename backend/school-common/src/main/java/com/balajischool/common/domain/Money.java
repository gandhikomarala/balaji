...
/**
 * Balaji High School — Money
 * Description: Immutable currency and amount representation with RoundingMode.HALF_EVEN precision
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class Money implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "common-domain-Money";
