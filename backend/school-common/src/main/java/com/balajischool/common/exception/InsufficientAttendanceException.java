package com.balajischool.common.exception;
...
/**
 * Balaji High School — InsufficientAttendanceException
 * Description: Domain exception for hall ticket withholding when attendance < 75%
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class InsufficientAttendanceException implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "common-exception-InsufficientAttendanceException";
    private final Map<String, Object> operationalAttributes = new ConcurrentHashMap<>();
    private Instant createdAt = Instant.now();
    private boolean isActive = true;

    public InsufficientAttendanceException() {
