...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 030)
 ...
 */
public class CommonService_030 {

    private final String serviceId = "school-common-030";
