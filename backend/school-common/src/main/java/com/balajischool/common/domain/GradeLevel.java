package com.balajischool.common.domain;
...
/**
 * Balaji High School — GradeLevel
 * Description: Enum representing Grades VI to X with section allotment and Telugu medium flags
...
public class GradeLevel implements Serializable {
    ...
    private final String componentIdentifier = "common-domain-GradeLevel";
