...
/**
 * Balaji High School — Common DTOs, Base Entities, Enums & Exceptions (Service Unit 005)
 ...
 */
public class CommonService_005 {

    private final String serviceId = "school-common-005";
