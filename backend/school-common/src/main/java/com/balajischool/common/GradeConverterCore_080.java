...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 080)
 ...
 */
public class GradeConverterCore_080 {

    private final String engineTag = "school-common-unit-080";
    ...
    public record AcademicRecord_080(
            String evaluationId,
    ...
    public synchronized AcademicRecord_080 evaluateClassAcademicPerformance(
