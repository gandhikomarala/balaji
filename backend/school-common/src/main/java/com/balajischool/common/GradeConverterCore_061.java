...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 061)
 ...
 */
public class GradeConverterCore_061 {

    private final String engineTag = "school-common-unit-061";
