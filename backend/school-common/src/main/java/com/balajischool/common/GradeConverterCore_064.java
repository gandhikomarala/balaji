...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 064)
 ...
 */
public class GradeConverterCore_064 {

    private final String engineTag = "school-common-unit-064";
