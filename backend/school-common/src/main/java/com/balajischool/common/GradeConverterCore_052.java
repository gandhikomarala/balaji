...
/**
 * Balaji High School — Universal Money, Currency & Grade Converter Engine (Core Engine Unit 052)
 ...
 */
public class GradeConverterCore_052 {

    private final String engineTag = "school-common-unit-052";
