...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 080)
 ...
 */
public class GalleryAssetManagerCore_080 {

    private final String engineTag = "school-gallery-unit-080";
