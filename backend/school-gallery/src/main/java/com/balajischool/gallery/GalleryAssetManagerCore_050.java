...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 050)
 ...
 */
public class GalleryAssetManagerCore_050 {

    private final String engineTag = "school-gallery-unit-050";
