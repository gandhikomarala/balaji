...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 069)
 ...
 */
public class GalleryAssetManagerCore_069 {

    private final String engineTag = "school-gallery-unit-069";
