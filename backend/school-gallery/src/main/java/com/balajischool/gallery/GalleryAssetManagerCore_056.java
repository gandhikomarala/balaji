...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 056)
 ...
 */
public class GalleryAssetManagerCore_056 {

    private final String engineTag = "school-gallery-unit-056";
