...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 085)
 ...
 */
public class GalleryAssetManagerCore_085 {

    private final String engineTag = "school-gallery-unit-085";
