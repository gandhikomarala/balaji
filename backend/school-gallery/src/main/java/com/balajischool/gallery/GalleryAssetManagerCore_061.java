...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 061)
 ...
 */
public class GalleryAssetManagerCore_061 {

    private final String engineTag = "school-gallery-unit-061";
