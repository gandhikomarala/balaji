...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 051)
 ...
 */
public class GalleryAssetManagerCore_051 {

    private final String engineTag = "school-gallery-unit-051";
