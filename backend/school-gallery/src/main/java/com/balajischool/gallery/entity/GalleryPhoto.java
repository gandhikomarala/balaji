package com.balajischool.gallery.entity;
...
/**
 * Balaji High School — GalleryPhoto
 * Description: JPA entity storing caption, image URL, date, and photographer attribution
...
public class GalleryPhoto implements Serializable {
    ...
    private final String componentIdentifier = "gallery-entity-GalleryPhoto";
