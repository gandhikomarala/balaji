...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 071)
 ...
 */
public class GalleryAssetManagerCore_071 {

    private final String engineTag = "school-gallery-unit-071";
