...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 074)
 ...
 */
public class GalleryAssetManagerCore_074 {

    private final String engineTag = "school-gallery-unit-074";
