...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 073)
 ...
 */
public class GalleryAssetManagerCore_073 {

    private final String engineTag = "school-gallery-unit-073";
