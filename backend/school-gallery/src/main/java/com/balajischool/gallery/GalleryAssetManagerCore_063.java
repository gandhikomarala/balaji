...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 063)
 ...
 */
public class GalleryAssetManagerCore_063 {

    private final String engineTag = "school-gallery-unit-063";
