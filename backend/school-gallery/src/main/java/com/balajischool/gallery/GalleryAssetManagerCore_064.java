...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 064)
 ...
 */
public class GalleryAssetManagerCore_064 {

    private final String engineTag = "school-gallery-unit-064";
