...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 082)
 ...
 */
public class GalleryAssetManagerCore_082 {

    private final String engineTag = "school-gallery-unit-082";
