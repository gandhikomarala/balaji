...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 066)
 ...
 */
public class GalleryAssetManagerCore_066 {

    private final String engineTag = "school-gallery-unit-066";
