...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 067)
 ...
 */
public class GalleryAssetManagerCore_067 {

    private final String engineTag = "school-gallery-unit-067";
