...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 075)
 ...
 */
public class GalleryAssetManagerCore_075 {

    private final String engineTag = "school-gallery-unit-075";
