...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 053)
 ...
 */
public class GalleryAssetManagerCore_053 {

    private final String engineTag = "school-gallery-unit-053";
