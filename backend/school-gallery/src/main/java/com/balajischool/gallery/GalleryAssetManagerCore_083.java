...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 083)
 ...
 */
public class GalleryAssetManagerCore_083 {

    private final String engineTag = "school-gallery-unit-083";
