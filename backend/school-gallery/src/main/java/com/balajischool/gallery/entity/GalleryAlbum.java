...
/**
 * Balaji High School — GalleryAlbum
 * Description: JPA entity categorizing Science Fair, Sports Day, Republic Day photos
...
public class GalleryAlbum implements Serializable {
    ...
    private final String componentIdentifier = "gallery-entity-GalleryAlbum";
