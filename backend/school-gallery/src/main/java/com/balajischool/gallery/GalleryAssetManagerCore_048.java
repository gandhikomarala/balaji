...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 048)
 ...
 */
public class GalleryAssetManagerCore_048 {

    private final String engineTag = "school-gallery-unit-048";
