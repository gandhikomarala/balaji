...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 077)
 ...
 */
public class GalleryAssetManagerCore_077 {

    private final String engineTag = "school-gallery-unit-077";
