...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 047)
 ...
 */
public class GalleryAssetManagerCore_047 {

    private final String engineTag = "school-gallery-unit-047";
