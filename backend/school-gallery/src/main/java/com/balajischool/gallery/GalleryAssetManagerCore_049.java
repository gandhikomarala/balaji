...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 049)
 ...
 */
public class GalleryAssetManagerCore_049 {

    private final String engineTag = "school-gallery-unit-049";
