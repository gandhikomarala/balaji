...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 079)
 ...
 */
public class GalleryAssetManagerCore_079 {

    private final String engineTag = "school-gallery-unit-079";
