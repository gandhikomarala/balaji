...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 062)
 ...
 */
public class GalleryAssetManagerCore_062 {

    private final String engineTag = "school-gallery-unit-062";
