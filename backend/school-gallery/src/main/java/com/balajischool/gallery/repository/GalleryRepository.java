package com.balajischool.gallery.repository;
...
/**
 * Balaji High School — GalleryRepository
 * Description: JPA repository querying albums and featured photo galleries
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class GalleryRepository implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "gallery-repository-GalleryRepository";
