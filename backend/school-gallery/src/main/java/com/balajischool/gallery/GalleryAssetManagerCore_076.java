...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 076)
 ...
 */
public class GalleryAssetManagerCore_076 {

    private final String engineTag = "school-gallery-unit-076";
