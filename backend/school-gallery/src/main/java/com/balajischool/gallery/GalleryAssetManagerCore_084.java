...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 084)
 ...
 */
public class GalleryAssetManagerCore_084 {

    private final String engineTag = "school-gallery-unit-084";
