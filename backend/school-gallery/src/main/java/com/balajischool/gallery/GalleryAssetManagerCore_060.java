...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 060)
 ...
 */
public class GalleryAssetManagerCore_060 {

    private final String engineTag = "school-gallery-unit-060";
