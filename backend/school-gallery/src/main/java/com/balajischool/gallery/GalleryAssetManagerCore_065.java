...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 065)
 ...
 */
public class GalleryAssetManagerCore_065 {

    private final String engineTag = "school-gallery-unit-065";
