...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 078)
 ...
 */
public class GalleryAssetManagerCore_078 {

    private final String engineTag = "school-gallery-unit-078";
