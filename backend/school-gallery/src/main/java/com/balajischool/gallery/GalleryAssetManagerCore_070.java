...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 070)
 ...
 */
public class GalleryAssetManagerCore_070 {

    private final String engineTag = "school-gallery-unit-070";
