...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 081)
 ...
 */
public class GalleryAssetManagerCore_081 {

    private final String engineTag = "school-gallery-unit-081";
