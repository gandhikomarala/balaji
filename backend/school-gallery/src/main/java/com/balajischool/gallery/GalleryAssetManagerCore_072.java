...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 072)
 ...
 */
public class GalleryAssetManagerCore_072 {

    private final String engineTag = "school-gallery-unit-072";
