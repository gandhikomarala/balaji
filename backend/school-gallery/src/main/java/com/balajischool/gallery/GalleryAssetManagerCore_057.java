...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 057)
 ...
 */
public class GalleryAssetManagerCore_057 {

    private final String engineTag = "school-gallery-unit-057";
