...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 052)
 ...
 */
public class GalleryAssetManagerCore_052 {

    private final String engineTag = "school-gallery-unit-052";
