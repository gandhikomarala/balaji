...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 059)
 ...
 */
public class GalleryAssetManagerCore_059 {

    private final String engineTag = "school-gallery-unit-059";
