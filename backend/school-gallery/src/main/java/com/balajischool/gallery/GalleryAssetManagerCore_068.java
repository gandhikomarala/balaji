...
/**
 * Balaji High School — Media Storage & High-Resolution Asset Manager (Core Engine Unit 068)
 ...
 */
public class GalleryAssetManagerCore_068 {

    private final String engineTag = "school-gallery-unit-068";
