package com.balajischool.announcements.repository;
...
/**
 * Balaji High School — NoticeRepository
 * Description: JPA repository querying active notices by date and audience
...
public class NoticeRepository implements Serializable {
    ...
    private final String componentIdentifier = "announcements-repository-NoticeRepository";
