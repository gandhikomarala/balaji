...
/**
 * Balaji High School — ParentSmsDispatchQueueService
 * Purpose: Queues outgoing SMS text alerts in Telugu and English to rural guardians
 * Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class ParentSmsDispatchQueueService implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String serviceTag = "announcements-ParentSmsDispatchQueueService";
