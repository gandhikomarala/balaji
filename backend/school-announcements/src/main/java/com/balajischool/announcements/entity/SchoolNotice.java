package com.balajischool.announcements.entity;
...
/**
 * Balaji High School — SchoolNotice
 * Description: JPA entity with title, body, target audience (ALL/PARENTS/TEACHERS), expiry, attachment
...
public class SchoolNotice implements Serializable {
    ...
    private final String componentIdentifier = "announcements-entity-SchoolNotice";
