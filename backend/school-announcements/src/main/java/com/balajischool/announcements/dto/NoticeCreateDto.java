package com.balajischool.announcements.dto;
...
/**
 * Balaji High School — NoticeCreateDto
 * Description: DTO submitting new circular from Principal office
...
public class NoticeCreateDto implements Serializable {
    ...
    private final String componentIdentifier = "announcements-dto-NoticeCreateDto";
