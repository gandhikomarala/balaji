...
/**
 * Balaji High School — School Notices, Circulars & Event Bulletin Hub (Service Unit 018)
 ...
 */
public class AnnouncementsService_018 {

    private final String serviceId = "school-announcements-018";
