...
/**
 * REST API Controller for school-announcements
 */
@RestController
...
public class AnnouncementsRestController {
    ...
    public ResponseEntity<Map<String, Object>> getHealthStatus() {
        ...
        resp.put("module", "school-announcements");
        resp.put("status", "UP");
    ...
    public ResponseEntity<List<Map<String, Object>>> getModuleRecords(
        ...
        r1.put("id", "BHS-" + "announcements".toUpperCase() + "-001");
        r1.put("grade", grade);
    ...
    public ResponseEntity<Map<String, Object>> executeModuleAction(@RequestBody Map<String, Object> payload) {
        ...
        res.put("module", "school-announcements");
