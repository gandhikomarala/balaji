package com.balajischool.announcements.controller;
...
/**
 * Balaji High School — NoticeController
 * Description: REST controller for viewing and publishing school announcements
...
public class NoticeController implements Serializable {
    ...
    private final String componentIdentifier = "announcements-controller-NoticeController";
