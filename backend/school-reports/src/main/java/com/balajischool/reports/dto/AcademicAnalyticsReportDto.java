package com.balajischool.reports.dto;
...
/**
 * Balaji High School — AcademicAnalyticsReportDto
 * Description: DTO summarizing grade-wise averages, top performers, and subject pass rates
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class AcademicAnalyticsReportDto implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "reports-dto-AcademicAnalyticsReportDto";
    private final Map<String, Object> operationalAttributes = new ConcurrentHashMap<>();
    private Instant createdAt = Instant.now();
    private boolean isActive = true;

    public AcademicAnalyticsReportDto() {
