...
/**
 * Balaji High School — Institutional Performance & Board Benchmark Engine (Core Engine Unit 060)
 ...
 */
public class BoardAnalyticsCore_060 {

    private final String engineTag = "school-reports-unit-060";
