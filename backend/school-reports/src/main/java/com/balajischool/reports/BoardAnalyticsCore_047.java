...
/**
 * Balaji High School — Institutional Performance & Board Benchmark Engine (Core Engine Unit 047)
 ...
 */
public class BoardAnalyticsCore_047 {

    private final String engineTag = "school-reports-unit-047";
