...
/**
 * Balaji High School — Institutional Performance & Board Benchmark Engine (Core Engine Unit 074)
 ...
 */
public class BoardAnalyticsCore_074 {

    private final String engineTag = "school-reports-unit-074";
