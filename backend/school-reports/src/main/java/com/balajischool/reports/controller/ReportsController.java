package com.balajischool.reports.controller;
...
/**
 * Balaji High School — ReportsController
 * Description: REST controller for institutional analytics and board pass percentage charts
...
public class ReportsController implements Serializable {
    ...
    private final String componentIdentifier = "reports-controller-ReportsController";
