...
/**
 * Balaji High School — SubjectPerformanceDrilldownService
 * Purpose: Identifies subjects needing remedial classes (e.g. Mathematics / English)
 * Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class SubjectPerformanceDrilldownService implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String serviceTag = "reports-SubjectPerformanceDrilldownService";
