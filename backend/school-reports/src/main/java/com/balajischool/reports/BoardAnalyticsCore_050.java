...
/**
 * Balaji High School — Institutional Performance & Board Benchmark Engine (Core Engine Unit 050)
 ...
 */
public class BoardAnalyticsCore_050 {

    private final String engineTag = "school-reports-unit-050";
