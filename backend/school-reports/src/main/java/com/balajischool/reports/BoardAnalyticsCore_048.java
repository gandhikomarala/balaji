...
/**
 * Balaji High School — Institutional Performance & Board Benchmark Engine (Core Engine Unit 048)
 ...
 */
public class BoardAnalyticsCore_048 {

    private final String engineTag = "school-reports-unit-048";
