...
/**
 * Balaji High School — DistrictEducationReportExportService
 * Purpose: Exports U-DISE+ format annual school statistical data for government submission
 * Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class DistrictEducationReportExportService implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String serviceTag = "reports-DistrictEducationReportExportService";
