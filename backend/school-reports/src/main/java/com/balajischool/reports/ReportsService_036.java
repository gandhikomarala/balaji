...
/**
 * Balaji High School — Student Performance, Fee Collection & Attendance Analytics (Service Unit 036)
 ...
 */
public class ReportsService_036 {

    private final String serviceId = "school-reports-036";
