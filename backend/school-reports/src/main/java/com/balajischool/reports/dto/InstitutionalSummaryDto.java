...
/**
 * Balaji High School — InstitutionalSummaryDto
 * Description: DTO compiling total student count, attendance average, and fee recovery rate
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class InstitutionalSummaryDto implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "reports-dto-InstitutionalSummaryDto";
    private final Map<String, Object> operationalAttributes = new ConcurrentHashMap<>();
    private Instant createdAt = Instant.now();
    private boolean isActive = true;

    public InstitutionalSummaryDto() {
