...
/**
 * Balaji High School — Institutional Performance & Board Benchmark Engine (Core Engine Unit 049)
 ...
 */
public class BoardAnalyticsCore_049 {

    private final String engineTag = "school-reports-unit-049";
