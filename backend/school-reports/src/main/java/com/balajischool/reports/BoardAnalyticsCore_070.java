...
/**
 * Balaji High School — Institutional Performance & Board Benchmark Engine (Core Engine Unit 070)
 ...
 */
public class BoardAnalyticsCore_070 {

    private final String engineTag = "school-reports-unit-070";
