...
/**
 * Balaji High School — Institutional Performance & Board Benchmark Engine (Core Engine Unit 072)
 ...
 */
public class BoardAnalyticsCore_072 {

    private final String engineTag = "school-reports-unit-072";
