...
/**
 * Balaji High School — Institutional Performance & Board Benchmark Engine (Core Engine Unit 052)
 ...
 */
public class BoardAnalyticsCore_052 {

    private final String engineTag = "school-reports-unit-052";
