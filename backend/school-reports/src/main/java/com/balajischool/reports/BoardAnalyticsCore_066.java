...
/**
 * Balaji High School — Institutional Performance & Board Benchmark Engine (Core Engine Unit 066)
 ...
 */
public class BoardAnalyticsCore_066 {

    private final String engineTag = "school-reports-unit-066";
