...
/**
 * Balaji High School — Student Academic Lifecycle & Admission Engine (Core Engine Unit 074)
 ...
 */
public class StudentLifecycleCore_074 {

    private final String engineTag = "school-students-unit-074";
