...
/**
 * Balaji High School — Student Academic Lifecycle & Admission Engine (Core Engine Unit 067)
 ...
 */
public class StudentLifecycleCore_067 {

    private final String engineTag = "school-students-unit-067";
