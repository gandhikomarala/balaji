...
/**
 * Balaji High School — Student Academic Lifecycle & Admission Engine (Core Engine Unit 064)
 ...
 */
public class StudentLifecycleCore_064 {

    private final String engineTag = "school-students-unit-064";
