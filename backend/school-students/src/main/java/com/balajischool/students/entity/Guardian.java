...
/**
 * Balaji High School — Guardian
 * Description: JPA entity with parent name, primary phone, occupation, address, and Aadhaar ref
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class Guardian implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "students-entity-Guardian";
