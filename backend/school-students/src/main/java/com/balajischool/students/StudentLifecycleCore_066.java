...
/**
 * Balaji High School — Student Academic Lifecycle & Admission Engine (Core Engine Unit 066)
 ...
 */
public class StudentLifecycleCore_066 {

    private final String engineTag = "school-students-unit-066";
