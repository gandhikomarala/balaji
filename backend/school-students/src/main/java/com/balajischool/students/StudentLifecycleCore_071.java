...
/**
 * Balaji High School — Student Academic Lifecycle & Admission Engine (Core Engine Unit 071)
 ...
 */
public class StudentLifecycleCore_071 {

    private final String engineTag = "school-students-unit-071";
