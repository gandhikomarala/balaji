...
/**
 * Balaji High School — StudentProfileResponse
 * Description: DTO containing student personal info, active class, photo URL, and attendance summary
...
public class StudentProfileResponse implements Serializable {
    ...
    private final String componentIdentifier = "students-dto-StudentProfileResponse";
