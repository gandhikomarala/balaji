package com.balajischool.students.controller;
...
/**
 * Balaji High School — StudentController
 * Description: REST controller for student CRUD, search, promotion, and guardian updates
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class StudentController implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "students-controller-StudentController";
