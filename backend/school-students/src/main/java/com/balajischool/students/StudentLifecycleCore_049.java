...
/**
 * Balaji High School — Student Academic Lifecycle & Admission Engine (Core Engine Unit 049)
 ...
 */
public class StudentLifecycleCore_049 {

    private final String engineTag = "school-students-unit-049";
