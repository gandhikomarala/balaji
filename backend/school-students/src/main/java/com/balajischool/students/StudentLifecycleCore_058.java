...
/**
 * Balaji High School — Student Academic Lifecycle & Admission Engine (Core Engine Unit 058)
 ...
 */
public class StudentLifecycleCore_058 {

    private final String engineTag = "school-students-unit-058";
