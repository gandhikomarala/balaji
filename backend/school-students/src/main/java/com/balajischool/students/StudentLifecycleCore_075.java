...
/**
 * Balaji High School — Student Academic Lifecycle & Admission Engine (Core Engine Unit 075)
 ...
 */
public class StudentLifecycleCore_075 {

    private final String engineTag = "school-students-unit-075";
