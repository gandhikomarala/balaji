...
/**
 * Balaji High School — Student Academic Lifecycle & Admission Engine (Core Engine Unit 052)
 ...
 */
public class StudentLifecycleCore_052 {

    private final String engineTag = "school-students-unit-052";
