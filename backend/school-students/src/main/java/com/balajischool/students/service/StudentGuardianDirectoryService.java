...
/**
 * Balaji High School — StudentGuardianDirectoryService
 * Purpose: Manages emergency parent contact rosters, village addresses, and communication logs
 * Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class StudentGuardianDirectoryService implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String serviceTag = "students-StudentGuardianDirectoryService";
