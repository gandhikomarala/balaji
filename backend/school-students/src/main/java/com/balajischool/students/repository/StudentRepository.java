package com.balajischool.students.repository;
...
/**
 * Balaji High School — StudentRepository
 * Description: JPA repository supporting grade-wise search, section filters, and roll number ordering
...
public class StudentRepository implements Serializable {
    ...
    private final String componentIdentifier = "students-repository-StudentRepository";
