...
/**
 * Balaji High School — Student Academic Lifecycle & Admission Engine (Core Engine Unit 059)
 ...
 */
public class StudentLifecycleCore_059 {

    private final String engineTag = "school-students-unit-059";
