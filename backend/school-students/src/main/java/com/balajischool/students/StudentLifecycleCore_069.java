...
/**
 * Balaji High School — Student Academic Lifecycle & Admission Engine (Core Engine Unit 069)
 ...
 */
public class StudentLifecycleCore_069 {

    private final String engineTag = "school-students-unit-069";
