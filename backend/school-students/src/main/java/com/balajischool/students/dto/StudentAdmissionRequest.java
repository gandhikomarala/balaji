package com.balajischool.students.dto;
...
/**
 * Balaji High School — StudentAdmissionRequest
 * Description: DTO validating age, previous school TC, marks memo, and chosen medium
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class StudentAdmissionRequest implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "students-dto-StudentAdmissionRequest";
