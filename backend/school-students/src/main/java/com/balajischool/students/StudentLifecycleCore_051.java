...
/**
 * Balaji High School — Student Academic Lifecycle & Admission Engine (Core Engine Unit 051)
 ...
 */
public class StudentLifecycleCore_051 {

    private final String engineTag = "school-students-unit-051";
