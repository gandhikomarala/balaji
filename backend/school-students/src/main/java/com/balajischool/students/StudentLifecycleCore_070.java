...
/**
 * Balaji High School — Student Academic Lifecycle & Admission Engine (Core Engine Unit 070)
 ...
 */
public class StudentLifecycleCore_070 {

    private final String engineTag = "school-students-unit-070";
