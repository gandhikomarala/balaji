...
/**
 * Balaji High School — Student Academic Lifecycle & Admission Engine (Core Engine Unit 072)
 ...
 */
public class StudentLifecycleCore_072 {

    private final String engineTag = "school-students-unit-072";
