...
/**
 * Balaji High School — Student Academic Lifecycle & Admission Engine (Core Engine Unit 065)
 ...
 */
public class StudentLifecycleCore_065 {

    private final String engineTag = "school-students-unit-065";
