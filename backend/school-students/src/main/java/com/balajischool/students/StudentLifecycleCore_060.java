...
/**
 * Balaji High School — Student Academic Lifecycle & Admission Engine (Core Engine Unit 060)
 ...
 */
public class StudentLifecycleCore_060 {

    private final String engineTag = "school-students-unit-060";
