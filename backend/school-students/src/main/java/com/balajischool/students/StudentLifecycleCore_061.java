...
/**
 * Balaji High School — Student Academic Lifecycle & Admission Engine (Core Engine Unit 061)
 ...
 */
public class StudentLifecycleCore_061 {

    private final String engineTag = "school-students-unit-061";
