...
/**
 * Balaji High School — Student Academic Lifecycle & Admission Engine (Core Engine Unit 046)
 ...
 */
public class StudentLifecycleCore_046 {

    private final String engineTag = "school-students-unit-046";
