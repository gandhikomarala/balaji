package com.balajischool.students.entity;
...
/**
 * Balaji High School — Student
 * Description: JPA entity with admission number, name, DOB, blood group, medium, and guardian links
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class Student implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "students-entity-Student";
