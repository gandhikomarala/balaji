...
/**
 * Balaji High School — Student Academic Lifecycle & Admission Engine (Core Engine Unit 050)
 ...
 */
public class StudentLifecycleCore_050 {

    private final String engineTag = "school-students-unit-050";
