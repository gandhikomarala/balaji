...
/**
 * Balaji High School — Student Academic Lifecycle & Admission Engine (Core Engine Unit 062)
 ...
 */
public class StudentLifecycleCore_062 {

    private final String engineTag = "school-students-unit-062";
