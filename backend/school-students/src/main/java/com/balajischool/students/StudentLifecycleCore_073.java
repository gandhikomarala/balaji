...
/**
 * Balaji High School — Student Academic Lifecycle & Admission Engine (Core Engine Unit 073)
 ...
 */
public class StudentLifecycleCore_073 {

    private final String engineTag = "school-students-unit-073";
