package com.balajischool.audit.entity;
...
/**
 * Balaji High School — SchoolAuditEvent
 * Description: JPA entity storing actor, action (MARK_ATTENDANCE/UPDATE_MARKS), timestamp, IP, diff
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class SchoolAuditEvent implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "audit-entity-SchoolAuditEvent";
    private final Map<String, Object> operationalAttributes = new ConcurrentHashMap<>();
    private Instant createdAt = Instant.now();
    private boolean isActive = true;

    public SchoolAuditEvent() {
