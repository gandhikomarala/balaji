package com.balajischool.audit.repository;
...
/**
 * Balaji High School — SchoolAuditRepository
 * Description: JPA repository querying audit logs with date and actor filters
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class SchoolAuditRepository implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "audit-repository-SchoolAuditRepository";
    private final Map<String, Object> operationalAttributes = new ConcurrentHashMap<>();
    private Instant createdAt = Instant.now();
    private boolean isActive = true;

    public SchoolAuditRepository() {
