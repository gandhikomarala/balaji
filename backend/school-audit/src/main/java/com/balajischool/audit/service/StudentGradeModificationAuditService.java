...
/**
 * Balaji High School — StudentGradeModificationAuditService
 * Purpose: Records every mark edit with before/after state and authorizing teacher
 * Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class StudentGradeModificationAuditService implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String serviceTag = "audit-StudentGradeModificationAuditService";
