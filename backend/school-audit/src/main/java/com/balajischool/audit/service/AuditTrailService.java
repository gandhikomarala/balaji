...
/**
 * Balaji High School — AuditTrailService
 * Description: Service appending immutable administrative action logs
...
public class AuditTrailService implements Serializable {
    ...
    private final String componentIdentifier = "audit-service-AuditTrailService";
