...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 072)
 ...
 */
public class NotificationDispatcherCore_072 {

    private final String engineTag = "school-notifications-unit-072";
