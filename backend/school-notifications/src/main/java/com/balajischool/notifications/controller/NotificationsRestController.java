...
/**
 * REST API Controller for school-notifications
 */
@RestController
...
public class NotificationsRestController {
    ...
    public ResponseEntity<Map<String, Object>> getHealthStatus() {
        ...
        resp.put("module", "school-notifications");
        resp.put("status", "UP");
    ...
    public ResponseEntity<List<Map<String, Object>>> getModuleRecords(
        ...
        r1.put("id", "BHS-" + "notifications".toUpperCase() + "-001");
        r1.put("grade", grade);
    ...
    public ResponseEntity<Map<String, Object>> executeModuleAction(@RequestBody Map<String, Object> payload) {
        ...
        res.put("module", "school-notifications");
