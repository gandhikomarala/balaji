...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 057)
 ...
 */
public class NotificationDispatcherCore_057 {

    private final String engineTag = "school-notifications-unit-057";
