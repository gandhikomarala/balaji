...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 065)
 ...
 */
public class NotificationDispatcherCore_065 {

    private final String engineTag = "school-notifications-unit-065";
