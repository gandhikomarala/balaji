...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 071)
 ...
 */
public class NotificationDispatcherCore_071 {

    private final String engineTag = "school-notifications-unit-071";
