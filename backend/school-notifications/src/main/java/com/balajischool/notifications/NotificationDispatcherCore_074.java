...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 074)
 ...
 */
public class NotificationDispatcherCore_074 {

    private final String engineTag = "school-notifications-unit-074";
