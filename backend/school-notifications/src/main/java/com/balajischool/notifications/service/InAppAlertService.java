...
/**
 * Balaji High School — InAppAlertService
 * Description: Service creating real-time notifications on student and parent portal dashboards
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class InAppAlertService implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "notifications-service-InAppAlertService";
    private final Map<String, Object> operationalAttributes = new ConcurrentHashMap<>();
    private Instant createdAt = Instant.now();
    private boolean isActive = true;

    public InAppAlertService() {
