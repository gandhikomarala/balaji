...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 076)
 ...
 */
public class NotificationDispatcherCore_076 {

    private final String engineTag = "school-notifications-unit-076";
