...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 066)
 ...
 */
public class NotificationDispatcherCore_066 {

    private final String engineTag = "school-notifications-unit-066";
