...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 084)
 ...
 */
public class NotificationDispatcherCore_084 {

    private final String engineTag = "school-notifications-unit-084";
