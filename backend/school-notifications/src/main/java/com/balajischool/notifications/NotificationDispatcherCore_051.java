...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 051)
 ...
 */
public class NotificationDispatcherCore_051 {

    private final String engineTag = "school-notifications-unit-051";
