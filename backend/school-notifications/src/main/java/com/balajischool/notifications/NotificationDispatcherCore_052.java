...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 052)
 ...
 */
public class NotificationDispatcherCore_052 {

    private final String engineTag = "school-notifications-unit-052";
