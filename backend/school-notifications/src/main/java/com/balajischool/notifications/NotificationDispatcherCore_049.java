...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 049)
 ...
 */
public class NotificationDispatcherCore_049 {

    private final String engineTag = "school-notifications-unit-049";
