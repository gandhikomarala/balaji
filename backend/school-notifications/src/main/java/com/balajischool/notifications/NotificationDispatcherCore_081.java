...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 081)
 ...
 */
public class NotificationDispatcherCore_081 {

    private final String engineTag = "school-notifications-unit-081";
