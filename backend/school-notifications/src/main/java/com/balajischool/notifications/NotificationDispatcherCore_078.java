...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 078)
 ...
 */
public class NotificationDispatcherCore_078 {

    private final String engineTag = "school-notifications-unit-078";
