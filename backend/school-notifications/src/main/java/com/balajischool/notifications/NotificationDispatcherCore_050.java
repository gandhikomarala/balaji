...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 050)
 ...
 */
public class NotificationDispatcherCore_050 {

    private final String engineTag = "school-notifications-unit-050";
