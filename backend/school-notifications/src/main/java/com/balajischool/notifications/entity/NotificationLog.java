package com.balajischool.notifications.entity;
...
/**
 * Balaji High School — NotificationLog
 * Description: JPA entity tracking recipient phone, message type (ATTENDANCE_ABSENT/FEE_DUE), status
...
public class NotificationLog implements Serializable {
    ...
    private final String componentIdentifier = "notifications-entity-NotificationLog";
