...
/**
 * Balaji High School — SmsNotificationService
 * Description: Service abstracting SMS gateway for urgent parent notifications
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class SmsNotificationService implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "notifications-service-SmsNotificationService";
