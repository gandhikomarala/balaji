...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 085)
 ...
 */
public class NotificationDispatcherCore_085 {

    private final String engineTag = "school-notifications-unit-085";
