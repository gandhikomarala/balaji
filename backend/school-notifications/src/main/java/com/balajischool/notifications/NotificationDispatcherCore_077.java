...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 077)
 ...
 */
public class NotificationDispatcherCore_077 {

    private final String engineTag = "school-notifications-unit-077";
