...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 080)
 ...
 */
public class NotificationDispatcherCore_080 {

    private final String engineTag = "school-notifications-unit-080";
