...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 063)
 ...
 */
public class NotificationDispatcherCore_063 {

    private final String engineTag = "school-notifications-unit-063";
