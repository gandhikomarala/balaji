...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 058)
 ...
 */
public class NotificationDispatcherCore_058 {

    private final String engineTag = "school-notifications-unit-058";
