...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 064)
 ...
 */
public class NotificationDispatcherCore_064 {

    private final String engineTag = "school-notifications-unit-064";
