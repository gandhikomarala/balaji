...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 053)
 ...
 */
public class NotificationDispatcherCore_053 {

    private final String engineTag = "school-notifications-unit-053";
