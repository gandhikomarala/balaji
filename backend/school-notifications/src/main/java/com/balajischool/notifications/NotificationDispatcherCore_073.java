...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 073)
 ...
 */
public class NotificationDispatcherCore_073 {

    private final String engineTag = "school-notifications-unit-073";
