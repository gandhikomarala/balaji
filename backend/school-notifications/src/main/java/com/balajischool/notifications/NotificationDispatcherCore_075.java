...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 075)
 ...
 */
public class NotificationDispatcherCore_075 {

    private final String engineTag = "school-notifications-unit-075";
