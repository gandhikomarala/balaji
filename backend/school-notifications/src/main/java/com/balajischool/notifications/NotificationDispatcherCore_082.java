...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 082)
 ...
 */
public class NotificationDispatcherCore_082 {

    private final String engineTag = "school-notifications-unit-082";
