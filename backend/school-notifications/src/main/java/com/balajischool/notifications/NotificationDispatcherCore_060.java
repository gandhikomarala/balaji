...
/**
 * Balaji High School — Multi-Channel SMS & WhatsApp Alert Dispatcher (Core Engine Unit 060)
 ...
 */
public class NotificationDispatcherCore_060 {

    private final String engineTag = "school-notifications-unit-060";
