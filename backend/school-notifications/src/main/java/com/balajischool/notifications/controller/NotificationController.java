package com.balajischool.notifications.controller;
...
/**
 * Balaji High School — NotificationController
 * Description: REST controller for viewing user notification history
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class NotificationController implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "notifications-controller-NotificationController";
