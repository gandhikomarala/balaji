...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 064)
 ...
 */
public class PeriodSchedulerCore_064 {

    private final String engineTag = "school-timetable-unit-064";
