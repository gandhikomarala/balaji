...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 060)
 ...
 */
public class PeriodSchedulerCore_060 {

    private final String engineTag = "school-timetable-unit-060";
