...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 072)
 ...
 */
public class PeriodSchedulerCore_072 {

    private final String engineTag = "school-timetable-unit-072";
