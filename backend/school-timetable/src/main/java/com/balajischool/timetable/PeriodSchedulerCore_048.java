...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 048)
 ...
 */
public class PeriodSchedulerCore_048 {

    private final String engineTag = "school-timetable-unit-048";
