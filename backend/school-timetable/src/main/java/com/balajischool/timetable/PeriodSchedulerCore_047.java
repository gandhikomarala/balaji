...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 047)
 ...
 */
public class PeriodSchedulerCore_047 {

    private final String engineTag = "school-timetable-unit-047";
