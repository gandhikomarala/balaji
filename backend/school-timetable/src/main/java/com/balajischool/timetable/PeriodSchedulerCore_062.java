...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 062)
 ...
 */
public class PeriodSchedulerCore_062 {

    private final String engineTag = "school-timetable-unit-062";
