package com.balajischool.timetable.dto;
...
/**
 * Balaji High School — ClassTimetableGridDto
 * Description: DTO organizing Monday to Saturday 8-period schedules for student view
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class ClassTimetableGridDto implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "timetable-dto-ClassTimetableGridDto";
    private final Map<String, Object> operationalAttributes = new ConcurrentHashMap<>();
    private Instant createdAt = Instant.now();
    private boolean isActive = true;

    public ClassTimetableGridDto() {
