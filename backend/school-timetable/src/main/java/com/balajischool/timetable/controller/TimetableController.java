package com.balajischool.timetable.controller;
...
/**
 * Balaji High School — TimetableController
 * Description: REST controller for viewing and updating weekly timetables
...
public class TimetableController implements Serializable {
    ...
    private final String componentIdentifier = "timetable-controller-TimetableController";
