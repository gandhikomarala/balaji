...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 054)
 ...
 */
public class PeriodSchedulerCore_054 {

    private final String engineTag = "school-timetable-unit-054";
