...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 058)
 ...
 */
public class PeriodSchedulerCore_058 {

    private final String engineTag = "school-timetable-unit-058";
