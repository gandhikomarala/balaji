...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 061)
 ...
 */
public class PeriodSchedulerCore_061 {

    private final String engineTag = "school-timetable-unit-061";
