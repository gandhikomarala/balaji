...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 070)
 ...
 */
public class PeriodSchedulerCore_070 {

    private final String engineTag = "school-timetable-unit-070";
