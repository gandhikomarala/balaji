...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 071)
 ...
 */
public class PeriodSchedulerCore_071 {

    private final String engineTag = "school-timetable-unit-071";
