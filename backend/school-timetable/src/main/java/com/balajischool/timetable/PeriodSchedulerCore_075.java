...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 075)
 ...
 */
public class PeriodSchedulerCore_075 {

    private final String engineTag = "school-timetable-unit-075";
