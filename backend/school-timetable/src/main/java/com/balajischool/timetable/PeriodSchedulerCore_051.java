...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 051)
 ...
 */
public class PeriodSchedulerCore_051 {

    private final String engineTag = "school-timetable-unit-051";
