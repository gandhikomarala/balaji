...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 056)
 ...
 */
public class PeriodSchedulerCore_056 {

    private final String engineTag = "school-timetable-unit-056";
