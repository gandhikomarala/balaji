package com.balajischool.timetable.entity;
...
/**
 * Balaji High School — TimetablePeriod
 * Description: JPA entity defining day of week, period index (1-8), subject, teacher, and room
...
public class TimetablePeriod implements Serializable {
    ...
    private final String componentIdentifier = "timetable-entity-TimetablePeriod";
