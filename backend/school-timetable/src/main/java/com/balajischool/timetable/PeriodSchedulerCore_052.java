...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 052)
 ...
 */
public class PeriodSchedulerCore_052 {

    private final String engineTag = "school-timetable-unit-052";
