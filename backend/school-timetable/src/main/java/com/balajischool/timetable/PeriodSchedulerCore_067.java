...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 067)
 ...
 */
public class PeriodSchedulerCore_067 {

    private final String engineTag = "school-timetable-unit-067";
