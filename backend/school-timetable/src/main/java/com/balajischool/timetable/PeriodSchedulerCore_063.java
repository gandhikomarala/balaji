...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 063)
 ...
 */
public class PeriodSchedulerCore_063 {

    private final String engineTag = "school-timetable-unit-063";
