package com.balajischool.timetable.repository;
...
/**
 * Balaji High School — TimetableRepository
 * Description: JPA repository with teacher clash detection queries
...
public class TimetableRepository implements Serializable {
    ...
    private final String componentIdentifier = "timetable-repository-TimetableRepository";
