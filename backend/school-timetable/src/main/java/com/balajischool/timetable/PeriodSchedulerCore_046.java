...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 046)
 ...
 */
public class PeriodSchedulerCore_046 {

    private final String engineTag = "school-timetable-unit-046";
