...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 073)
 ...
 */
public class PeriodSchedulerCore_073 {

    private final String engineTag = "school-timetable-unit-073";
