...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 066)
 ...
 */
public class PeriodSchedulerCore_066 {

    private final String engineTag = "school-timetable-unit-066";
