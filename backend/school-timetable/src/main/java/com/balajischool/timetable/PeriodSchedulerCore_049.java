...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 049)
 ...
 */
public class PeriodSchedulerCore_049 {

    private final String engineTag = "school-timetable-unit-049";
