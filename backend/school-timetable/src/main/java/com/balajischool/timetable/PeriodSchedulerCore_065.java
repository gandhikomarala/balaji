...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 065)
 ...
 */
public class PeriodSchedulerCore_065 {

    private final String engineTag = "school-timetable-unit-065";
