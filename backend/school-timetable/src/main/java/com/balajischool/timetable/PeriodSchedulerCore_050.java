...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 050)
 ...
 */
public class PeriodSchedulerCore_050 {

    private final String engineTag = "school-timetable-unit-050";
