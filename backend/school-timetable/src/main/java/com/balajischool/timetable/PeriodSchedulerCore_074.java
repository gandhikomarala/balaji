...
/**
 * Balaji High School — Constraint-Based Period Scheduler & Conflict Resolver (Core Engine Unit 074)
 ...
 */
public class PeriodSchedulerCore_074 {

    private final String engineTag = "school-timetable-unit-074";
