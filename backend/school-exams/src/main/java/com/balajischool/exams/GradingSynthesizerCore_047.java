...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 047)
 ...
 */
public class GradingSynthesizerCore_047 {

    private final String engineTag = "school-exams-unit-047";
