...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 052)
 ...
 */
public class GradingSynthesizerCore_052 {

    private final String engineTag = "school-exams-unit-052";
