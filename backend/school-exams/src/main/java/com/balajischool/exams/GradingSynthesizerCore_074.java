...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 074)
 ...
 */
public class GradingSynthesizerCore_074 {

    private final String engineTag = "school-exams-unit-074";
