...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 062)
 ...
 */
public class GradingSynthesizerCore_062 {

    private final String engineTag = "school-exams-unit-062";
