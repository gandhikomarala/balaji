...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 054)
 ...
 */
public class GradingSynthesizerCore_054 {

    private final String engineTag = "school-exams-unit-054";
