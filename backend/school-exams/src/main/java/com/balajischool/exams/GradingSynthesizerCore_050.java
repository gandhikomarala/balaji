...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 050)
 ...
 */
public class GradingSynthesizerCore_050 {

    private final String engineTag = "school-exams-unit-050";
