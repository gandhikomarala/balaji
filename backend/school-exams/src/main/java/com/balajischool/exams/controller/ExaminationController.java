package com.balajischool.exams.controller;
...
/**
 * Balaji High School — ExaminationController
 * Description: REST controller for exam schedules, marks entry, and report card downloads
...
public class ExaminationController implements Serializable {
    ...
    private final String componentIdentifier = "exams-controller-ExaminationController";
