...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 067)
 ...
 */
public class GradingSynthesizerCore_067 {

    private final String engineTag = "school-exams-unit-067";
