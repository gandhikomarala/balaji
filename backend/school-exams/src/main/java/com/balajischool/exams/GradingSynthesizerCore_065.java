...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 065)
 ...
 */
public class GradingSynthesizerCore_065 {

    private final String engineTag = "school-exams-unit-065";
