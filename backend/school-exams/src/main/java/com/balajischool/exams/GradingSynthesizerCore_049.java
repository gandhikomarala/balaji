...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 049)
 ...
 */
public class GradingSynthesizerCore_049 {

    private final String engineTag = "school-exams-unit-049";
