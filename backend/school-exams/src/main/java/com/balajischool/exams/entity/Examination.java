...
/**
 * Balaji High School — Examination
 * Description: JPA entity defining exam term (Quarterly), academic year, and max marks schedule
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class Examination implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "exams-entity-Examination";
