...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 051)
 ...
 */
public class GradingSynthesizerCore_051 {

    private final String engineTag = "school-exams-unit-051";
