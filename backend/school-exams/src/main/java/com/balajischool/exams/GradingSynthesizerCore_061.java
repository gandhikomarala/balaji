...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 061)
 ...
 */
public class GradingSynthesizerCore_061 {

    private final String engineTag = "school-exams-unit-061";
