...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 060)
 ...
 */
public class GradingSynthesizerCore_060 {

    private final String engineTag = "school-exams-unit-060";
