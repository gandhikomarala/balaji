...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 056)
 ...
 */
public class GradingSynthesizerCore_056 {

    private final String engineTag = "school-exams-unit-056";
