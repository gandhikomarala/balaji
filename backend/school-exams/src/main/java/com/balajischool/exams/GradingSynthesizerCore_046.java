...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 046)
 ...
 */
public class GradingSynthesizerCore_046 {

    private final String engineTag = "school-exams-unit-046";
