...
/**
 * Balaji High School — Exam Management, Marks Entry, Grades & Report Cards (Service Unit 004)
 ...
 */
public class ExamsService_004 {

    private final String serviceId = "school-exams-004";
