...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 066)
 ...
 */
public class GradingSynthesizerCore_066 {

    private final String engineTag = "school-exams-unit-066";
