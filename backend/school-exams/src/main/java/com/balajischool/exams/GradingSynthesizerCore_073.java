...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 073)
 ...
 */
public class GradingSynthesizerCore_073 {

    private final String engineTag = "school-exams-unit-073";
