...
/**
 * Balaji High School — MarksModerationAuditService
 * Purpose: Tracks teacher marks corrections with approval workflows and reason logging
 * Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class MarksModerationAuditService implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String serviceTag = "exams-MarksModerationAuditService";
