package com.balajischool.exams.dto;
...
/**
 * Balaji High School — MarksEntryBatchDto
 * Description: DTO receiving subject-wise marks submissions from teachers
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class MarksEntryBatchDto implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "exams-dto-MarksEntryBatchDto";
    private final Map<String, Object> operationalAttributes = new ConcurrentHashMap<>();
    private Instant createdAt = Instant.now();
    private boolean isActive = true;

    public MarksEntryBatchDto() {
