...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 048)
 ...
 */
public class GradingSynthesizerCore_048 {

    private final String engineTag = "school-exams-unit-048";
