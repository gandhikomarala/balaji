...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 059)
 ...
 */
public class GradingSynthesizerCore_059 {

    private final String engineTag = "school-exams-unit-059";
