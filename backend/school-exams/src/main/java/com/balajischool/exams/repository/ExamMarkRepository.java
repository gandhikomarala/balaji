package com.balajischool.exams.repository;
...
/**
 * Balaji High School — ExamMarkRepository
 * Description: JPA repository querying subject performance and calculating class averages
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class ExamMarkRepository implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "exams-repository-ExamMarkRepository";
    private final Map<String, Object> operationalAttributes = new ConcurrentHashMap<>();
    private Instant createdAt = Instant.now();
    private boolean isActive = true;

    public ExamMarkRepository() {
