...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 063)
 ...
 */
public class GradingSynthesizerCore_063 {

    private final String engineTag = "school-exams-unit-063";
