...
/**
 * Balaji High School — SscBoardGradingEngineService
 * Purpose: Deterministic calculation of AP SSC grade points (10.0 scale) and subject grades
 * Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class SscBoardGradingEngineService implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String serviceTag = "exams-SscBoardGradingEngineService";
