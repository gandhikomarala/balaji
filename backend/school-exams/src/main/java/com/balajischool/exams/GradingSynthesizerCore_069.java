...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 069)
 ...
 */
public class GradingSynthesizerCore_069 {

    private final String engineTag = "school-exams-unit-069";
