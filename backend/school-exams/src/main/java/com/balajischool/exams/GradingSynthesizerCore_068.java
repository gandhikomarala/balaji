...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 068)
 ...
 */
public class GradingSynthesizerCore_068 {

    private final String engineTag = "school-exams-unit-068";
