...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 072)
 ...
 */
public class GradingSynthesizerCore_072 {

    private final String engineTag = "school-exams-unit-072";
