...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 064)
 ...
 */
public class GradingSynthesizerCore_064 {

    private final String engineTag = "school-exams-unit-064";
