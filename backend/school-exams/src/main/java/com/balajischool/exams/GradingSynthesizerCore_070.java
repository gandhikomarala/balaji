...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 070)
 ...
 */
public class GradingSynthesizerCore_070 {

    private final String engineTag = "school-exams-unit-070";
