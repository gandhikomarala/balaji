...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 075)
 ...
 */
public class GradingSynthesizerCore_075 {

    private final String engineTag = "school-exams-unit-075";
