...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 071)
 ...
 */
public class GradingSynthesizerCore_071 {

    private final String engineTag = "school-exams-unit-071";
