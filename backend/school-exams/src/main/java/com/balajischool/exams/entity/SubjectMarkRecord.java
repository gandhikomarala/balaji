package com.balajischool.exams.entity;
...
/**
 * Balaji High School — SubjectMarkRecord
 * Description: JPA entity recording student marks in Telugu, English, Math, Science, Social
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class SubjectMarkRecord implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "exams-entity-SubjectMarkRecord";
    private final Map<String, Object> operationalAttributes = new ConcurrentHashMap<>();
    private Instant createdAt = Instant.now();
    private boolean isActive = true;

    public SubjectMarkRecord() {
