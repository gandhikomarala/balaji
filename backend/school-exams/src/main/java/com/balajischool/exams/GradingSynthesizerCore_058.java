...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 058)
 ...
 */
public class GradingSynthesizerCore_058 {

    private final String engineTag = "school-exams-unit-058";
