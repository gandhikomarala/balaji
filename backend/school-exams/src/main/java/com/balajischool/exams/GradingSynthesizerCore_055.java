...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 055)
 ...
 */
public class GradingSynthesizerCore_055 {

    private final String engineTag = "school-exams-unit-055";
