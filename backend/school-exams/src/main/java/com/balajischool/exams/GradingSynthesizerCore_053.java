...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 053)
 ...
 */
public class GradingSynthesizerCore_053 {

    private final String engineTag = "school-exams-unit-053";
