...
/**
 * Balaji High School — Exam Management, Marks Entry, Grades & Report Cards (Service Unit 009)
 ...
 */
public class ExamsService_009 {

    private final String serviceId = "school-exams-009";
