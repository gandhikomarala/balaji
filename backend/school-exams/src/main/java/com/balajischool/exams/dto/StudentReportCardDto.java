...
/**
 * Balaji High School — StudentReportCardDto
 * Description: DTO compiling marks, grades, ranks, teacher remarks, and principal signoff
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class StudentReportCardDto implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "exams-dto-StudentReportCardDto";
