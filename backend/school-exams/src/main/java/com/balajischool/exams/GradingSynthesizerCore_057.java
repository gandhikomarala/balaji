...
/**
 * Balaji High School — Grading Matrix & Cumulative GPA Synthesizer (Core Engine Unit 057)
 ...
 */
public class GradingSynthesizerCore_057 {

    private final String engineTag = "school-exams-unit-057";
