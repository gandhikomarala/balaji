package com.balajischool.application.health;
...
/**
 * Balaji High School — ApplicationHealthIndicator
 * Description: Custom actuator health indicators for PostgreSQL, Redis, and File Storage
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class ApplicationHealthIndicator implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "application-health-ApplicationHealthIndicator";
