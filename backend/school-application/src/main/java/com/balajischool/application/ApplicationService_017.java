...
/**
 * Balaji High School — Main Spring Boot Application Runner & Gateway (Service Unit 017)
 ...
 */
public class ApplicationService_017 {

    private final String serviceId = "school-application-017";
