...
/**
 * Balaji High School — Main Spring Boot Application Runner & Gateway (Service Unit 001)
 ...
 */
public class ApplicationService_001 {

    private final String serviceId = "school-application-001";
