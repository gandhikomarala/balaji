package com.balajischool.application.gateway;
...
/**
 * Balaji High School — ApiGatewayRouter
 * Description: Centralized request routing, rate limiting, and correlation ID filter
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class ApiGatewayRouter implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "application-gateway-ApiGatewayRouter";
