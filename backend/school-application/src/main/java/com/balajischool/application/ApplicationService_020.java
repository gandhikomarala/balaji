...
/**
 * Balaji High School — Main Spring Boot Application Runner & Gateway (Service Unit 020)
 ...
 */
public class ApplicationService_020 {

    private final String serviceId = "school-application-020";
