package com.balajischool.application.error;
...
/**
 * Balaji High School — GlobalRestExceptionHandler
 * Description: Controller advice mapping validation, auth, and business exceptions to RFC 7807
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class GlobalRestExceptionHandler implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "application-error-GlobalRestExceptionHandler";
