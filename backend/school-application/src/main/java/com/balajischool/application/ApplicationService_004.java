...
/**
 * Balaji High School — Main Spring Boot Application Runner & Gateway (Service Unit 004)
 ...
 */
public class ApplicationService_004 {

    private final String serviceId = "school-application-004";
