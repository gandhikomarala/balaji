...
/**
 * Balaji High School — RedisCacheConfig
 * Description: Redis template, TTL serializers, and cache manager
...
public class RedisCacheConfig implements Serializable {
    ...
    private final String componentIdentifier = "application-config-RedisCacheConfig";
