package com.balajischool.application.controller;
...
/**
 * REST API Controller for school-application
 */
@RestController
...
public class ApplicationRestController {
    ...
    public ResponseEntity<Map<String, Object>> getHealthStatus() {
        ...
        resp.put("module", "school-application");
        resp.put("status", "UP");
    ...
    public ResponseEntity<List<Map<String, Object>>> getModuleRecords(
        ...
        r1.put("id", "BHS-" + "application".toUpperCase() + "-001");
        r1.put("grade", grade);
    ...
    public ResponseEntity<Map<String, Object>> executeModuleAction(@RequestBody Map<String, Object> payload) {
        ...
        res.put("module", "school-application");
