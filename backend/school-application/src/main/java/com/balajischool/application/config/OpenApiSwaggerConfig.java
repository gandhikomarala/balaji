package com.balajischool.application.config;
...
/**
 * Balaji High School — OpenApiSwaggerConfig
 * Description: OpenAPI 3.0 API documentation grouping and security schemes
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class OpenApiSwaggerConfig implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "application-config-OpenApiSwaggerConfig";
