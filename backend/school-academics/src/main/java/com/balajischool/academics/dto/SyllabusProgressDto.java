package com.balajischool.academics.dto;
...
/**
 * Balaji High School — SyllabusProgressDto
 * Description: DTO tracking chapter completion percentage per teacher
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class SyllabusProgressDto implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "academics-dto-SyllabusProgressDto";
    private final Map<String, Object> operationalAttributes = new ConcurrentHashMap<>();
    private Instant createdAt = Instant.now();
    private boolean isActive = true;

    public SyllabusProgressDto() {
