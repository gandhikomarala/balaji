...
/**
 * Balaji High School — Class 6-10 Curriculum, Sections & Academic Year Calendar (Service Unit 004)
 ...
 */
public class AcademicsService_004 {

    private final String serviceId = "school-academics-004";
