package com.balajischool.academics.entity;
...
/**
 * Balaji High School — SubjectCurriculum
 * Description: JPA entity detailing syllabus chapters, Telugu/English textbooks, and lab requirements
...
public class SubjectCurriculum implements Serializable {
    ...
    private final String componentIdentifier = "academics-entity-SubjectCurriculum";
