...
/**
 * Balaji High School — AcademicCurriculumService
 * Description: Service managing term dates, syllabus milestones, and working day calendar
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class AcademicCurriculumService implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "academics-service-AcademicCurriculumService";
    private final Map<String, Object> operationalAttributes = new ConcurrentHashMap<>();
    private Instant createdAt = Instant.now();
    private boolean isActive = true;

    public AcademicCurriculumService() {
