...
/**
 * Balaji High School — ClassSection
 * Description: JPA entity representing Grade 6 to 10 with Section A and B, room, and capacity
...
public class ClassSection implements Serializable {
    ...
    private final String componentIdentifier = "academics-entity-ClassSection";
