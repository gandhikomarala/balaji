...
/**
 * Balaji High School — AcademicTermCalendarService
 * Purpose: Defines working days, unit test dates, quarterly exams, and annual vacation
 * Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class AcademicTermCalendarService implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String serviceTag = "academics-AcademicTermCalendarService";
