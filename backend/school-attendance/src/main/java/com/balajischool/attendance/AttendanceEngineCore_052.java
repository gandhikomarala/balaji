...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 052)
 ...
 */
public class AttendanceEngineCore_052 {

    private final String engineTag = "school-attendance-unit-052";
