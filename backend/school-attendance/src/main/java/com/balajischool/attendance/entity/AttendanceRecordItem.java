...
/**
 * Balaji High School — AttendanceRecordItem
 * Description: JPA entity linking individual student to PRESENT/ABSENT status and remarks
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class AttendanceRecordItem implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "attendance-entity-AttendanceRecordItem";
    private final Map<String, Object> operationalAttributes = new ConcurrentHashMap<>();
    private Instant createdAt = Instant.now();
    private boolean isActive = true;

    public AttendanceRecordItem() {
