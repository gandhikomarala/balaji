package com.balajischool.attendance.controller;
...
/**
 * Balaji High School — AttendanceController
 * Description: REST controller for recording, updating, and viewing attendance logs
...
public class AttendanceController implements Serializable {
    ...
    private final String componentIdentifier = "attendance-controller-AttendanceController";
