...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 056)
 ...
 */
public class AttendanceEngineCore_056 {

    private final String engineTag = "school-attendance-unit-056";
