...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 048)
 ...
 */
public class AttendanceEngineCore_048 {

    private final String engineTag = "school-attendance-unit-048";
