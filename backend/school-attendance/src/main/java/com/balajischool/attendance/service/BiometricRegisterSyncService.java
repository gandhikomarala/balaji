...
/**
 * Balaji High School — BiometricRegisterSyncService
 * Purpose: Integrates optical/RFID student morning card scans with classroom registers
 * Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class BiometricRegisterSyncService implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String serviceTag = "attendance-BiometricRegisterSyncService";
