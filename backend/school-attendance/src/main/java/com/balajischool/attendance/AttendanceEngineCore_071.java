...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 071)
 ...
 */
public class AttendanceEngineCore_071 {

    private final String engineTag = "school-attendance-unit-071";
