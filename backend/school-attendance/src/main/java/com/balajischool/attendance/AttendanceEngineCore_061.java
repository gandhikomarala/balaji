...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 061)
 ...
 */
public class AttendanceEngineCore_061 {

    private final String engineTag = "school-attendance-unit-061";
