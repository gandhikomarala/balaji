...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 063)
 ...
 */
public class AttendanceEngineCore_063 {

    private final String engineTag = "school-attendance-unit-063";
