...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 055)
 ...
 */
public class AttendanceEngineCore_055 {

    private final String engineTag = "school-attendance-unit-055";
