...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 070)
 ...
 */
public class AttendanceEngineCore_070 {

    private final String engineTag = "school-attendance-unit-070";
