package com.balajischool.attendance.repository;
...
/**
 * Balaji High School — AttendanceRegisterRepository
 * Description: JPA repository querying daily sheets by class and date ranges
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class AttendanceRegisterRepository implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "attendance-repository-AttendanceRegisterRepository";
    private final Map<String, Object> operationalAttributes = new ConcurrentHashMap<>();
    private Instant createdAt = Instant.now();
    private boolean isActive = true;

    public AttendanceRegisterRepository() {
