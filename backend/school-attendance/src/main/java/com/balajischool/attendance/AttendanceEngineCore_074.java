...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 074)
 ...
 */
public class AttendanceEngineCore_074 {

    private final String engineTag = "school-attendance-unit-074";
