...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 051)
 ...
 */
public class AttendanceEngineCore_051 {

    private final String engineTag = "school-attendance-unit-051";
