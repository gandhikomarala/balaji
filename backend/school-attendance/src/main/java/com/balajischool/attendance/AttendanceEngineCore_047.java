...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 047)
 ...
 */
public class AttendanceEngineCore_047 {

    private final String engineTag = "school-attendance-unit-047";
