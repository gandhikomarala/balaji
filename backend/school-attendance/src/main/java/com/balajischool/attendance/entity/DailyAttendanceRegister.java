package com.balajischool.attendance.entity;
...
/**
 * Balaji High School — DailyAttendanceRegister
 * Description: JPA entity storing date, class, section, teacher signature, and attendance items
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class DailyAttendanceRegister implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "attendance-entity-DailyAttendanceRegister";
    private final Map<String, Object> operationalAttributes = new ConcurrentHashMap<>();
    private Instant createdAt = Instant.now();
    private boolean isActive = true;

    public DailyAttendanceRegister() {
