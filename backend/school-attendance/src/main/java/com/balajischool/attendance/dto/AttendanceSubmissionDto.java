...
/**
 * Balaji High School — AttendanceSubmissionDto
 * Description: DTO receiving bulk attendance sheet from teacher mobile or portal
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class AttendanceSubmissionDto implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "attendance-dto-AttendanceSubmissionDto";
