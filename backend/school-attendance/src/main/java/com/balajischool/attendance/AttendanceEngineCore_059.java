...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 059)
 ...
 */
public class AttendanceEngineCore_059 {

    private final String engineTag = "school-attendance-unit-059";
