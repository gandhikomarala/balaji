...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 067)
 ...
 */
public class AttendanceEngineCore_067 {

    private final String engineTag = "school-attendance-unit-067";
