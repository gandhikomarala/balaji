...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 053)
 ...
 */
public class AttendanceEngineCore_053 {

    private final String engineTag = "school-attendance-unit-053";
