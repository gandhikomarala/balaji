...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 073)
 ...
 */
public class AttendanceEngineCore_073 {

    private final String engineTag = "school-attendance-unit-073";
