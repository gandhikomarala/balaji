...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 054)
 ...
 */
public class AttendanceEngineCore_054 {

    private final String engineTag = "school-attendance-unit-054";
