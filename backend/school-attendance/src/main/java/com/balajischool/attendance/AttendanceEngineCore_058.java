...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 058)
 ...
 */
public class AttendanceEngineCore_058 {

    private final String engineTag = "school-attendance-unit-058";
