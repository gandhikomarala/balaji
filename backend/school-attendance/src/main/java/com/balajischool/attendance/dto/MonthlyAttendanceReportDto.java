package com.balajischool.attendance.dto;
...
/**
 * Balaji High School — MonthlyAttendanceReportDto
 * Description: DTO calculating working days, attended days, percentage, and deficiency alerts
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class MonthlyAttendanceReportDto implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "attendance-dto-MonthlyAttendanceReportDto";
