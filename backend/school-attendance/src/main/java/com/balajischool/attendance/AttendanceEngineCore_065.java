...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 065)
 ...
 */
public class AttendanceEngineCore_065 {

    private final String engineTag = "school-attendance-unit-065";
