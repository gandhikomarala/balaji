...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 064)
 ...
 */
public class AttendanceEngineCore_064 {

    private final String engineTag = "school-attendance-unit-064";
