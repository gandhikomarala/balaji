...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 046)
 ...
 */
public class AttendanceEngineCore_046 {

    private final String engineTag = "school-attendance-unit-046";
