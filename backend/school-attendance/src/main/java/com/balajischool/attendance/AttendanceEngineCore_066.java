...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 066)
 ...
 */
public class AttendanceEngineCore_066 {

    private final String engineTag = "school-attendance-unit-066";
