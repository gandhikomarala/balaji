...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 075)
 ...
 */
public class AttendanceEngineCore_075 {

    private final String engineTag = "school-attendance-unit-075";
