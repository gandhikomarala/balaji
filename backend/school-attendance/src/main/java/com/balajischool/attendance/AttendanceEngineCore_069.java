...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 069)
 ...
 */
public class AttendanceEngineCore_069 {

    private final String engineTag = "school-attendance-unit-069";
