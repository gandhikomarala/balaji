...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 050)
 ...
 */
public class AttendanceEngineCore_050 {

    private final String engineTag = "school-attendance-unit-050";
