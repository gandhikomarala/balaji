...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 049)
 ...
 */
public class AttendanceEngineCore_049 {

    private final String engineTag = "school-attendance-unit-049";
