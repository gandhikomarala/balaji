...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 062)
 ...
 */
public class AttendanceEngineCore_062 {

    private final String engineTag = "school-attendance-unit-062";
