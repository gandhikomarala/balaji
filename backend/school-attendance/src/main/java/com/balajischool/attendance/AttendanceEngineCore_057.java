...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 057)
 ...
 */
public class AttendanceEngineCore_057 {

    private final String engineTag = "school-attendance-unit-057";
