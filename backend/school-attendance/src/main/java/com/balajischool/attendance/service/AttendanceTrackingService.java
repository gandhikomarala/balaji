...
/**
 * Balaji High School — AttendanceTrackingService
 * Description: Service processing attendance submissions, lockouts, and parent SMS alerts
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class AttendanceTrackingService implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "attendance-service-AttendanceTrackingService";
    private final Map<String, Object> operationalAttributes = new ConcurrentHashMap<>();
    private Instant createdAt = Instant.now();
    private boolean isActive = true;

    public AttendanceTrackingService() {
