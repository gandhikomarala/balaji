...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 068)
 ...
 */
public class AttendanceEngineCore_068 {

    private final String engineTag = "school-attendance-unit-068";
