...
/**
 * Balaji High School — Biometric & Class Attendance Aggregator (Core Engine Unit 060)
 ...
 */
public class AttendanceEngineCore_060 {

    private final String engineTag = "school-attendance-unit-060";
