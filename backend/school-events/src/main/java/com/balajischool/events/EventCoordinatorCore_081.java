...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 081)
 ...
 */
public class EventCoordinatorCore_081 {

    private final String engineTag = "school-events-unit-081";
