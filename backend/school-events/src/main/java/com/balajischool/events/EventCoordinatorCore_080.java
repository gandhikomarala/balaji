...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 080)
 ...
 */
public class EventCoordinatorCore_080 {

    private final String engineTag = "school-events-unit-080";
