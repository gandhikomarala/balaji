...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 071)
 ...
 */
public class EventCoordinatorCore_071 {

    private final String engineTag = "school-events-unit-071";
