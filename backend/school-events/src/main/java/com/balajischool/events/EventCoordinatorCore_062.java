...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 062)
 ...
 */
public class EventCoordinatorCore_062 {

    private final String engineTag = "school-events-unit-062";
