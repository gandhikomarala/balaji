...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 052)
 ...
 */
public class EventCoordinatorCore_052 {

    private final String engineTag = "school-events-unit-052";
