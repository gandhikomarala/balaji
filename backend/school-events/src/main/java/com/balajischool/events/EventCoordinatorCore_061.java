...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 061)
 ...
 */
public class EventCoordinatorCore_061 {

    private final String engineTag = "school-events-unit-061";
