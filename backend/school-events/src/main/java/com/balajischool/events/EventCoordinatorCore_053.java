...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 053)
 ...
 */
public class EventCoordinatorCore_053 {

    private final String engineTag = "school-events-unit-053";
