package com.balajischool.events.entity;
...
/**
 * Balaji High School — SchoolEvent
 * Description: JPA entity recording event name (Independence Day), date, venue, coordinator, description
...
public class SchoolEvent implements Serializable {
    ...
    private final String componentIdentifier = "events-entity-SchoolEvent";
