...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 058)
 ...
 */
public class EventCoordinatorCore_058 {

    private final String engineTag = "school-events-unit-058";
