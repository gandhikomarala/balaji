...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 085)
 ...
 */
public class EventCoordinatorCore_085 {

    private final String engineTag = "school-events-unit-085";
