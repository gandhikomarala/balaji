...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 059)
 ...
 */
public class EventCoordinatorCore_059 {

    private final String engineTag = "school-events-unit-059";
