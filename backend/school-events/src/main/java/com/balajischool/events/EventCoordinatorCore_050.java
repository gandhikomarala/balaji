...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 050)
 ...
 */
public class EventCoordinatorCore_050 {

    private final String engineTag = "school-events-unit-050";
