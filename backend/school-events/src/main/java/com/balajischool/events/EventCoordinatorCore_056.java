...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 056)
 ...
 */
public class EventCoordinatorCore_056 {

    private final String engineTag = "school-events-unit-056";
