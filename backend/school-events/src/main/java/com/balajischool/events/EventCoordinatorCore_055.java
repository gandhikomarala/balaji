...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 055)
 ...
 */
public class EventCoordinatorCore_055 {

    private final String engineTag = "school-events-unit-055";
