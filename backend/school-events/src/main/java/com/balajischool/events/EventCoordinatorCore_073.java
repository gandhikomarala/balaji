...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 073)
 ...
 */
public class EventCoordinatorCore_073 {

    private final String engineTag = "school-events-unit-073";
