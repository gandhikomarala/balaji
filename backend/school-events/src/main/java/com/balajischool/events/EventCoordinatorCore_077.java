...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 077)
 ...
 */
public class EventCoordinatorCore_077 {

    private final String engineTag = "school-events-unit-077";
