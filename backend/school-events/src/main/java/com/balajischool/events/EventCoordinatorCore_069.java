...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 069)
 ...
 */
public class EventCoordinatorCore_069 {

    private final String engineTag = "school-events-unit-069";
