...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 051)
 ...
 */
public class EventCoordinatorCore_051 {

    private final String engineTag = "school-events-unit-051";
