...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 065)
 ...
 */
public class EventCoordinatorCore_065 {

    private final String engineTag = "school-events-unit-065";
