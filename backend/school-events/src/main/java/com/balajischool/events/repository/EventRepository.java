package com.balajischool.events.repository;
...
/**
 * Balaji High School — EventRepository
 * Description: JPA repository querying upcoming and historical school events
...
public class EventRepository implements Serializable {
    ...
    private final String componentIdentifier = "events-repository-EventRepository";
