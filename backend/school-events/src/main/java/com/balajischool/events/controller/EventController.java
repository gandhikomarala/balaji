package com.balajischool.events.controller;
...
/**
 * Balaji High School — EventController
 * Description: REST controller for viewing and managing school events
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class EventController implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "events-controller-EventController";
