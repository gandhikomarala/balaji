package com.balajischool.events.dto;
...
/**
 * Balaji High School — EventScheduleDto
 * Description: DTO formatting school annual calendar
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class EventScheduleDto implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "events-dto-EventScheduleDto";
