...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 079)
 ...
 */
public class EventCoordinatorCore_079 {

    private final String engineTag = "school-events-unit-079";
