...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 046)
 ...
 */
public class EventCoordinatorCore_046 {

    private final String engineTag = "school-events-unit-046";
