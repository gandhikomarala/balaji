...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 072)
 ...
 */
public class EventCoordinatorCore_072 {

    private final String engineTag = "school-events-unit-072";
