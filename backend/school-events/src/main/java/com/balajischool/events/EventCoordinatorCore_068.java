...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 068)
 ...
 */
public class EventCoordinatorCore_068 {

    private final String engineTag = "school-events-unit-068";
