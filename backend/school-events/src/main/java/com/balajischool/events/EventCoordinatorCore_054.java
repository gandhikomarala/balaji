...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 054)
 ...
 */
public class EventCoordinatorCore_054 {

    private final String engineTag = "school-events-unit-054";
