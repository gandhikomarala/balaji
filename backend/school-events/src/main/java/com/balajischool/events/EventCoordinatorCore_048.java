...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 048)
 ...
 */
public class EventCoordinatorCore_048 {

    private final String engineTag = "school-events-unit-048";
