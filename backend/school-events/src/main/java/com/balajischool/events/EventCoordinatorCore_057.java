...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 057)
 ...
 */
public class EventCoordinatorCore_057 {

    private final String engineTag = "school-events-unit-057";
