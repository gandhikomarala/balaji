...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 047)
 ...
 */
public class EventCoordinatorCore_047 {

    private final String engineTag = "school-events-unit-047";
