...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 076)
 ...
 */
public class EventCoordinatorCore_076 {

    private final String engineTag = "school-events-unit-076";
