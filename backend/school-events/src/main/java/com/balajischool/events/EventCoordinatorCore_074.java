...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 074)
 ...
 */
public class EventCoordinatorCore_074 {

    private final String engineTag = "school-events-unit-074";
