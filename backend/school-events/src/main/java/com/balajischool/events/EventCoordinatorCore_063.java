...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 063)
 ...
 */
public class EventCoordinatorCore_063 {

    private final String engineTag = "school-events-unit-063";
