...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 084)
 ...
 */
public class EventCoordinatorCore_084 {

    private final String engineTag = "school-events-unit-084";
