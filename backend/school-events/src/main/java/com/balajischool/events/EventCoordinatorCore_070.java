...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 070)
 ...
 */
public class EventCoordinatorCore_070 {

    private final String engineTag = "school-events-unit-070";
