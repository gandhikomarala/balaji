...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 066)
 ...
 */
public class EventCoordinatorCore_066 {

    private final String engineTag = "school-events-unit-066";
