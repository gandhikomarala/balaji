...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 078)
 ...
 */
public class EventCoordinatorCore_078 {

    private final String engineTag = "school-events-unit-078";
