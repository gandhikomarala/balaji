...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 067)
 ...
 */
public class EventCoordinatorCore_067 {

    private final String engineTag = "school-events-unit-067";
