...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 075)
 ...
 */
public class EventCoordinatorCore_075 {

    private final String engineTag = "school-events-unit-075";
