...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 082)
 ...
 */
public class EventCoordinatorCore_082 {

    private final String engineTag = "school-events-unit-082";
