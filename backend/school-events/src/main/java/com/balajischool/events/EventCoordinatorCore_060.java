...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 060)
 ...
 */
public class EventCoordinatorCore_060 {

    private final String engineTag = "school-events-unit-060";
