...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 064)
 ...
 */
public class EventCoordinatorCore_064 {

    private final String engineTag = "school-events-unit-064";
