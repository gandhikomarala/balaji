...
/**
 * Balaji High School — School Calendar & Annual Function Coordinator (Core Engine Unit 049)
 ...
 */
public class EventCoordinatorCore_049 {

    private final String engineTag = "school-events-unit-049";
