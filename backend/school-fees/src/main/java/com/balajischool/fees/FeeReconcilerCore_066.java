...
/**
 * Balaji High School — Fee Concession & General Ledger Reconciler (Core Engine Unit 066)
 ...
 */
public class FeeReconcilerCore_066 {

    private final String engineTag = "school-fees-unit-066";
