...
/**
 * Balaji High School — Fee Collection, Concessions, Dues & PDF Receipt Generator (Service Unit 028)
 ...
 */
public class FeesService_028 {

    private final String serviceId = "school-fees-028";
