...
/**
 * Balaji High School — FeePaymentRequest
 * Description: DTO submitting student fee installment payment
...
public class FeePaymentRequest implements Serializable {
    ...
    private final String componentIdentifier = "fees-dto-FeePaymentRequest";
