...
/**
 * Balaji High School — Fee Collection, Concessions, Dues & PDF Receipt Generator (Service Unit 006)
 ...
 */
public class FeesService_006 {

    private final String serviceId = "school-fees-006";
