...
/**
 * Balaji High School — Fee Collection, Concessions, Dues & PDF Receipt Generator (Service Unit 018)
 ...
 */
public class FeesService_018 {

    private final String serviceId = "school-fees-018";
