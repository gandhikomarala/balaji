...
/**
 * Balaji High School — Fee Collection, Concessions, Dues & PDF Receipt Generator (Service Unit 036)
 ...
 */
public class FeesService_036 {

    private final String serviceId = "school-fees-036";
