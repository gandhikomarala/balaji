package com.balajischool.fees.controller;
...
/**
 * Balaji High School — FeeController
 * Description: REST controller for fee dues inspection, payments, and PDF receipt downloads
...
public class FeeController implements Serializable {
    ...
    private final String componentIdentifier = "fees-controller-FeeController";
