...
/**
 * Balaji High School — Fee Collection, Concessions, Dues & PDF Receipt Generator (Service Unit 017)
 ...
 */
public class FeesService_017 {

    private final String serviceId = "school-fees-017";
