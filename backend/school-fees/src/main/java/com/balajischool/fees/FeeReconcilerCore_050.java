...
/**
 * Balaji High School — Fee Concession & General Ledger Reconciler (Core Engine Unit 050)
 ...
 */
public class FeeReconcilerCore_050 {

    private final String engineTag = "school-fees-unit-050";
