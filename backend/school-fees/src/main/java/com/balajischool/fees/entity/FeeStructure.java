...
/**
 * Balaji High School — FeeStructure
 * Description: JPA entity defining annual tuition, admission, and exam fees per grade
...
public class FeeStructure implements Serializable {
    ...
    private final String componentIdentifier = "fees-entity-FeeStructure";
