package com.balajischool.fees.entity;
...
/**
 * Balaji High School — FeePaymentTransaction
 * Description: JPA entity recording transaction ID, amount paid, payment mode (UPI/Cash), date
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class FeePaymentTransaction implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "fees-entity-FeePaymentTransaction";
    private final Map<String, Object> operationalAttributes = new ConcurrentHashMap<>();
    private Instant createdAt = Instant.now();
    private boolean isActive = true;

    public FeePaymentTransaction() {
