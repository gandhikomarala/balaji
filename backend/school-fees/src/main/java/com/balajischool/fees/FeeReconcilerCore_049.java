...
/**
 * Balaji High School — Fee Concession & General Ledger Reconciler (Core Engine Unit 049)
 ...
 */
public class FeeReconcilerCore_049 {

    private final String engineTag = "school-fees-unit-049";
