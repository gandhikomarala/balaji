...
/**
 * Balaji High School — Fee Collection, Concessions, Dues & PDF Receipt Generator (Service Unit 005)
 ...
 */
public class FeesService_005 {

    private final String serviceId = "school-fees-005";
