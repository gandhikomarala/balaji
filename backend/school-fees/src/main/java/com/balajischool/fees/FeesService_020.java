...
/**
 * Balaji High School — Fee Collection, Concessions, Dues & PDF Receipt Generator (Service Unit 020)
 ...
 */
public class FeesService_020 {

    private final String serviceId = "school-fees-020";
