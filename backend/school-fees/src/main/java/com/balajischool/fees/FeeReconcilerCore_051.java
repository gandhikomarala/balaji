...
/**
 * Balaji High School — Fee Concession & General Ledger Reconciler (Core Engine Unit 051)
 ...
 */
public class FeeReconcilerCore_051 {

    private final String engineTag = "school-fees-unit-051";
