...
/**
 * Balaji High School — Fee Collection, Concessions, Dues & PDF Receipt Generator (Service Unit 040)
 ...
 */
public class FeesService_040 {

    private final String serviceId = "school-fees-040";
