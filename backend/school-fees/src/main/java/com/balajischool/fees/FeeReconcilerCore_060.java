...
/**
 * Balaji High School — Fee Concession & General Ledger Reconciler (Core Engine Unit 060)
 ...
 */
public class FeeReconcilerCore_060 {

    private final String engineTag = "school-fees-unit-060";
