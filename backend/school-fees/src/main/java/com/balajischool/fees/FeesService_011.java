...
/**
 * Balaji High School — Fee Collection, Concessions, Dues & PDF Receipt Generator (Service Unit 011)
 ...
 */
public class FeesService_011 {

    private final String serviceId = "school-fees-011";
