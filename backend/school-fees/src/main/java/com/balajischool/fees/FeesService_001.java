...
/**
 * Balaji High School — Fee Collection, Concessions, Dues & PDF Receipt Generator (Service Unit 001)
 ...
 */
public class FeesService_001 {

    private final String serviceId = "school-fees-001";
