...
/**
 * Balaji High School — Fee Collection, Concessions, Dues & PDF Receipt Generator (Service Unit 004)
 ...
 */
public class FeesService_004 {

    private final String serviceId = "school-fees-004";
