package com.balajischool.fees.dto;
...
/**
 * Balaji High School — FeeReceiptDto
 * Description: DTO formatting printable official Balaji High School fee receipt
...
public class FeeReceiptDto implements Serializable {
    ...
    private final String componentIdentifier = "fees-dto-FeeReceiptDto";
