...
/**
 * Balaji High School — Fee Collection, Concessions, Dues & PDF Receipt Generator (Service Unit 021)
 ...
 */
public class FeesService_021 {

    private final String serviceId = "school-fees-021";
