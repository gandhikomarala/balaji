...
/**
 * Balaji High School — Fee Concession & General Ledger Reconciler (Core Engine Unit 070)
 ...
 */
public class FeeReconcilerCore_070 {

    private final String engineTag = "school-fees-unit-070";
