...
/**
 * Balaji High School — Fee Concession & General Ledger Reconciler (Core Engine Unit 047)
 ...
 */
public class FeeReconcilerCore_047 {

    private final String engineTag = "school-fees-unit-047";
