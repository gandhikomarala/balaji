...
/**
 * Balaji High School — Fee Collection, Concessions, Dues & PDF Receipt Generator (Service Unit 003)
 ...
 */
public class FeesService_003 {

    private final String serviceId = "school-fees-003";
