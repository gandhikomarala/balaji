...
/**
 * Balaji High School — Fee Concession & General Ledger Reconciler (Core Engine Unit 048)
 ...
 */
public class FeeReconcilerCore_048 {

    private final String engineTag = "school-fees-unit-048";
