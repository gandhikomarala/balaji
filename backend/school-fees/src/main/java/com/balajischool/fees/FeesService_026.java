...
/**
 * Balaji High School — Fee Collection, Concessions, Dues & PDF Receipt Generator (Service Unit 026)
 ...
 */
public class FeesService_026 {

    private final String serviceId = "school-fees-026";
