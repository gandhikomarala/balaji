...
/**
 * Balaji High School — Fee Concession & General Ledger Reconciler (Core Engine Unit 059)
 ...
 */
public class FeeReconcilerCore_059 {

    private final String engineTag = "school-fees-unit-059";
