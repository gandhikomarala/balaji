...
/**
 * Balaji High School — Fee Collection, Concessions, Dues & PDF Receipt Generator (Service Unit 007)
 ...
 */
public class FeesService_007 {

    private final String serviceId = "school-fees-007";
