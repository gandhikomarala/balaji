...
/**
 * Balaji High School — Fee Collection, Concessions, Dues & PDF Receipt Generator (Service Unit 012)
 ...
 */
public class FeesService_012 {

    private final String serviceId = "school-fees-012";
