package com.balajischool.fees.repository;
...
/**
 * Balaji High School — FeeTransactionRepository
 * Description: JPA repository querying student payment history and pending dues
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class FeeTransactionRepository implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "fees-repository-FeeTransactionRepository";
