...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 071)
 ...
 */
public class TeacherWorkloadCore_071 {

    private final String engineTag = "school-teachers-unit-071";
