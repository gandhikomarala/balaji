...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 052)
 ...
 */
public class TeacherWorkloadCore_052 {

    private final String engineTag = "school-teachers-unit-052";
