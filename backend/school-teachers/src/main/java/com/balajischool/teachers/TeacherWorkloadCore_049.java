...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 049)
 ...
 */
public class TeacherWorkloadCore_049 {

    private final String engineTag = "school-teachers-unit-049";
