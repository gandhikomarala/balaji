...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 072)
 ...
 */
public class TeacherWorkloadCore_072 {

    private final String engineTag = "school-teachers-unit-072";
