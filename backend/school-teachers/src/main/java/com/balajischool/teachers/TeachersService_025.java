...
/**
 * Balaji High School — Teacher Directory, Subject Assignment & Class Management (Service Unit 025)
 ...
 */
public class TeachersService_025 {

    private final String serviceId = "school-teachers-025";
