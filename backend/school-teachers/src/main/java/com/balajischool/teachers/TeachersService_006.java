...
/**
 * Balaji High School — Teacher Directory, Subject Assignment & Class Management (Service Unit 006)
 ...
 */
public class TeachersService_006 {

    private final String serviceId = "school-teachers-006";
