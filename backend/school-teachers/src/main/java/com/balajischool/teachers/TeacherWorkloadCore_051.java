...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 051)
 ...
 */
public class TeacherWorkloadCore_051 {

    private final String engineTag = "school-teachers-unit-051";
