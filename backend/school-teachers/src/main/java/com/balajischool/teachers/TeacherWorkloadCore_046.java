...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 046)
 ...
 */
public class TeacherWorkloadCore_046 {

    private final String engineTag = "school-teachers-unit-046";
