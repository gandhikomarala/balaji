...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 048)
 ...
 */
public class TeacherWorkloadCore_048 {

    private final String engineTag = "school-teachers-unit-048";
