package com.balajischool.teachers.repository;
...
/**
 * Balaji High School — TeacherRepository
 * Description: JPA repository querying subject specialists and active class teachers
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class TeacherRepository implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "teachers-repository-TeacherRepository";
