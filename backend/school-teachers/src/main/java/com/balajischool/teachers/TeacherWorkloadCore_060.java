...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 060)
 ...
 */
public class TeacherWorkloadCore_060 {

    private final String engineTag = "school-teachers-unit-060";
