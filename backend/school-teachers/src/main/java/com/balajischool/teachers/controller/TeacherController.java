package com.balajischool.teachers.controller;
...
/**
 * Balaji High School — TeacherController
 * Description: REST controller for teacher directory, workload analytics, and profile management
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class TeacherController implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "teachers-controller-TeacherController";
