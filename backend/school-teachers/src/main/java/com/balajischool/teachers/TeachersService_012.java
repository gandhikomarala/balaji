...
/**
 * Balaji High School — Teacher Directory, Subject Assignment & Class Management (Service Unit 012)
 ...
 */
public class TeachersService_012 {

    private final String serviceId = "school-teachers-012";
