...
/**
 * Balaji High School — Teacher Directory, Subject Assignment & Class Management (Service Unit 021)
 ...
 */
public class TeachersService_021 {

    private final String serviceId = "school-teachers-021";
