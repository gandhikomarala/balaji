package com.balajischool.teachers.dto;
...
/**
 * Balaji High School — TeacherWorkloadSummary
 * Description: DTO summarizing weekly teaching periods, assigned subjects, and free periods
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class TeacherWorkloadSummary implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "teachers-dto-TeacherWorkloadSummary";
    private final Map<String, Object> operationalAttributes = new ConcurrentHashMap<>();
    private Instant createdAt = Instant.now();
    private boolean isActive = true;

    public TeacherWorkloadSummary() {
