...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 050)
 ...
 */
public class TeacherWorkloadCore_050 {

    private final String engineTag = "school-teachers-unit-050";
