...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 062)
 ...
 */
public class TeacherWorkloadCore_062 {

    private final String engineTag = "school-teachers-unit-062";
