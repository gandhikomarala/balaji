...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 056)
 ...
 */
public class TeacherWorkloadCore_056 {

    private final String engineTag = "school-teachers-unit-056";
