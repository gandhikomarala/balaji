...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 074)
 ...
 */
public class TeacherWorkloadCore_074 {

    private final String engineTag = "school-teachers-unit-074";
