...
/**
 * Balaji High School — Teacher Directory, Subject Assignment & Class Management (Service Unit 002)
 ...
 */
public class TeachersService_002 {

    private final String serviceId = "school-teachers-002";
