...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 066)
 ...
 */
public class TeacherWorkloadCore_066 {

    private final String engineTag = "school-teachers-unit-066";
