...
/**
 * Balaji High School — Teacher
 * Description: JPA entity with employee code, qualification (B.Ed/M.Sc), joining date, and subjects
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class Teacher implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "teachers-entity-Teacher";
