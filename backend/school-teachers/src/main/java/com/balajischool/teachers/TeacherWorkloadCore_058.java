...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 058)
 ...
 */
public class TeacherWorkloadCore_058 {

    private final String engineTag = "school-teachers-unit-058";
