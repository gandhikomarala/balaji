...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 063)
 ...
 */
public class TeacherWorkloadCore_063 {

    private final String engineTag = "school-teachers-unit-063";
