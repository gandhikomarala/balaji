...
/**
 * Balaji High School — Teacher Directory, Subject Assignment & Class Management (Service Unit 036)
 ...
 */
public class TeachersService_036 {

    private final String serviceId = "school-teachers-036";
