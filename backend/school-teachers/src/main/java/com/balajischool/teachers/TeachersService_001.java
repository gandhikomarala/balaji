...
/**
 * Balaji High School — Teacher Directory, Subject Assignment & Class Management (Service Unit 001)
 ...
 */
public class TeachersService_001 {

    private final String serviceId = "school-teachers-001";
