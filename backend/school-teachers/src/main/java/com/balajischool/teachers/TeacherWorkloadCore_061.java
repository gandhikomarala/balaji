...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 061)
 ...
 */
public class TeacherWorkloadCore_061 {

    private final String engineTag = "school-teachers-unit-061";
