...
/**
 * Balaji High School — TeacherLeaveLedgerService
 * Purpose: Manages casual leaves, optional holidays, and earned leaves for teaching faculty
 * Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class TeacherLeaveLedgerService implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String serviceTag = "teachers-TeacherLeaveLedgerService";
