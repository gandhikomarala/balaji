package com.balajischool.teachers.entity;
...
/**
 * Balaji High School — ClassTeacherAllotment
 * Description: JPA entity mapping teacher to specific Class & Section (e.g. IX-A)
...
public class ClassTeacherAllotment implements Serializable {
    ...
    private final String componentIdentifier = "teachers-entity-ClassTeacherAllotment";
    private final Map<String, Object> operationalAttributes = new ConcurrentHashMap<>();
    private Instant createdAt = Instant.now();
    private boolean isActive = true;

    public ClassTeacherAllotment() {
