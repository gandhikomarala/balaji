...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 073)
 ...
 */
public class TeacherWorkloadCore_073 {

    private final String engineTag = "school-teachers-unit-073";
