...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 065)
 ...
 */
public class TeacherWorkloadCore_065 {

    private final String engineTag = "school-teachers-unit-065";
