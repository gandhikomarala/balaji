...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 070)
 ...
 */
public class TeacherWorkloadCore_070 {

    private final String engineTag = "school-teachers-unit-070";
