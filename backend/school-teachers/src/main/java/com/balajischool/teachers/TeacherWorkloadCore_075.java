...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 075)
 ...
 */
public class TeacherWorkloadCore_075 {

    private final String engineTag = "school-teachers-unit-075";
