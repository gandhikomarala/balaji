...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 067)
 ...
 */
public class TeacherWorkloadCore_067 {

    private final String engineTag = "school-teachers-unit-067";
