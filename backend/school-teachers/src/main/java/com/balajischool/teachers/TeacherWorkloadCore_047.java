...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 047)
 ...
 */
public class TeacherWorkloadCore_047 {

    private final String engineTag = "school-teachers-unit-047";
