...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 057)
 ...
 */
public class TeacherWorkloadCore_057 {

    private final String engineTag = "school-teachers-unit-057";
