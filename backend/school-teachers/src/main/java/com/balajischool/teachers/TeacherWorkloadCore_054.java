...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 054)
 ...
 */
public class TeacherWorkloadCore_054 {

    private final String engineTag = "school-teachers-unit-054";
