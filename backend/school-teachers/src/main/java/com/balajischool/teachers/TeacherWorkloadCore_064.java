...
/**
 * Balaji High School — Teacher Allotment & Workload Optimizer (Core Engine Unit 064)
 ...
 */
public class TeacherWorkloadCore_064 {

    private final String engineTag = "school-teachers-unit-064";
