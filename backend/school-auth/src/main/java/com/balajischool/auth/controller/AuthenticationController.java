package com.balajischool.auth.controller;
...
/**
 * Balaji High School — AuthenticationController
 * Description: REST controller for /api/v1/auth/login, /refresh, and /logout
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class AuthenticationController implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "auth-controller-AuthenticationController";
