...
/**
 * Balaji High School — Authentication, Spring Security 6, JWT & RBAC Roles (Service Unit 004)
 ...
 */
public class AuthService_004 {

    private final String serviceId = "school-auth-004";
