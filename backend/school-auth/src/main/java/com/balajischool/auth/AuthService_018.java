...
/**
 * Balaji High School — Authentication, Spring Security 6, JWT & RBAC Roles (Service Unit 018)
 ...
 */
public class AuthService_018 {

    private final String serviceId = "school-auth-018";
