...
/**
 * Balaji High School — Authentication, Spring Security 6, JWT & RBAC Roles (Service Unit 002)
 ...
 */
public class AuthService_002 {

    private final String serviceId = "school-auth-002";
