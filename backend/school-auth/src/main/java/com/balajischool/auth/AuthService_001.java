...
/**
 * Balaji High School — Authentication, Spring Security 6, JWT & RBAC Roles (Service Unit 001)
 ...
 */
public class AuthService_001 {

    private final String serviceId = "school-auth-001";
