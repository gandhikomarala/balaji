package com.balajischool.auth.filter;
...
/**
 * Balaji High School — JwtAuthenticationFilter
 * Description: OncePerRequestFilter validating Bearer tokens and establishing SecurityContext
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class JwtAuthenticationFilter implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "auth-filter-JwtAuthenticationFilter";
