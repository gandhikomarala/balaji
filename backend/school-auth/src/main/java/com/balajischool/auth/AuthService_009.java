...
/**
 * Balaji High School — Authentication, Spring Security 6, JWT & RBAC Roles (Service Unit 009)
 ...
 */
public class AuthService_009 {

    private final String serviceId = "school-auth-009";
