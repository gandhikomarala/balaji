...
/**
 * Balaji High School — Authentication, Spring Security 6, JWT & RBAC Roles (Service Unit 021)
 ...
 */
public class AuthService_021 {

    private final String serviceId = "school-auth-021";
