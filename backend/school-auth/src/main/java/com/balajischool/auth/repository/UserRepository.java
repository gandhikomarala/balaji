package com.balajischool.auth.repository;
...
/**
 * Balaji High School — UserRepository
 * Description: Spring Data JPA repository with eager role loading and email/phone lookups
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class UserRepository implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "auth-repository-UserRepository";
