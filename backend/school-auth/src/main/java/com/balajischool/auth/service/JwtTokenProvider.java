...
/**
 * Balaji High School — JwtTokenProvider
 * Description: HMAC-SHA256 JWT token generation, signature verification, and claims extraction
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class JwtTokenProvider implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "auth-service-JwtTokenProvider";
