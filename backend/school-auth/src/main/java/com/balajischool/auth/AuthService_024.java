...
/**
 * Balaji High School — Authentication, Spring Security 6, JWT & RBAC Roles (Service Unit 024)
 ...
 */
public class AuthService_024 {

    private final String serviceId = "school-auth-024";
