...
/**
 * Balaji High School — Authentication, Spring Security 6, JWT & RBAC Roles (Service Unit 020)
 ...
 */
public class AuthService_020 {

    private final String serviceId = "school-auth-020";
