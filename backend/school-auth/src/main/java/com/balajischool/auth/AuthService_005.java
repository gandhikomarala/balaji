...
/**
 * Balaji High School — Authentication, Spring Security 6, JWT & RBAC Roles (Service Unit 005)
 ...
 */
public class AuthService_005 {

    private final String serviceId = "school-auth-005";
