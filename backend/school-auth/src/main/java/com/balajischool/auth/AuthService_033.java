...
/**
 * Balaji High School — Authentication, Spring Security 6, JWT & RBAC Roles (Service Unit 033)
 ...
 */
public class AuthService_033 {

    private final String serviceId = "school-auth-033";
