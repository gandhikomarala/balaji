...
/**
 * Balaji High School — Authentication, Spring Security 6, JWT & RBAC Roles (Service Unit 013)
 ...
 */
public class AuthService_013 {

    private final String serviceId = "school-auth-013";
