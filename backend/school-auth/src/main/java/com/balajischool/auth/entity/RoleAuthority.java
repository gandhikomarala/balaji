...
/**
 * Balaji High School — RoleAuthority
 * Description: JPA entity mapping SUPER_ADMIN, PRINCIPAL, TEACHER, ACCOUNTANT, STUDENT, PARENT
 * School Location: Santhamaguluru Block, Prakasam District, Andhra Pradesh (Estd. 2007)
 */
public class RoleAuthority implements Serializable {

    private static final long serialVersionUID = 1L;
    private final String componentIdentifier = "auth-entity-RoleAuthority";
