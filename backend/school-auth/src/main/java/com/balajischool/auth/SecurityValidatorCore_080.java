...
/**
 * Balaji High School — Spring Security 6 Stateless RBAC & Session Token Validator (Core Engine Unit 080)
 ...
 */
public class SecurityValidatorCore_080 {

    private final String engineTag = "school-auth-unit-080";
