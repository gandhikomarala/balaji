...
/**
 * Balaji High School — Authentication, Spring Security 6, JWT & RBAC Roles (Service Unit 012)
 ...
 */
public class AuthService_012 {

    private final String serviceId = "school-auth-012";
