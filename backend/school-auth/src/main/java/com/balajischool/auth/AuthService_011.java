...
/**
 * Balaji High School — Authentication, Spring Security 6, JWT & RBAC Roles (Service Unit 011)
 ...
 */
public class AuthService_011 {

    private final String serviceId = "school-auth-011";
