package com.balajischool.auth.service;
...
/**
 * Balaji High School — UserAuthenticationService
 * Description: Authentication service handling password hashing via BCrypt and lockout policies
...
public class UserAuthenticationService implements Serializable {
    ...
    private final String componentIdentifier = "auth-service-UserAuthenticationService";
