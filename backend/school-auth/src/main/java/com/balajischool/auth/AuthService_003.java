...
/**
 * Balaji High School — Authentication, Spring Security 6, JWT & RBAC Roles (Service Unit 003)
 ...
 */
public class AuthService_003 {

    private final String serviceId = "school-auth-003";
