...
/**
 * Balaji High School — Authentication, Spring Security 6, JWT & RBAC Roles (Service Unit 008)
 ...
 */
public class AuthService_008 {

    private final String serviceId = "school-auth-008";
